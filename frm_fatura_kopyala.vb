...
Public Class frm_fatura_kopyala
    Public firmano
    Public donemno
    Public connection
    ...
    Private Sub frm_fatura_kopyala_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If bAktar = True Then
            Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("SERVER", txt_Server.Text)
            Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("DATABASE", txt_database.Text)
            Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("PASSWORD", txt_password.Text)
            Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("USER", txt_sKullanici.Text)
        End If
    End Sub
    Private Sub frm_fatura_kopyala_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If bAktar = True Then
            Try
                txt_Server.Text = Registry.CurrentUser.OpenSubKey("Software").OpenSubKey("BusinessSmart").OpenSubKey("GlobalParams").GetValue("SERVER")
            Catch ex As Exception
                txt_Server.Text = ""
                Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("SERVER", "")
            End Try
            Try
                txt_database.Text = Registry.CurrentUser.OpenSubKey("Software").OpenSubKey("BusinessSmart").OpenSubKey("GlobalParams").GetValue("DATABASE")
            Catch ex As Exception
                txt_database.Text = ""
                Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("DATABASE", "")
            End Try
            Try
                txt_sKullanici.Text = Registry.CurrentUser.OpenSubKey("Software").OpenSubKey("BusinessSmart").OpenSubKey("GlobalParams").GetValue("USER")
            Catch ex As Exception
                txt_sKullanici.Text = "sa"
                Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("USER", "")
            End Try
            Try
                txt_password.Text = Registry.CurrentUser.OpenSubKey("Software").OpenSubKey("BusinessSmart").OpenSubKey("GlobalParams").GetValue("PASSWORD")
            Catch ex As Exception
                txt_password.Text = ""
                Registry.CurrentUser.CreateSubKey("Software").CreateSubKey("BusinessSmart").CreateSubKey("GlobalParams").SetValue("PASSWORD", "")
            End Try
        End If
        If bLogo = True Then
