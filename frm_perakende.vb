...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LabelControl35.Text = "H�zl� Ara:"
        '
        'TextEdit1
        '
        ...
        'BarButtonItem19
        '
        Me.BarButtonItem19.Caption = "M��teri Kart� Sil"
        ...
        'BarButtonItem18
        '
        Me.BarButtonItem18.Caption = "M��teri Gir"
        ...
        'BarButtonItem2
        '
        Me.BarButtonItem2.Caption = "M��teri Se�"
        ...
        'BarButtonItem3
        '
        Me.BarButtonItem3.Caption = "M��teri Kart�"
        ...
        'BarButtonItem4
        '
        Me.BarButtonItem4.Caption = "A��klama"
        ...
        'BarButtonItem6
        '
        Me.BarButtonItem6.Caption = "M��teri D�zenle"
        ...
        'BarButtonItem7
        '
        Me.BarButtonItem7.Caption = "Kredili Sat��"
        ...
        'BarButtonItem8
        '
        Me.BarButtonItem8.Caption = "Pe�in Sat��"
        ...
        'BarButtonItem9
        '
        Me.BarButtonItem9.Caption = "�deme"
        ...
        'BarButtonItem10
        '
        Me.BarButtonItem10.Caption = "Vade Fark� �deme"
        Me.BarButtonItem10.Id = 10
        Me.BarButtonItem10.Name = "BarButtonItem10"
        '
        'BarButtonItem11
        '
        Me.BarButtonItem11.Caption = "Slip Sat��"
        ...
        'BarButtonItem14
        '
        Me.BarButtonItem14.Caption = "Yap�lan �demeler"
        ...
        'BarButtonItem15
        '
        Me.BarButtonItem15.Caption = "Yap�lan Sat��lar"
        ...
        'BarButtonItem16
        '
        Me.BarButtonItem16.Caption = "Kalan �demeler"
        ...
        'BarButtonItem24
        '
        Me.BarButtonItem24.Caption = "Karl�l�k Ak�� Tablosu"
        ...
        'BarButtonItem25
        '
        Me.BarButtonItem25.Caption = "Al�nan Pe�inatlar"
        ...
        Me.sec_magaza.Properties.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo("sDepo", "Kod"), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("sAciklama", "A��klama")})
        Me.sec_magaza.Properties.DisplayMember = "sAciklama"
        Me.sec_magaza.Properties.NullText = "[Ma�aza]"
        ...
        Me.sec_magaza.ToolTip = "�al���lan Ma�aza"
        '
        'sec_kasa
        '
        ...
        Me.sec_kasa.Properties.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo("nKasaNo", 5, "KasaNo"), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("sAciklama", 40, "A��klama")})
        ...
        Me.sec_kasa.ToolTip = "�al���lan Kasa Numaras�"
        '
        'DateEdit1
        '
        ...
        Me.DateEdit1.ToolTip = "Aktif ��lem Tarihi"
        '
        'LabelControl6
        '
        ...
        ToolTipItem8.Text = "��lem Yapabilmek i�in Yetkili Personel �ifresini Girmeniz Gerekmektedir."
        ...
        Me.txt_sEhliyetNo.ToolTip = "5 Karakterden K���kse FiyatTipi , 5 Karakterden B�y�kise EhliyetNo olarak alg�lan" &
    "maktad�r."
        ...
        Me.LabelControl26.Text = "Do�umYeri:"
        '
        'txt_dteDogumTarihi
        '
        ...
        Me.LabelControl27.Text = "Do�umTarihi:"
        '
        ...
        Me.LabelControl17.Text = "�sk.Pe�in%:"
        '
        'LabelControl20
        '
        ...
        Me.LabelControl20.Text = "�sk.Kredi%:"
        '
        ...
        ToolTipItem1.Text = "Hesap Kart�nda Bilgileri Yeniler"
        ...
        ToolTipTitleItem2.Text = "Son Kay�t"
        ToolTipItem2.LeftIndent = 6
        ToolTipItem2.Text = "En Son Girilmi� Olan M��teri Kayd�n� Ekrana Getirir"
        ...
        ToolTipTitleItem3.Text = "Sonraki Kay�t"
        ToolTipItem3.LeftIndent = 6
        ToolTipItem3.Text = "Bir Sonraki M��teri Kayd�n� Ekrana Getirir"
        ...
        ToolTipTitleItem4.Text = "�nceki Kay�t"
        ToolTipItem4.LeftIndent = 6
        ToolTipItem4.Text = "Bir �nceki M��teri Kayd�n� Ekrana Getirir"
        ...
        ToolTipTitleItem5.Text = "Ilk Kay�t"
        ToolTipItem5.LeftIndent = 6
        ToolTipItem5.Text = "Ilk M��teri Kayd�n� Ekrana Getirir"
        ...
        Me.txt_musterino.Properties.NullText = "[M��teriNo]"
        Me.txt_musterino.Size = New System.Drawing.Size(175, 30)
        ToolTipTitleItem6.Text = "M��teri No"
        ...
        Me.LabelControl4.Text = "M��teriNo:"
        '
        'sec_bakiyeli
        '
        ...
        ToolTipTitleItem7.Text = "Bakiyeli M��teriler"
        ToolTipItem7.LeftIndent = 6
        ToolTipItem7.Text = "Sadece Bakiyeli M��terilerin Ekrana Gelmesi ve Izlenmesi istenidi�i zaman Bu Kutu" &
    "cuk ��aretlenir"
        ...
        Me.GroupControl1.Text = "Kalan �demeler"
        '
        'GridControl3
        '
        ...
        Me.GroupControl2.Text = "M��terinin Grupland�rmas�"
        '
        'GridControl1
        '
        ...
        Me.colTARIH.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "TARIH", "{0} Kay�t")})
        ...
        Me.�mageList1.TransparentColor = System.Drawing.Color.Transparent
        Me.�mageList1.Images.SetKeyName(0, "businessman_preferences.png")
        Me.�mageList1.Images.SetKeyName(1, "businessman_add.png")
        Me.�mageList1.Images.SetKeyName(2, "id_card_information.png")
        Me.�mageList1.Images.SetKeyName(3, "note_pinned.png")
        Me.�mageList1.Images.SetKeyName(4, "id_card_ok.png")
        Me.�mageList1.Images.SetKeyName(5, "outbox.png")
        Me.�mageList1.Images.SetKeyName(6, "money2.png")
        Me.�mageList1.Images.SetKeyName(7, "money_envelope.png")
        Me.�mageList1.Images.SetKeyName(8, "shoppingcart_full.png")
        Me.�mageList1.Images.SetKeyName(9, "column.png")
        Me.�mageList1.Images.SetKeyName(10, "index_view.png")
        '
        'ds_taksitler
        '
        ...
        Me.SimpleButton6.Text = "Karl�l�k Ak�� Tablosu   Ctrl+Z"
        '
        ...
        Me.btn_Analiz_Satislar_Bekleyen.Text = "Bekleyen Al��veri�ler"
        '
        ...
        Me.btn_Analiz_Kalan_Satislar.Text = "Kalan Sat��lar"
        '
        'btn_Analiz_Satislar
        '
        ...
        Me.btn_Analiz_Satislar.Text = "Yap�lan Sat��lar          Alt+F6"
        '
        'btn_Analiz_Odemeler
        '
        ...
        Me.btn_Analiz_Odemeler.Text = "Al�nan �demeler        Alt+F5"
        '
        'GroupControl6
        '
        ...
        Me.btn_Ekstre_Ozet.Text = "Ekstre �zet"
        '
        ...
        Me.btn_Raporlar_Ekstre_Detayli.Text = "Ekstre Detayl�           Ctrl+F8"
        '
        'GroupControl5
        '
        ...
        Me.SimpleButton7.Text = "Pe�inat Al"
        '
        ...
        Me.btn_Islem_VadeFarki.Text = "Vade Fark� Hesapla"
        '
        'btn_Islem_Odeme_Al
        '
        ...
        Me.btn_Islem_Odeme_Al.Text = "�deme Al                  F7"
        '
        ...
        Me.btn_Islem_Siparis_Pesin.Text = "Sonradan Teslim Pe�in  Sat��"
        '
        ...
        Me.btn_Islem_Siparis_Kredili.Text = "Sonradan Teslim Kredili Sat��"
        '
        ...
        Me.btn_Islem_Satis_Pesin.Text = "Pe�in Sat��                F6"
        '
        ...
        Me.btn_Islem_Satis_Kredili.Text = "Kredili Sat��               F5"
        '
        'GroupControl4
        '
        ...
        Me.GroupControl4.Text = "M��teri Bilgileri"
        '
        'btn_KimlikTara
        '
        ...
        Me.SimpleButton5.Text = "SMS G�nder"
        '
        ...
        Me.btn_Musteri_Sozlesme.Text = "S�zle�me"
        '
        'btn_Musteri_Duzelt
        '
        ...
        Me.btn_Musteri_Duzelt.Text = "M��teri D�zenle        Ctrl+F4"
        '
        'btn_Musteri_Not
        '
        ...
        Me.btn_Musteri_Kart.Text = "M��teri Kart�              F4"
        '
        'btn_Musteri_Yeni
        '
        ...
        Me.btn_Musteri_Yeni.Text = "Yeni M��teri              Insert"
        '
        'btn_Musteri_sec
        '
        ...
        Me.btn_Musteri_sec.Text = "M��teri Se�               F3"
        '
        'panel_bilgi
        '
        ...
        Me.Text = "Pe�in ve Kredili Sat��,�ade ve �deme Formu"
...
#End Region
    ...
    Private Sub dataload(ByVal nMusteriID As Int64)
        ...
        If sAdi.Contains("PE��N") = False And txt_musterino.Text <> 0 Then
        ...
        If lGeciken > 0 Then
            BarButtonItem21.Caption = "Geciken �deme: " & gecikmistaksitsayisi & " Tutar�: " & FormatNumber(lGeciken, 2)
        Else
        ...
        Else
            'lbl_isim.Text += "  Do�um Tarihi :" & dr("DOGUMTARIHI").ToLongDateString
            ...
            BarButtonItem1.Caption += "  Do�um G�n� :" & CDate(gun + "." + ay + "." + yil).ToLongDateString
            gun_dogum = DateDiff(DateInterval.Day, Today, CDate(gun + "." + ay + "." + yil))
            If gun_dogum > 0 And gun_dogum < 30 Then
                BarButtonItem1.Caption += " " & gun_dogum & " G�n Sonra Do�um G�n�n�z.�imdiden Do�um G�n�n�z Kutlu Olsun..!"
            ElseIf gun_dogum < 0 And Math.Abs(gun_dogum) < 30 Then
                BarButtonItem1.Caption += " " & Math.Abs(gun_dogum) & " G�n �nce Do�um G�n�n�zm��...Nice Senelere..!"
            ElseIf gun_dogum = 0 Then
                BarButtonItem1.Caption += "  Do�um G�n�n�z Kutlu Olsun...!"
            End If
        End If
        'Evlilik Tarihi
        ...
        Else
            ...
            BarButtonItem1.Caption += "  Evlilik Y�ld�n�m� :" & CDate(gun + "." + ay + "." + yil).ToLongDateString
            gun_dogum = DateDiff(DateInterval.Day, Today, CDate(gun + "." + ay + "." + yil))
            If gun_dogum > 0 And gun_dogum < 30 Then
                BarButtonItem1.Caption += " " & gun_dogum & " G�n Sonra Evlilik Y�ld�n�m�n�z.�imdiden Evlilik Y�ld�n�m�n�z Kutlu Olsun..!"
            ElseIf gun_dogum < 0 And Math.Abs(gun_dogum) < 30 Then
                BarButtonItem1.Caption += " " & Math.Abs(gun_dogum) & " G�n �nce Evlilik Y�ld�n�m�n�zm��...Nice Senelere..!"
            ElseIf gun_dogum = 0 Then
                BarButtonItem1.Caption += " Evlilik Y�ld�n�m�n�z Kutlu Olsun...!"
            End If
        End If
        ...
        If lBekleyen > 0 Then
            If XtraMessageBox.Show(Sorgu_sDil("M��terinin [" & lBekleyen & "] Adet Bekleyen �r�n� Var.." & vbCrLf & "M��terinin Bekleyen �r�nlerini G�rmek �ster misiniz..?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Information) = MsgBoxResult.Yes Then
                analiz_bekleyen()
            End If
        End If
        If lHediyeCeki < 0 Then
            XtraMessageBox.Show(FormatNumber(Math.Abs(lHediyeCeki), 2) & Sorgu_sDil(" Tutar�nda M��teri Alaca�� Bulunmaktad�r...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Warning)
            lbl_istihbarat.Text += vbCrLf & FormatNumber(Math.Abs(lHediyeCeki), 2) & " Tutar�nda M��teri Alacakl�"
        ElseIf lHediyeCeki = 0 Then
        Else
            lbl_istihbarat.Text += vbCrLf & FormatNumber(Math.Abs(lHediyeCeki), 2) & " Tutar�nda Fazla Hediye �eki Giri�i Yap�lm��"
        End If
        If lPuan > 0 Then
            XtraMessageBox.Show(FormatNumber(Math.Abs(lPuan), 2) & Sorgu_sDil(" Tutarinda Alisveris Puani Bulunmaktad�r...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Information)
            lbl_istihbarat.Text += vbCrLf & FormatNumber(Math.Abs(lPuan), 2) & " Tutar�nda AlisVeris Puani"
        End If
        lHediyeCeki = Nothing
        lPuan = Nothing
        lBekleyen = Nothing
    ...
    Private Function KayitSiniri_kontrol(ByVal tbTable As String, ByVal kriter As String, ByVal nKayitSinir As Integer) As Boolean
        ...
        If nKayitSinir > 0 Then
            ...
            If yetki = 0 Then
                XtraMessageBox.Show(Sorgu_sDil("�zg�n�m K�s�tl� Kullan�m.Maximum Kay�t S�n�r�n� A�amazs�n�z...!" & vbCrLf & "L�tfen Yetkili Sat�c�n�zla G�r���n...", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Information)
                status = True
                pass = False
            ElseIf yetki = 1 Then
                pass = True
    ...
    Private Sub kasiyer_kontrol(Optional ByVal bKontrol As Boolean = True)
        ...
        ElseIf sonuc = False Then
            ...
            If XtraMessageBox.Show(Sorgu_sDil("�ifre Hatal� L�tfen Tekrar Deneyiniz...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Information) Then
        ...
        If txt_musterino.EditValue <> "" Then
            ...
            If GridView3.RowCount > 0 Or nOdemeKodu = 4 Then
                ...
                ElseIf pass = False Then
                    XtraMessageBox.Show(Sorgu_sDil("�zg�n�m" & vbCrLf & "Gecikmi� Borcu Olan M��terilerden �deme Alma Yetkiniz Yok...!" & vbCrLf & "L�tfen Sistem Y�neticinizle G�r���n...", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Warning)
                End If
                pass = Nothing
            End If
        Else
            XtraMessageBox.Show(Sorgu_sDil("L�tfen Bir M��teri Hesab� Se�iniz...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Question)
            txt_musterino.Focus()
            txt_musterino.SelectAll()
        End If
    End Sub
        ...
        If KayitSiniri_kontrol("tbAlisVeris", "Where sFisTipi = '" & sFisTipi & "'", nKayitSinir) = True Then
            If txt_musterino.Text.ToString <> "" Then
                ...
                If pass = True Then
                    ...
                    frm.Show()
                Else
                    XtraMessageBox.Show(Sorgu_sDil("�zg�n�m" & vbCrLf & "M��teri Hesab�na Sat�� Yetkisi Yok...!" & vbCrLf & "L�tfen Sistem Y�neticinizle G�r���n...", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Warning)
                End If
            Else
                XtraMessageBox.Show(Sorgu_sDil("L�tfen Bir M��teri Hesab� Se�iniz...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Question)
                txt_musterino.Focus()
    ...
    Private Sub musteri_sec()
        If Trim(sKasiyerRumuzu.ToString) <> "" Then
            ...
            End If
        Else
            XtraMessageBox.Show(Sorgu_sDil("L�tfen Kasiyer Bilgilerinizi Giriniz...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Warning)
            txt_kasiyer_kod.Focus()
            txt_kasiyer_kod.SelectAll()
        End If
    End Sub
    Private Sub musteri_kontrol()
        If Trim(txt_musterino.Text).ToString <> "" And IsNumeric(Trim(txt_musterino.Text)) = True Then
            ...
            End If
        Else
            XtraMessageBox.Show(Sorgu_sDil("L�tfen Say�sal Veri Giriniz...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Information)
            txt_musterino.Focus()
            txt_musterino.SelectAll()
        End If
    End Sub
    ...
    Private Sub SMS_Gonder()
        If XtraMessageBox.Show(Sorgu_sDil("SMS G�ndermek �stedi�inize Emin misiniz...?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
    ...
    Private Sub txt_musterino_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_musterino.KeyDown
        ...
        ElseIf e.KeyCode = Keys.Space Then
            Dim deger = ""
            deger = InputBox("M��teriNumaras�n� Okutun", "M��teriKartOkut", "").ToString
        ...
        If e.KeyCode = Keys.Escape Then
            If XtraMessageBox.Show(Sorgu_sDil("Perakende Ekran�ndan ��kmak �stedi�inize Emin misiniz...?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
                Me.Close()
            End If
        End If
    End Sub
