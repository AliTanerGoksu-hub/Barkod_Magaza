...
Imports System.IO
Public Class frm_Musteri_Referans_Kontrol_Detay
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_Musteri_Referans_Kontrol_Detay))
        ...
        Me.colnBasamak = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        Me.Label1.Text = "Satış Detayları Aşağıdadır."
        '
        'PictureBox1
        '
        ...
        Me.PanelControl2.Location = New System.Drawing.Point(0, 383)
        ...
        Me.PanelControl3.Size = New System.Drawing.Size(824, 331)
        ...
        Me.XtraTabControl1.Size = New System.Drawing.Size(820, 327)
        ...
        Me.XtraTabPage1.Size = New System.Drawing.Size(814, 301)
        ...
        Me.GridControl1.Size = New System.Drawing.Size(814, 301)
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colnMusteriID, Me.collKodu, Me.colsAdi, Me.colsSoyadi, Me.collSatis, Me.colnBasamak})
        ...
        Me.GridView1.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "lKodu", Nothing, "{0} Kayıt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lSatis", Nothing, "{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "lKodu", Me.collKodu, "{0} Kayıt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lSatis", Me.collSatis, "{0:#,0.00}")})
        ...
        'colnMusteriID
        '
        Me.colnMusteriID.Caption = "KayıtNo"
        ...
        Me.collSatis.Width = 195
        '
        'colnBasamak
        '
        Me.colnBasamak.Caption = "Basamak"
        Me.colnBasamak.FieldName = "nBasamak"
        Me.colnBasamak.Name = "colnBasamak"
        Me.colnBasamak.Visible = True
        Me.colnBasamak.VisibleIndex = 5
        '
        'sec_renk
        '
        ...
        'ContextMenu1
        '
        Me.ContextMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem3, Me.MenuItem7, Me.MenuItem8, Me.MenuItem9, Me.MenuItem14, Me.MenuItem1, Me.MenuItem10, Me.MenuItem11, Me.MenuItem18, Me.MenuItem2, Me.MenuItem4, Me.MenuItem5, Me.MenuItem17})
        '
        'MenuItem3
        '
        ...
        Me.MenuItem1.Text = "Hızlı Filtre"
        '
        'MenuItem10
        '
        ...
        Me.MenuItem2.Text = "Satırları Aç"
        '
        'MenuItem4
        '
        Me.MenuItem4.Index = 10
        Me.MenuItem4.Text = "Satırları Kapat"
        '
        'MenuItem5
        '
        ...
        Me.printlink1.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"", "Refere Satış Listesi", "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"[User Name]", "CRM-Müşteri İlişkileri Yönetimi", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
        ...
        Me.Bar3.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem3, True)})
        ...
        '
        'frm_Musteri_Referans_Kontrol_Detay
        '
        ...
        Me.Name = "frm_Musteri_Referans_Kontrol_Detay"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Refere Satış Detay Kontrol"
...
#End Region
    ...
    Public Function stok() As DataSet
        ...
        conn.ConnectionString = connection
        adapter.SelectCommand = cmd
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , SUM(tbStokFisiDetayi.lBrutTutar) AS lSatis , 0 AS nBasamak FROM tbAlisVeris INNER JOIN tbMusteri ON tbAlisVeris.nMusteriID = tbMusteri.nMusteriID INNER JOIN tbStokFisiDetayi ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.nKdvOrani <> 0) AND (tbAlisVeris.nMusteriID = '" & nMusteriID & "') GROUP BY tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi UNION ALL SELECT tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , SUM(tbStokFisiDetayi.lBrutTutar) AS lSatis , 1 AS nBasamak FROM tbAlisVeris INNER JOIN tbMusteri ON tbAlisVeris.nMusteriID = tbMusteri.nMusteriID INNER JOIN tbStokFisiDetayi ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.nKdvOrani <> 0) AND (tbAlisVeris.nMusteriID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID = '" & nMusteriID & "')) GROUP BY tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi UNION ALL SELECT tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , SUM(tbStokFisiDetayi.lBrutTutar) AS lSatis , 2 AS nBasamak FROM tbAlisVeris INNER JOIN tbMusteri ON tbAlisVeris.nMusteriID = tbMusteri.nMusteriID INNER JOIN tbStokFisiDetayi ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.nKdvOrani <> 0) AND (tbAlisVeris.nMusteriID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID = '" & nMusteriID & "'))) GROUP BY tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi UNION ALL SELECT tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , SUM(tbStokFisiDetayi.lBrutTutar) AS lSatis , 3 AS nBasamak FROM tbAlisVeris INNER JOIN tbMusteri ON tbAlisVeris.nMusteriID = tbMusteri.nMusteriID INNER JOIN tbStokFisiDetayi ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.nKdvOrani <> 0) AND (tbAlisVeris.nMusteriID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID = '" & nMusteriID & "')))) GROUP BY tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi UNION ALL SELECT tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , SUM(tbStokFisiDetayi.lBrutTutar) AS lSatis , 4 AS nBasamak FROM tbAlisVeris INNER JOIN tbMusteri ON tbAlisVeris.nMusteriID = tbMusteri.nMusteriID INNER JOIN tbStokFisiDetayi ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.nKdvOrani <> 0) AND (tbAlisVeris.nMusteriID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID IN (SELECT nMusteriID FROM tbMusteriReferans WHERE nRefID = '" & nMusteriID & "'))))) GROUP BY tbMusteri.nMusteriID , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi) tbReferans ORDER BY nBasamak, lKodu")
        cmd.Connection = conn
        conn.Open()
    ...
    Private Sub MenuItem22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim file As String
        OpenFileDialog1.Filter = "Plu Dosyaları (*.fr3) |*.fr3"
    ...
    Friend WithEvents colnBasamak As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Private Sub MenuItem1_Click_2(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem1.Click
        ...
        ElseIf MenuItem1.Checked = True Then
