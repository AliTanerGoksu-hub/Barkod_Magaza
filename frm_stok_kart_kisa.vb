...
Public Class frm_stok_kart_kisa
    Public firmano
    Public donemno
    Public connection
    Public nStokID
    ...
    Private Function tbStok_kaydet_yeni(ByVal sKodu As String, ByVal sAciklama As String, ByVal sKisaAdi As String, ByVal nStokTipi As Int64, ByVal sBedenTipi As String, ByVal sKavalaTipi As String, ByVal sRenk As String, ByVal sBeden As String, ByVal sKavala As String, ByVal sBirimCinsi1 As String, ByVal sBirimCinsi2 As String, ByVal nIskontoYuzdesi As Decimal, ByVal sKdvTipi As String, ByVal nTeminSuresi As Decimal, ByVal lAsgariMiktar As Decimal, ByVal lAzamiMiktar As Decimal, ByVal sOzelNot As String, ByVal nFiyatlandirma As Int64, ByVal sModel As String, ByVal sKullaniciAdi As String, ByVal dteKayitTarihi As DateTime, ByVal bEksiyeDusulebilirmi As Byte, ByVal sDefaultAsortiTipi As String, ByVal bEksideUyarsinmi As Byte, ByVal bOTVVar As Byte, ByVal sOTVTipi As String, ByVal nIskontoYuzdesiAV As Decimal, ByVal bEk1 As Byte, ByVal nEk2 As String, ByVal nAgirlik As Decimal, ByVal bOIVVar As Byte, ByVal nOIV As Decimal) As Decimal
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        bEksiyeDusulebilirmi = sorgula_Boolean("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT bEksiyeDusulebilirmi FROM tbParamStok")
        ...
        Return kayitno
    End Function
    Private Sub tbStokSinifi_kaydet_yeni(ByVal nStokID As String, ByVal sModel As String, ByVal sSinifKodu1 As String, ByVal sSinifKodu2 As String, ByVal sSinifKodu3 As String, ByVal sSinifKodu4 As String, ByVal sSinifKodu5 As String, ByVal sSinifKodu6 As String, ByVal sSinifKodu7 As String, ByVal sSinifKodu8 As String, ByVal sSinifKodu9 As String, ByVal sSinifKodu10 As String, ByVal sSinifKodu11 As String, ByVal sSinifKodu12 As String, ByVal sSinifKodu13 As String, ByVal sSinifKodu14 As String, ByVal sSinifKodu15 As String)
        Dim con As New OleDb.OleDbConnection
        Dim cmd As New OleDb.OleDbCommand
        cmd.Connection = con
        con.ConnectionString = connection
    ...
    Private Sub kaydet_tumu(Optional ByVal bDiger As Boolean = False)
        ...
        If bDevam = True Then
            ...
            If IsDBNull(txt_nOIV.Value) Then
                txt_nOIV.Value = 0
            End If
            nStokID = tbStok_kaydet_yeni(txt_sKodu.EditValue.ToString, txt_sAdi.EditValue.ToString, txt_sKisaAdi.EditValue.ToString, 0, "", "", txt_sRenk.EditValue.ToString, txt_sBeden.Text.ToString, "", txt_sBirimCinsi1.EditValue.ToString, "", 0, txt_sKdvTipi.EditValue.ToString, 0, 0, 0, "", 0, txt_sKodu.EditValue.ToString, kullanici, Now, 1, "", 0, CType((txt_OTVvar.EditValue), Byte), txt_sOTVtipi.Text, 0, 0, 0, txt_nAgirlik.Value, CType((txt_OIVVar.EditValue), Byte), txt_nOIV.Value)
            tbStokSinifi_kaydet_yeni(nStokID, sModel, sec_sSinifKodu.EditValue, sec_sSinifKodu2.EditValue.ToString, sec_sSinifKodu3.EditValue.ToString, sec_sSinifKodu4.EditValue.ToString, "", "", "", "", "", "", "", "", "", "", "")
            If txt_lFiyat1.EditValue > 0 Then
                tbStokFiyati_ekle_yeni(0, txt_sKodu.EditValue.ToString, "", "", sec_sFiyatTipi1.EditValue.ToString, txt_lFiyat1.EditValue.ToString, Today, kullaniciadi)
            End If
            If txt_lFiyat2.EditValue > 0 Then
                tbStokFiyati_ekle_yeni(0, txt_sKodu.EditValue.ToString, "", "", sec_sFiyatTipi2.EditValue.ToString, txt_lFiyat2.EditValue.ToString, Today, kullaniciadi)
            End If
            If txt_lFiyat3.EditValue > 0 Then
                tbStokFiyati_ekle_yeni(0, txt_sKodu.EditValue.ToString, "", "", sec_sFiyatTipi3.EditValue.ToString, txt_lFiyat3.EditValue.ToString, Today, kullaniciadi)
            End If
            If txt_lFiyat4.EditValue > 0 Then
                tbStokFiyati_ekle_yeni(0, txt_sKodu.EditValue.ToString, "", "", sec_sFiyatTipi4.EditValue.ToString, txt_lFiyat4.EditValue.ToString, Today, kullaniciadi)
            End If
            If txt_lFiyat5.EditValue > 0 Then
                tbStokFiyati_ekle_yeni(0, txt_sKodu.EditValue.ToString, "", "", sec_sFiyatTipi5.EditValue.ToString, txt_lFiyat5.EditValue.ToString, Today, kullaniciadi)
            End If
