...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ým))
        ...
        Me.XtraTabPage1.Text = "Üretim Vardiyalarý"
        '
        'GridControl1
        '
        ...
        Me.btn_kaydet.Size = New System.Drawing.Size(144, 23)
...
#End Region
    ...
    Private Sub dataload_yerler()
        DataSet1 = sorgu(sorgu_query("SELECT     * FROM         TBLUREVARDIYALIST"))
    ...
    Private Sub ekle(ByVal GRUPADI As String, ByVal BASLAMASAATI As DateTime, ByVal BITISAATI As DateTime)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("SET DATEFORMAT DMY INSERT INTO TBLUREVARDIYALIST  (GRUPADI, BASLAMASAATI, BITISAATI) VALUES     (N'" & GRUPADI & "', N'" & BASLAMASAATI & "', N'" & BITISAATI & "')")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    Private Sub duzelt(ByVal ind As Int64, ByVal GRUPADI As String, ByVal BASLAMASAATI As DateTime, ByVal BITISAATI As DateTime)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("SET DATEFORMAT DMY UPDATE    TBLUREVARDIYALIST SET              GRUPADI = N'" & GRUPADI & "', BASLAMASAATI = N'" & BASLAMASAATI & "', BITISAATI = N'" & BITISAATI & "' WHERE IND =" & ind & "")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    Private Sub sil(ByVal ind As Int64)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("DELETE FROM TBLUREVARDIYALIST WHERE IND = " & ind & "")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    ...
    Private Sub kayit_sil()
        If GridView1.RowCount > 0 Then
            ...
            kayitno = dr("IND")
            If kayitno > 100 Then
                If XtraMessageBox.Show(kayitno & vbTab & Sorgu_sDil("Nolu Üretim Vardiyalarý Kaydýný Silmek istediðinize eminmisiniz...?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
                    sil(kayitno)
                End If
            End If
            dataload_yerler()
