...
Public Class frm_tbSiparis_bekleyen_panorama
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_tbSiparis_bekleyen_panorama))
        ...
        '
        Me.sec_bUrunKoduOlanlar.Location = New System.Drawing.Point(5, 4)
        ...
        Me.sec_bUrunKoduOlanlar.TabIndex = 9
        '
        'frm_tbSiparis_bekleyen_panorama
        '
        ...
        Me.Name = "frm_tbSiparis_bekleyen_panorama"
...
#End Region
    ...
    Private Sub analiz_fis()
        If GridView1.RowCount > 0 Then
            ...
            frm.donemno = donemno
            frm.connection = connection
            frm.dteSiparisTarihi = dr("Islemtarihi")
            frm.lSiparisNo = dr("SiparisNo")
            frm.nFirmaID = dr("nFirmaID")
    ...
    Private Sub raporla_excel()
        If XtraMessageBox.Show(Sorgu_sDil("Sonuçlarý Excel Dosyasý Oluþturmak Ýstediðinize Emin misiniz...?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
            ...
            SaveFileDialog1.FileName = "Panorama_" & Trim(Replace(sec_sSiparisTipi.Text, " ", "")) & "_" & sTarih & ".xls"
