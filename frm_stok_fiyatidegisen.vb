...
Imports System.IO
Public Class frm_stok_fiyatidegisen
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents colsFiyat5 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colsOran4 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colsOran5 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colsbWebGoruntule As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents barDockControlRight As DevExpress.XtraBars.BarDockControl
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_fiyatidegisen))
        ...
        Me.colsFiyat5 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colsOran4 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colsOran5 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colsbWebGoruntule = New DevExpress.XtraGrid.Columns.GridColumn()
    ...
    "a] butonuna týklayýnýz."
        ...
        Me.colsFiyat4.Visible = True
        Me.colsFiyat4.VisibleIndex = 11
        '
        'colsFiyat5
        '
        Me.colsFiyat5.Caption = "Fiyat 5"
        Me.colsFiyat5.DisplayFormat.FormatString = "#,0.00"
        Me.colsFiyat5.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colsFiyat5.FieldName = "FIYAT5"
        Me.colsFiyat5.Name = "colsFiyat5"
        Me.colsFiyat5.Visible = True
        Me.colsFiyat5.VisibleIndex = 13
        '
        'colsOran4
        '
        Me.colsOran4.Caption = "Oran 4"
        Me.colsOran4.DisplayFormat.FormatString = "P"
        Me.colsOran4.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colsOran4.FieldName = "ORAN4"
        Me.colsOran4.Name = "colsOran4"
        Me.colsOran4.Visible = True
        Me.colsOran4.VisibleIndex = 12
        '
        'colsOran5
        '
        Me.colsOran5.Caption = "Oran 5"
        Me.colsOran5.DisplayFormat.FormatString = "P"
        Me.colsOran5.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colsOran5.FieldName = "ORAN5"
        Me.colsOran5.Name = "colsOran5"
        Me.colsOran5.Visible = True
        Me.colsOran5.VisibleIndex = 14
        '
        'colsbWebGoruntule
        '
        Me.colsbWebGoruntule.Caption = "WebGoruntule"
        Me.colsbWebGoruntule.FieldName = "bWebGoruntule"
        Me.colsbWebGoruntule.Name = "colsbWebGoruntule"
        Me.colsbWebGoruntule.Visible = True
        Me.colsbWebGoruntule.VisibleIndex = 15
        '
        'ContextMenu1
        '
        ...
        Me.printlink1.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"", "Yeni Stok Kayýtlarý", "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"[User Name]", "Stok Ýþlemleri", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
        ...
        Me.Name = "frm_stok_fiyatidegisen"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Fiyati Deðiþen Stok Kayýtlarý"
...
#End Region
    ...
    Public mevcut
    Public yeni
    Public etiket As Boolean = False
    ...
    Private Sub frm_stok_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        colsFiyat5.Caption = sFiyat5Aciklama
    ...
    Private Sub gorunum_yazdir()
        ...
        kriter += Microsoft.VisualBasic.Left(tarih1, 10) & " ve " & Microsoft.VisualBasic.Left(tarih2.ToString, 10) & " Tarihleri Arasýnda Fiyat Deðiþimi Yapýlan Stoklar" & vbCrLf
        Me.printlink1.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"", kriter, "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"[User Name]", "Stok Ýþlemleri", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
    ...
    End Sub
    Private Sub etiket_gorunum()
        If etiket = True Then
            colMALIYET.Visible = False
            colNETMALIYET.Visible = False
            colORAN1.Visible = False
            colORAN2.Visible = False
            colORAN3.Visible = False
            colsOran4.Visible = False
            colsOran5.Visible = False
            colMALIYET.OptionsColumn.ShowInCustomizationForm = False
            colNETMALIYET.OptionsColumn.ShowInCustomizationForm = False
            ...
            colsOran4.OptionsColumn.ShowInCustomizationForm = False
            colsOran5.OptionsColumn.ShowInCustomizationForm = False
        Else
            colMALIYET.Visible = True
            colORAN1.Visible = True
            colORAN2.Visible = True
            colORAN3.Visible = True
            colsOran4.Visible = True
            colsOran5.Visible = True
        End If
    End Sub
    ...
    Public Function stok() As DataSet
        ...
        'kriter = "WHERE stok.dteKayitTarihi between '" & Microsoft.VisualBasic.Left(tarih1.ToString, 10) + " 00:00:00" & "' and '" & Microsoft.VisualBasic.Left(tarih2.ToString, 10) + " 23:59:59" & "' "
        If stokkodu <> "" Then
        ...
        End If
        If etiket = True Then
            'kriter += " AND stok.nStokID IN (SELECT nStokID FROM tbStokFiyati WHERE (dteFiyatTespitTarihi BETWEEN '" & Microsoft.VisualBasic.Left(tarih1, 10) & "' AND '" & Microsoft.VisualBasic.Left(tarih2, 10) & "') and (sFiyatTipi <>'" & sFiyatM & "') )"
            kriter += " AND stok.nStokID IN (SELECT nStokID FROM tbStokFiyati WHERE (dteFiyatTespitTarihi BETWEEN '" & Microsoft.VisualBasic.Left(tarih1, 10) & "' AND '" & Microsoft.VisualBasic.Left(tarih2, 10) & "') and (sFiyatTipi IN('" & sFiyat1 & "','" & sFiyat2 & "','" & sFiyat3 & "','" & sFiyat4 & "','" & sFiyat5 & "')) )"
        Else
            'kriter += " AND stok.nStokID IN (SELECT nStokID FROM tbStokFiyati WHERE (dteFiyatTespitTarihi BETWEEN '" & Microsoft.VisualBasic.Left(tarih1, 10) & "' AND '" & Microsoft.VisualBasic.Left(tarih2, 10) & "'))"
            kriter += " AND stok.nStokID IN (SELECT nStokID FROM tbStokFiyati WHERE (dteFiyatTespitTarihi BETWEEN '" & Microsoft.VisualBasic.Left(tarih1, 10) & "' AND '" & Microsoft.VisualBasic.Left(tarih2, 10) & "') and (sFiyatTipi IN('" & sFiyat1 & "','" & sFiyat2 & "','" & sFiyat3 & "''" & sFiyat4 & "','" & sFiyat5 & "')) )"
        End If
        ...
        conn.ConnectionString = connection
        adapter.SelectCommand = cmd
        cmd.CommandText = sorgu_query("SET DATEFORMAT DMY SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT stok.dteKayitTarihi,stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.bWebGoruntule,stok.sKavala,stok.sModel,stok.sBirimCinsi1, barkod.sBarkod, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID) AS Mevcut, ISNULL((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat1 & "'), 0) AS PESIN, ISNULL((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat3 & "'), 0) AS ONAY, ISNULL((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat2 & "'), 0) AS ALTIAY, ISNULL((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat4 & "'), 0) AS FIYAT4, ISNULL((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat5 & "'), 0) AS FIYAT5, ISNULL((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyatM & "'),0) AS MALIYET, tbRenk.sRenkAdi, stok.sRenk, CAST(0 AS MONEY) AS ORANEKMALIYET, CAST(0 AS MONEY) AS ORAN1, CAST(0 AS MONEY) AS ORAN2, CAST(0 AS MONEY) AS ORAN3, CAST(0 AS MONEY) AS ORAN4, CAST(0 AS MONEY) AS ORAN5, CAST(0 AS MONEY) AS SONALISMIKTARI, CAST(0 AS MONEY) AS SONALISFIYATI, CAST(0 AS MONEY) AS SONALISMALIYETI,CAST(0 AS MONEY) AS ONCEKIALISMALIYETI,CAST('01.01.1900' AS DATETIME) AS ONCEKIALISTARIHI,CAST('01.01.1900' AS DATETIME) AS SONALISTARIHI,CAST(0 AS MONEY) AS NETMALIYET,CAST(0 AS MONEY) AS EKMALIYET FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") AS T  " & kriter2 & "  ORDER BY sKodu")
        cmd.Connection = conn
        conn.Open()
    ...
    Private Sub kontrol_oran()
        ...
        For Each dr In DataSet1.Tables(0).Rows
            ...
            Try
                If dr("FIYAT4") <> 0 Then
                    dr("ORAN4") = ((dr("FIYAT4") - dr("NETMALIYET")) / dr("NETMALIYET"))
                End If
            Catch ex As Exception
            End Try
            Try
