...
Public Class frm_fatura_kalemleri_silinen
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_fatura_kalemleri_silinen))
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.coldtefisTarihi, Me.coldteValorTarihi, Me.collFisNo, Me.colsFirmaKodu, Me.colsFirmaAciklama, Me.colHT, Me.colsStokKodu, Me.colsModel, Me.colsStokAciklama, Me.colsRenk, Me.colsBeden, Me.colsDepo, Me.colsFiyatTipi, Me.collCikisMiktar1, Me.collGirisMiktar1, Me.collBrutFiyat, Me.collBrutTutar, Me.colnIskontoYuzdesi, Me.colnKdvOrani, Me.colsStokIslem, Me.collSiparisNo, Me.collIrsaliyeNo, Me.coldteIrsaliyeTarihi, Me.colsAciklama, Me.collToplamMiktar, Me.collMalBedeli, Me.collMalIskontoTutari, Me.colnDipIskontoYuzdesi1, Me.colnDipIskontoYuzdesi2, Me.collDipIskontoTutari1, Me.collDipIskontoTutari2, Me.collDipIskontoTutari3, Me.colnKdvOrani1, Me.colnKdvOrani2, Me.colnKdvOrani3, Me.colnKdvOrani4, Me.colnKdvOrani5, Me.collKdv1, Me.collKdv2, Me.collKdv3, Me.collKdv4, Me.collKdv5, Me.collEkmaliyet1, Me.collEkmaliyet2, Me.collEkmaliyet3, Me.collKdv, Me.collNetTutar, Me.colsAciklama1, Me.colsAciklama2, Me.colsAciklama3, Me.colsAciklama4, Me.colsAciklama5, Me.colbFisTamamlandimi, Me.collKdvMatrahi1, Me.collKdvMatrahi2, Me.collKdvMatrahi3, Me.collKdvMatrahi4, Me.collKdvMatrahi5, Me.collKdvMatrahi, Me.colsBarkod, Me.colISK1, Me.colISK2, Me.colISK3, Me.colISK4, Me.colGERCEKFIYAT, Me.colGERCEKTOPLAM, Me.collKdvTutari, Me.collDahilBrutFiyat, Me.collDahilBrutTutar, Me.colsDovizCinsi1, Me.collDovizMiktari1, Me.colnStokFisiId, Me.colMasterKullanici, Me.colMasterTarih, Me.colDetayKullanici, Me.colDetayTarih, Me.collIskontoTutari, Me.colFIYAT1, Me.colFIYAT2, Me.colFIYAT3, Me.colFiyatFirma, Me.coldteUpdateTarihi})
        ...
        Me.collIskontoTutari.VisibleIndex = 11
        ...
        'coldteUpdateTarihi
        '
        Me.coldteUpdateTarihi.Caption = "SilTarihi"
        Me.coldteUpdateTarihi.DisplayFormat.FormatString = "dd/MM/yyyy HH:mm:ss t"
        Me.coldteUpdateTarihi.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
        Me.coldteUpdateTarihi.FieldName = "dteUpdateTarihi"
        Me.coldteUpdateTarihi.Name = "coldteUpdateTarihi"
        Me.coldteUpdateTarihi.Visible = True
        Me.coldteUpdateTarihi.VisibleIndex = 12
        '
        'ps
        '
        ...
        Me.Name = "frm_fatura_kalemleri_silinen"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Silinen Fiþ Detaylari"
...
#End Region
    ...
    Public Function stok(ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String, ByVal sFisTipi As String, ByVal nGirisCikis As String, ByVal dteFisTarihi1 As DateTime, ByVal dteFisTarihi2 As DateTime, ByVal lFisNo1 As Int64, ByVal lFisNo2 As Int64, ByVal lNetTutar1 As Decimal, ByVal lNetTutar2 As Decimal, ByVal sDepo As String, ByVal sHareketTipi As String) As DataSet
        Dim kriter As String = " Where auStokFisiDetayi.nKayitTipi = 3 AND (auStokFisiDetayi.sFisTipi = '" & sFisTipi & "')"
        kriter += " AND auStokFisiDetayi.dteFisTarihi between '" & dteFisTarihi1 & "' and '" & dteFisTarihi2 & "' "
        kriter += " and auStokFisiDetayi.lFisNo between '" & lFisNo1 & "' and '" & lFisNo2 & "'"
        'kriter += " and auStokFisiDetayi.lNetTutar between '" & lNetTutar1 & "' and '" & lNetTutar2 & "'"
        If Trim(sDepo) <> "" Then
            kriter += " And auStokFisiDetayi.sDepo = '" & sDepo & "' "
        End If
        If Trim(sHareketTipi) <> "" Then
            kriter += " And auStokFisiDetayi.sHareketTipi = '" & sHareketTipi & "' "
        End If
        If nGirisCikis > 0 Then
            kriter += " and auStokFisiDetayi.nGirisCikis = " & nGirisCikis & " "
        End If
