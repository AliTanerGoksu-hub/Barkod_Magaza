...
Public Class frm_stok_servis_arizatipleri
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_servis_arizatipleri))
        ...
        Me.Label1.Size = New System.Drawing.Size(754, 42)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(757, 3)
        Me.PictureBox1.Name = "PictureBox1"
        Me.PictureBox1.Size = New System.Drawing.Size(64, 42)
        ...
        Me.XtraTabControl1.Size = New System.Drawing.Size(818, 335)
        ...
        Me.XtraTabPage1.Text = "Arýza Tipleri..."
        '
        'GridControl1
        '
        ...
        'DataColumn2
        '
        Me.DataColumn2.ColumnName = "BIRIM"
        '
        'DataColumn3
        '
        Me.DataColumn3.ColumnName = "BIRIMADI"
        '
        'GridView1
        '
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colIND, Me.colKOD, Me.colAD})
        ...
        Me.colIND.SummaryItem.DisplayFormat = "{0} Kayýt"
        Me.colIND.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(184, 77)
        ...
        Me.txt_ad.Size = New System.Drawing.Size(145, 22)
        ...
        Me.txt_kod.Size = New System.Drawing.Size(145, 22)
        ...
        Me.printlink1.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"[User Name]", "Arýza Tipleri", "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"Powered by www.barkodyazilimevi.com", "Servis Yönetimi", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
        ...
        Me.Name = "frm_stok_servis_arizatipleri"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Arýza Tipleri"
...
#End Region
    ...
    Private Sub dataload_yerler()
        DataSet1 = sorgu(sorgu_query("SELECT     * FROM         ASTOKSERVISARIZATIPLERI"))
    ...
    Private Sub ekle(ByVal BIRIM As String, ByVal BIRIMADI As String)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED INSERT INTO ASTOKSERVISARIZATIPLERI (KOD, ACIKLAMA) VALUES     ('" & BIRIM & "', '" & BIRIMADI & "')")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    Private Sub duzelt(ByVal ind As Int64, ByVal BIRIM As String, ByVal BIRIMADI As String)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED UPDATE    ASTOKSERVISARIZATIPLERI SET              KOD = '" & BIRIM & "', ACIKLAMA = '" & BIRIMADI & "' WHERE IND =" & ind & "")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    Private Sub sil(ByVal ind As Int64)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("DELETE FROM ASTOKSERVISARIZATIPLERI WHERE IND = " & ind & "")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    ...
    Private Sub kayit_sil()
        If GridView1.RowCount > 0 Then
            ...
            kayitno = dr("IND")
            If kayitno > 0 Then
                If XtraMessageBox.Show(kayitno & vbTab & Sorgu_sDil("Nolu Arýza Tipi Kaydýný Silmek istediðinize Emin misiniz...?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
                    sil(kayitno)
                End If
            End If
            dataload_yerler()
