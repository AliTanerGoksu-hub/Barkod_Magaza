...
begin:
    ...
    Function LongLeftRotate(ByRef value As Long, ByRef Bits As Long) As Long
        ...
        LongLeftRotate = value
    End Function
    Private Function LongOverflowAdd(ByRef Val1 As Long, ByRef Val2 As Long) As Long
    ...
    End Function
    Private Function LongOverflowAdd4(ByRef Val1 As Long, ByRef Val2 As Long, ByRef val3 As Long, ByRef val4 As Long) As Long
        Dim lngHighWord As Long, lngLowWord As Long, lngOverflow As Long
