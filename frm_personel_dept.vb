...
Public Class frm_personel_dept
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_personel_dept))
        ...
        Me.XtraTabPage1.Text = "Departmanlar"
        '
        'GridControl1
        '
        ...
        Me.Name = "frm_personel_dept"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Maðaza Departmanlarý"
...
#End Region
    ...
    Private Sub dataload_yerler()
        DataSet1 = sorgu(sorgu_query("SELECT     * FROM         APERSONELDEPT"))
    ...
    Private Sub ekle(ByVal BIRIM As String, ByVal BIRIMADI As String)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED INSERT INTO APERSONELDEPT (KOD, ACIKLAMA) VALUES     ('" & BIRIM & "', '" & BIRIMADI & "')")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
    Private Sub duzelt(ByVal ind As Int64, ByVal BIRIM As String, ByVal BIRIMADI As String)
        ...
        If con.State = ConnectionState.Closed = True Then
            con.Open()
        End If
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED UPDATE    APERSONELDEPT SET              KOD = '" & BIRIM & "', ACIKLAMA = '" & BIRIMADI & "' WHERE IND =" & ind & "")
        cmd.ExecuteNonQuery()
        con.Close()
    End Sub
