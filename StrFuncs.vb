...
Module StrFuncs
    ...
    Public Function ShiftStrLeft(ByVal StrIn As String, ByVal Bits As Integer) As String
        ...
        CurPos = 1
        'UPGRADE_WARNING: Couldn't resolve default property of object StrLen. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
        StrLen = Len(StrIn)
        'UPGRADE_WARNING: Couldn't resolve default property of object StrLen. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
        'UPGRADE_WARNING: Couldn't resolve default property of object StrBits. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
        StrBits = StrLen * 8
        WorkStr = StrIn
        ...
        If (StrBits > Bits) Then
            ...
            If (ShiftBits > 0) Then
                For CurPos = 1 To Len(WorkStr)
                    ...
                    LeftPart = (CurByteVal And BitMask) And &HFFS
                    RightPart = (CurByteVal And InvMask) And &HFFS
    ...
    Public Function Base32Enc(ByVal StrIn As String) As String
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object StrChar. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
        StrChar = Len(StrIn)
        BitsProc = 0
        Mask32 = &H1FS
    ...
    Public Function Base32Dec(ByVal StrIn As String) As String
        ...
        ' Calculate metrics
        'UPGRADE_WARNING: Couldn't resolve default property of object BitsProc. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
        BitsProc = 0
        'UPGRADE_WARNING: Couldn't resolve default property of object BaseMask. Click for more: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
        BaseMask = &H1FS
        Carry = 0
        WorkStr = StrIn
        InBits = Len(StrIn) * 5
