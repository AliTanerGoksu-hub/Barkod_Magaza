...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_firma_risk))
        ...
        Me.Label1.Text = "Firma Risk Bilgileri Aþaðýdadýr..."
        '
        'PictureBox1
        '
        ...
        'ContextMenu1
        '
        Me.ContextMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem13, Me.MenuItem14, Me.MenuItem15, Me.MenuItem1, Me.MenuItem2, Me.MenuItem3, Me.MenuItem4, Me.MenuItem10, Me.MenuItem16, Me.MenuItem5, Me.MenuItem6, Me.MenuItem11, Me.MenuItem7, Me.MenuItem8, Me.MenuItem12, Me.MenuItem9})
        '
        'MenuItem13
        '
        ...
        Me.MenuItem16.Text = "Hýzlý Filtre"
        '
        'MenuItem5
        '
        ...
        Me.collCekSenetNo.VisibleIndex = 0
        Me.collCekSenetNo.Width = 58
        '
        'collTutar
        '
        ...
        Me.collTutar.VisibleIndex = 2
        Me.collTutar.Width = 60
        '
        'coldteVadeTarihi
        '
        ...
        Me.coldteVadeTarihi.VisibleIndex = 3
        Me.coldteVadeTarihi.Width = 67
        '
        'colsBankaKodu
        '
        ...
        Me.colsBankaKodu.VisibleIndex = 4
        Me.colsBankaKodu.Width = 63
        '
        'colsBankaAciklama
        '
        ...
        Me.colsBankaAciklama.VisibleIndex = 5
        Me.colsBankaAciklama.Width = 103
        '
        ...
        Me.colsOrjinalCekSenetNo.VisibleIndex = 1
        Me.colsOrjinalCekSenetNo.Width = 55
        '
        'colsVerenFirmaKodu
        '
        ...
        Me.colsVerenFirmaKodu.VisibleIndex = 6
        Me.colsVerenFirmaKodu.Width = 66
        '
        ...
        Me.colsVerenFirmaAciklama.VisibleIndex = 7
        Me.colsVerenFirmaAciklama.Width = 104
        '
        ...
        Me.colsIslem.VisibleIndex = 8
        Me.colsIslem.Width = 44
        '
        'colsAlanFirmaKodu
        '
        Me.colsAlanFirmaKodu.Caption = "AlanFirmaKodu"
        Me.colsAlanFirmaKodu.FieldName = "sAlanFirmaKodu"
        Me.colsAlanFirmaKodu.Name = "colsAlanFirmaKodu"
        '
        'colsAlanFirmaAciklama
        '
        Me.colsAlanFirmaAciklama.Caption = "AlanFirma"
        ...
        Me.colsHareketTipi.VisibleIndex = 9
        Me.colsHareketTipi.Width = 38
        '
        'colsDovizCinsi1
        '
        ...
        Me.colsDovizCinsi1.VisibleIndex = 10
        Me.colsDovizCinsi1.Width = 41
        '
        'collDovizMiktari1
        '
        ...
        Me.collDovizMiktari1.VisibleIndex = 12
        Me.collDovizMiktari1.Width = 70
        '
        'collDovizKuru1
        '
        ...
        Me.collDovizKuru1.VisibleIndex = 11
        ...
        Me.collTahsilat.VisibleIndex = 13
        '
        'collKalan
        '
        ...
        Me.printlink1.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"[User Name]", "Firma Risk Bilgileri", "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"Powered by www.barkodyazilimevi.com", "Finans Yönetimi", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
        ...
        Me.Bar3.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem5), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem1, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem2, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem3, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem4, True)})
        ...
        'BarButtonItem5
        '
        Me.BarButtonItem5.Caption = "Çek/Senet Hareketleri"
        ...
        Me.Name = "frm_firma_risk"
        Me.ShowIcon = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Risk Bilgileri"
...
#End Region
    ...
    Public Function stok() As DataSet
        Dim kriter As String = "WHERE (tbCekSenet.sCekSenetTipi IN ('AC','AS'))"
        Dim kriter2 As String = "WHERE (tbCekSenet.sCekSenetTipi IN ('AC','AS'))"
        kriter += " AND tbCekSenet.dteVadeTarihi between '01/01/1900' and '31/12/2078' "
        kriter2 += " AND tbCekSenet.dteVadeTarihi > '" & Today & "'  "
        kriter += " AND   (VEREN.nFirmaID = " & musterino & ")"
        kriter2 += " AND   (VEREN.nFirmaID = " & musterino & ")"
        kriter += " and tbCekSenetBordro.nCekSenetIslem IN(1,6,9,11) "
        kriter2 += " and tbCekSenetBordro.nCekSenetIslem IN(3,4,5) "
        Dim conn As New OleDb.OleDbConnection
        Dim cmd As New OleDb.OleDbCommand
        Dim adapter As New OleDb.OleDbDataAdapter
        conn.ConnectionString = connection
        adapter.SelectCommand = cmd
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT tbCekSenet.nCekSenetID, tbCekSenet.lCekSenetNo, tbCekSenet.sCekSenetTipi,tbCekSenet.lTutar, tbCekSenet.dteVadeTarihi, tbCekSenet.sBankaKodu, tbCekSenet.sBankaHesapNo,tbCekSenet.sIl, tbCekSenet.sSemt, tbCekSenet.sBorclusu, tbCekSenet.sBorcluVergiDairesi, tbCekSenet.sBorcluVergiNumarasi, tbCekSenet.sNot, tbCekSenet.nVerenID,tbCekSenet.sCekSenetKodu1, tbCekSenet.sCekSenetKodu2,tbBanka.sAciklama AS sBankaAciklama, tbCekSenet.sOrjinalCekSenetNo, VEREN.sKodu AS sVerenFirmaKodu, VEREN.sAciklama AS sVerenFirmaAciklama, tbCekSenet.nSonCekSenetIslem, tbCekSenetIslem.sAciklama AS sIslem, VEREN.sKodu AS sAlanFirmaKodu, VEREN.sAciklama AS sAlanFirmaAciklama, tbCekSenet.sHareketTipi, tbCekSenet.sDovizCinsi1, tbCekSenet.lDovizMiktari1, tbCekSenet.lDovizKuru1,tbCekSenetBordro.nBordroSatirID, tbCekSenetBordro.dteBordroTarihi,(SELECT SUM(lProtestoMasrafi) FROM tbCekSenetBordro WHERE nCekSenetID = tbCekSenet.nCekSenetID) AS lTahsilat, tbCekSenet.lTutar - (SELECT SUM(lProtestoMasrafi) FROM tbCekSenetBordro WHERE nCekSenetID = tbCekSenet.nCekSenetID) AS lKalan FROM tbFirma VEREN INNER JOIN tbCekSenet ON VEREN.nFirmaID = tbCekSenet.nVerenID INNER JOIN tbBanka ON tbCekSenet.sBankaKodu = tbBanka.sBankaKodu INNER JOIN tbHareketTipi ON tbCekSenet.sHareketTipi = tbHareketTipi.sHareketTipi INNER JOIN tbFirma tbFirma_1 INNER JOIN tbCekSenetBordro ON tbFirma_1.nFirmaID = tbCekSenetBordro.nFirmaID ON tbCekSenet.nSonBordroSatirID = tbCekSenetBordro.nBordroSatirID INNER JOIN tbCekSenetIslem ON tbCekSenet.nSonCekSenetIslem = tbCekSenetIslem.nCekSenetIslem " & kriter & " UNION ALL SELECT tbCekSenet.nCekSenetID, tbCekSenet.lCekSenetNo, tbCekSenet.sCekSenetTipi,tbCekSenet.lTutar, tbCekSenet.dteVadeTarihi, tbCekSenet.sBankaKodu, tbCekSenet.sBankaHesapNo,tbCekSenet.sIl, tbCekSenet.sSemt, tbCekSenet.sBorclusu, tbCekSenet.sBorcluVergiDairesi, tbCekSenet.sBorcluVergiNumarasi, tbCekSenet.sNot, tbCekSenet.nVerenID,tbCekSenet.sCekSenetKodu1, tbCekSenet.sCekSenetKodu2,tbBanka.sAciklama AS sBankaAciklama, tbCekSenet.sOrjinalCekSenetNo, VEREN.sKodu AS sVerenFirmaKodu, VEREN.sAciklama AS sVerenFirmaAciklama, tbCekSenet.nSonCekSenetIslem, tbCekSenetIslem.sAciklama AS sIslem, VEREN.sKodu AS sAlanFirmaKodu, VEREN.sAciklama AS sAlanFirmaAciklama, tbCekSenet.sHareketTipi, tbCekSenet.sDovizCinsi1, tbCekSenet.lDovizMiktari1, tbCekSenet.lDovizKuru1,tbCekSenetBordro.nBordroSatirID, tbCekSenetBordro.dteBordroTarihi,(SELECT SUM(lProtestoMasrafi) FROM tbCekSenetBordro WHERE nCekSenetID = tbCekSenet.nCekSenetID) AS lTahsilat, tbCekSenet.lTutar - (SELECT SUM(lProtestoMasrafi) FROM tbCekSenetBordro WHERE nCekSenetID = tbCekSenet.nCekSenetID) AS lKalan FROM tbFirma VEREN INNER JOIN tbCekSenet ON VEREN.nFirmaID = tbCekSenet.nVerenID INNER JOIN tbBanka ON tbCekSenet.sBankaKodu = tbBanka.sBankaKodu INNER JOIN tbHareketTipi ON tbCekSenet.sHareketTipi = tbHareketTipi.sHareketTipi INNER JOIN tbFirma tbFirma_1 INNER JOIN tbCekSenetBordro ON tbFirma_1.nFirmaID = tbCekSenetBordro.nFirmaID ON tbCekSenet.nSonBordroSatirID = tbCekSenetBordro.nBordroSatirID INNER JOIN tbCekSenetIslem ON tbCekSenet.nSonCekSenetIslem = tbCekSenetIslem.nCekSenetIslem " & kriter2 & " ORDER BY tbCekSenet.dteVadeTarihi")
        cmd.Connection = conn
        conn.Open()
    ...
    Private Sub MenuItem16_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem16.Click
        If MenuItem16.Checked = False Then
            GridView1.OptionsView.ShowFilterPanelMode = DevExpress.XtraGrid.Views.Base.ShowFilterPanelMode.Default
            GridView1.OptionsCustomization.AllowFilter = True
            GridView1.OptionsView.ShowAutoFilterRow = True
            MenuItem16.Checked = True
        ElseIf MenuItem16.Checked = True Then
