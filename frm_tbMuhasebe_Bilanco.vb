...
Public Class frm_tbMuhasebe_Bilanco
    Public firmano
    Public donemno
    Public connection
    Public nFirmaID
    ...
    Dim lAktifToplam As Decimal = 0
    Dim lPasifToplam As Decimal = 0
    ...
    Private Sub dataload(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime)
        ...
        If sec_bakiye.Text = "Aktif" Then
            SplitContainer1.Panel1Collapsed = False
            SplitContainer1.Panel2Collapsed = True
        ElseIf sec_bakiye.Text = "Pasif" Then
            SplitContainer1.Panel1Collapsed = True
            SplitContainer1.Panel2Collapsed = False
        ElseIf sec_bakiye.Text = "Aktif+Pasif" Then
            SplitContainer1.Panel1Collapsed = False
            SplitContainer1.Panel2Collapsed = False
        End If
        If sec_bKarZarar.Checked = True Then
            Dim lKarZarar As Decimal = lAktifToplam - lPasifToplam
            Dim dr As DataRow
            For Each dr In ds_tbPasif.Tables(0).Rows
                If dr("sHesap2") = "59" And dr("sHesap3") = "59" Then
                    dr("Simdiki") = lKarZarar
                ElseIf dr("sHesap2") = "5" And dr("sHesap3") = "5" Then
                    If dr("nDurum") = 4 Then
                        dr("Genel") = dr("Genel") + lKarZarar
                    Else
                        dr("Simdiki") = dr("Simdiki") + lKarZarar
                    End If
                End If
                If lKarZarar > 0 Then
                    If dr("sHesap2") = "59" And dr("sHesap3") = "590" Then
                        dr("Onceki") = lKarZarar
                    End If
                Else
                    If dr("sHesap2") = "59" And dr("sHesap3") = "591" Then
                        dr("Onceki") = lKarZarar
                    End If
                End If
            Next
    ...
    Public Sub Dataload_tbAktif(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime)
        ...
        For Each dr In ds_tbAktif.Tables(0).Rows
            If Trim(dr("nDurum")) = "0" Then
            ElseIf Trim(dr("nDurum")) = "1" Then
                dr("Genel") = 0
                dr("Onceki") = 0
            ElseIf Trim(dr("nDurum")) = "2" Then
                dr("Genel") = 0
                dr("Onceki") = dr("Simdiki")
                dr("Simdiki") = 0
            ElseIf Trim(dr("nDurum")) = "3" Then
                dr("Genel") = 0
                dr("Onceki") = dr("Simdiki")
                dr("Simdiki") = 0
            ElseIf Trim(dr("nDurum")) = "4" Then
                dr("Genel") = dr("Simdiki")
                dr("Simdiki") = 0
                lAktifToplam = lAktifToplam + dr("Genel")
            End If
            If dr("nDurum") = 0 Then
                If s0 = "" Then
                    s0 = "I"
    ...
    Public Sub Dataload_tbPasif(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime)
        ...
        For Each dr In ds_tbPasif.Tables(0).Rows
            ...
            ElseIf Trim(dr("nDurum")) = "4" Then
                dr("Genel") = dr("Simdiki")
                dr("Simdiki") = 0
                lPasifToplam = lPasifToplam + dr("Genel")
            End If
            If dr("nDurum") = 0 Then
                If s0 = "" Then
                    s0 = "I"
    ...
    Private Sub gorunum_yazdir()
        If GridControl1.Focused = True Then
            ...
            kriter += DateEdit1.EditValue & " ve " & DateEdit2.EditValue & Sorgu_sDil(" Tarihleri Arasındaki Bilanço Aktifi", sDil) & vbCrLf
        ...
        ElseIf GridControl2.Focused = True Then
            Dim kriter As String = ""
            kriter += DateEdit1.EditValue & " ve " & DateEdit2.EditValue & Sorgu_sDil(" Tarihleri Arasındaki Bilanço Pasifi", sDil) & vbCrLf
