...
Public Class frm_Perakende_Faaliyet_GunlukToplam
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_Perakende_Faaliyet_GunlukToplam))
        ...
        Me.collToplamIskonto = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        Me.collToplamTahsilat = New DevExpress.XtraGrid.Columns.GridColumn
        Me.colnSatisKayit = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        Me.PanelControl1.Size = New System.Drawing.Size(824, 148)
        ...
        Me.GroupControl1.Size = New System.Drawing.Size(726, 144)
        ...
        Me.PictureBox1.Size = New System.Drawing.Size(94, 144)
        ...
        Me.PanelControl3.Location = New System.Drawing.Point(0, 148)
        Me.PanelControl3.Name = "PanelControl3"
        Me.PanelControl3.Size = New System.Drawing.Size(824, 211)
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.coldteTarih, Me.collToplamMiktar, Me.collToplamIskonto, Me.collNetTutar, Me.collTahsilat, Me.collVisa, Me.collDiger, Me.collToplamTahsilat, Me.colnSatisKayit})
        ...
        Me.coldteTarih.DisplayFormat.FormatString = "D"
        ...
        Me.collToplamMiktar.VisibleIndex = 1
        Me.collToplamMiktar.Width = 81
        '
        'collToplamIskonto
        '
        Me.collToplamIskonto.Caption = "Iskonto"
        Me.collToplamIskonto.DisplayFormat.FormatString = "#,0.00"
        Me.collToplamIskonto.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.collToplamIskonto.FieldName = "lToplamIskonto"
        Me.collToplamIskonto.Name = "collToplamIskonto"
        Me.collToplamIskonto.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lToplamIskonto", "{0:#,0.00}")})
        Me.collToplamIskonto.Visible = True
        Me.collToplamIskonto.VisibleIndex = 3
        Me.collToplamIskonto.Width = 81
        '
        'collNetTutar
        '
        Me.collNetTutar.Caption = "Satýþ"
        ...
        Me.collNetTutar.VisibleIndex = 4
        Me.collNetTutar.Width = 81
        '
        'collTahsilat
        '
        Me.collTahsilat.Caption = "Nakit"
        ...
        Me.collVisa.VisibleIndex = 6
        Me.collVisa.Width = 81
        '
        'collDiger
        '
        ...
        Me.collDiger.VisibleIndex = 7
        Me.collDiger.Width = 81
        '
        'collToplamTahsilat
        '
        Me.collToplamTahsilat.Caption = "Tahsilat"
        Me.collToplamTahsilat.DisplayFormat.FormatString = "#,0.00"
        Me.collToplamTahsilat.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.collToplamTahsilat.FieldName = "lToplamTahsilat"
        Me.collToplamTahsilat.Name = "collToplamTahsilat"
        Me.collToplamTahsilat.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lToplamTahsilat", "{0:#,0.00}")})
        Me.collToplamTahsilat.Visible = True
        Me.collToplamTahsilat.VisibleIndex = 8
        Me.collToplamTahsilat.Width = 96
        '
        'colnSatisKayit
        '
        Me.colnSatisKayit.Caption = "Satýþ Kaydý"
        Me.colnSatisKayit.FieldName = "nSatisKayit"
        Me.colnSatisKayit.Name = "colnSatisKayit"
        Me.colnSatisKayit.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "nSatisKayit", "{0} Kayýt")})
        Me.colnSatisKayit.Visible = True
        Me.colnSatisKayit.VisibleIndex = 2
        Me.colnSatisKayit.Width = 81
        '
        'ps
        '
        ...
        '
        'frm_Perakende_Faaliyet_GunlukToplam
        '
        ...
        Me.Name = "frm_Perakende_Faaliyet_GunlukToplam"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Günlük Kasa Toplamlarý Raporu"
...
#End Region
    ...
    Private Sub dataload_satislar(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal sMagaza As String, ByVal kasatipi As String, ByVal kasiyer As String, ByVal harekettipi As String, ByVal fistipi As String)
        ...
        kriter_odeme = " and (tbOdeme.dteOdemeTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') "
        ...
        End If
        'DataSet1 = sorgu(sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT dteTarih, SUM(lToplamMiktar) AS lToplamMiktar, SUM(lToplamIskonto) AS lToplamIskonto, SUM(lNetTutar) AS lNetTutar, SUM(lTahsilat) AS lTahsilat, SUM(lVisa) AS lVisa, SUM(lDiger) AS lDiger, SUM(lTahsilat + lVisa + lDiger) AS lToplamTahsilat FROM (SELECT dteFaturaTarihi AS dteTarih , lToplamMiktar , lMalIskontoTutari + lDipIskontoTutari AS lToplamIskonto , lNetTutar , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi = 1 AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi = 1) Kapatma) AS lTahsilat , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi = 2 AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi = 2) Kapatma) AS lVisa , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi NOT IN (1 , 2) AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi NOT IN (1 , 2)) Kapatma) AS lDiger FROM tbAlisVeris " & kriter_satis & " AND (sFisTipi = 'K' OR sFisTipi = 'SK' OR sFisTipi = 'P' OR sFisTipi = 'SP' OR sFisTipi = 'KVF' OR sFisTipi = 'PD' OR sFisTipi = 'PTX' OR sFisTipi = 'KS') UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , SUM(tbOdeme.lOdemeTutar) AS lTahsilat , CAST(0 AS MONEY) AS lVisa , CAST(0 AS MONEY) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi = 1) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , CAST(0 AS MONEY) AS lTahsilat , SUM(tbOdeme.lOdemeTutar) AS lVisa , CAST(0 AS MONEY) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi = 2) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , CAST(0 AS MONEY) AS lTahsilat , CAST(0 AS MONEY) AS lVisa , SUM(tbOdeme.lOdemeTutar) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi NOT IN (1 , 2)) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi) tbGunluk GROUP BY dteTarih ORDER BY dteTarih"))
        'DataSet1 = sorgu(sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT dteTarih, SUM(lToplamMiktar) AS lToplamMiktar, nSatisKayit = CASE WHEN SUM(lTahsilat + lVisa + lDiger) <> 0 THEN COUNT(DISTINCT nAlisVerisID) - 1 ELSE COUNT(DISTINCT nAlisVerisID) END,SUM(lToplamIskonto) AS lToplamIskonto, SUM(lNetTutar) AS lNetTutar, SUM(lTahsilat) AS lTahsilat, SUM(lVisa) AS lVisa, SUM(lDiger) AS lDiger, SUM(lTahsilat + lVisa + lDiger) AS lToplamTahsilat FROM (SELECT dteFaturaTarihi AS dteTarih , lToplamMiktar , nAlisVerisID,lMalIskontoTutari + lDipIskontoTutari AS lToplamIskonto , lNetTutar , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi = 1 AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi = 1) Kapatma) AS lTahsilat , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi = 2 AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi = 2) Kapatma) AS lVisa , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi NOT IN (1 , 2) AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi NOT IN (1 , 2)) Kapatma) AS lDiger FROM tbAlisVeris " & kriter_satis & " AND (sFisTipi = 'K' OR sFisTipi = 'SK' OR sFisTipi = 'P' OR sFisTipi = 'SP' OR sFisTipi = 'KVF' OR sFisTipi = 'PD' OR sFisTipi = 'PTX' OR sFisTipi = 'KS') UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , '' as nAlisverisID,CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , SUM(tbOdeme.lOdemeTutar) AS lTahsilat , CAST(0 AS MONEY) AS lVisa , CAST(0 AS MONEY) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi = 1) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , '' as nAlisVerisID,CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , CAST(0 AS MONEY) AS lTahsilat , SUM(tbOdeme.lOdemeTutar) AS lVisa , CAST(0 AS MONEY) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi = 2) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , '' AS nAlisVerisID,CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , CAST(0 AS MONEY) AS lTahsilat , CAST(0 AS MONEY) AS lVisa , SUM(tbOdeme.lOdemeTutar) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi NOT IN (1 , 2)) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi) tbGunluk GROUP BY dteTarih ORDER BY dteTarih"))
        DataSet1 = sorgu(sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT dteTarih, SUM(lToplamMiktar) AS lToplamMiktar, nSatisKayit = CASE WHEN SUM(lTahsilat + lVisa + lDiger) <> 0 THEN COUNT(DISTINCT nAlisVerisID) - 1 ELSE COUNT(DISTINCT nAlisVerisID) END,SUM(lToplamIskonto) AS lToplamIskonto, SUM(lNetTutar) AS lNetTutar, SUM(lTahsilat) AS lTahsilat, SUM(lVisa) AS lVisa, SUM(lDiger) AS lDiger, SUM(lTahsilat + lVisa + lDiger) AS lToplamTahsilat FROM (SELECT dteFaturaTarihi AS dteTarih , lToplamMiktar , nAlisVerisID,lMalIskontoTutari + lDipIskontoTutari AS lToplamIskonto , lNetTutar , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi = 1 AND (nAlisverisID = tbAlisVeris.nAlisVerisID) ) Kapatma) AS lTahsilat , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi = 2 AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi = 2) Kapatma) AS lVisa , (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM (SELECT ISNULL(SUM(lOdemeTutar) , 0) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nOdemeKodu = 1) AND tbOdemeSekli.nOdemeTipi NOT IN (1 , 2) AND (nAlisverisID = tbAlisVeris.nAlisVerisID) UNION ALL SELECT - SUM(lOdemeTutar) AS lOdemeTutar FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (nAlisverisID = tbAlisVeris.nAlisVerisID) AND (nOdemeKodu = 3) AND tbOdemeSekli.nOdemeTipi NOT IN (1 , 2)) Kapatma) AS lDiger FROM tbAlisVeris " & kriter_satis & " AND (sFisTipi = 'K' OR sFisTipi = 'SK' OR sFisTipi = 'P' OR sFisTipi = 'SP' OR sFisTipi = 'KVF' OR sFisTipi = 'PD' OR sFisTipi = 'PTX' OR sFisTipi = 'KS') UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , '' as nAlisverisID,CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , SUM(tbOdeme.lOdemeTutar) AS lTahsilat , CAST(0 AS MONEY) AS lVisa , CAST(0 AS MONEY) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi = 1) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , '' as nAlisVerisID,CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , CAST(0 AS MONEY) AS lTahsilat , SUM(tbOdeme.lOdemeTutar) AS lVisa , CAST(0 AS MONEY) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi = 2) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi UNION ALL SELECT tbOdeme.dteOdemeTarihi AS dteTarihi , CAST(0 AS MONEY) AS lToplamMiktar , '' AS nAlisVerisID,CAST(0 AS MONEY) AS lToplamIskonto , CAST(0 AS MONEY) AS lNetTutar , CAST(0 AS MONEY) AS lTahsilat , CAST(0 AS MONEY) AS lVisa , SUM(tbOdeme.lOdemeTutar) AS lDiger FROM tbOdeme INNER JOIN tbOdemeSekli ON tbOdeme.sOdemeSekli = tbOdemeSekli.sOdemeSekli WHERE (tbOdeme.nOdemeKodu = 2) AND (tbOdemeSekli.nOdemeTipi NOT IN (1 , 2)) " & kriter_odeme & " GROUP BY tbOdeme.dteOdemeTarihi) tbGunluk GROUP BY dteTarih ORDER BY dteTarih"))
    End Sub
    ...
    Private Sub gorunum_yazdir()
        ...
        kriter += DateEdit1.EditValue.ToLongDateString & " ve " & DateEdit2.EditValue.ToLongDateString & " Tarihleri Arasýndaki Kasa Raporu Toplamlarý" & vbCrLf
    ...
    Friend WithEvents collToplamIskonto As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents collToplamTahsilat As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colnSatisKayit As DevExpress.XtraGrid.Columns.GridColumn
End Class
