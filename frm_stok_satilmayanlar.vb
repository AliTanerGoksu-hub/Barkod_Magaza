...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'sec_kriter_tip
        '
        Me.sec_kriter_tip.EditValue = "Satýþa Göre"
        ...
        Me.sec_kriter_tip.Properties.Items.AddRange(New Object() {"Satýþa Göre", "Alýþa Göre"})
        ...
        Me.sec_kriter_gun.Properties.Items.AddRange(New Object() {"Baþlar", "Biter", "Eþittir", "Ýçerir", "Ýçermez", "Boþ", "Dolu", "Farklý", "Büyük", "Küçük", "Aralýk"})
        ...
        Me.colGunSatis.Caption = "Son Satýþ"
        ...
        Me.colGunAlis.Caption = "Son Alýþ"
        ...
        'colBekleyenDeger
        '
        Me.colBekleyenDeger.Caption = "Bekleyen Deðer"
...
#End Region
    ...
    Private Sub satir_Pasif()
        If GridView1.RowCount > 0 Then
            If XtraMessageBox.Show(Sorgu_sDil("Seçili Kayýtlarý Pasif Etmek Ýstediðinize Emin misiniz...?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
                Dim s As String
                Dim arr As Integer()
                Dim i As Integer
    ...
    Private Sub tbStok_Pasif(ByVal sModel As String, Optional ByVal uyari As Boolean = True)
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            If uyari = True Then
                XtraMessageBox.Show(Sorgu_sDil("Kayýt Baþarýyla Deðiþtirildi...", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
            'stok_kontrol()
        Catch ex As Exception
            XtraMessageBox.Show(Sorgu_sDil("Üzgünüm,Hareket Görmüþ Kaydý Deðiþtiremezsiniz...!", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
