...
IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('tbStokFisiMaster') AND name = 'nKdvMuafiyetKodu')
BEGIN
    ALTER TABLE tbStokFisiMaster ADD nKdvMuafiyetKodu INT NULL
    PRINT 'nKdvMuafiyetKodu alanı eklendi.'
END
GO
