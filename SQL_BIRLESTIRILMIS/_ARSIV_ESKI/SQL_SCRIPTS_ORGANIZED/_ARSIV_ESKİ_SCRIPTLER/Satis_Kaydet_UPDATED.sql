...
@Fiyat4 numeric(18, 2),
@Miktar4 numeric(14),
@EkMaliyet3 numeric(18, 2),
@sAciklama2 varchar(255),
@sAciklama3 varchar(255)
as

-- ============================================
-- CRITICAL FIX: Set session settings FIRST!
-- ============================================
SET DATEFORMAT DMY
