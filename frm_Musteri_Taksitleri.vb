...
Public Class frm_Musteri_Taksitleri
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_Musteri_Taksitleri))
        ...
        Me.GroupControl1.Size = New System.Drawing.Size(463, 76)
        ...
        Me.sec_kefil.Size = New System.Drawing.Size(76, 20)
        ...
        Me.Label7.Text = "VadeTarihi:"
        '
        'Label6
        '
        Me.Label6.Location = New System.Drawing.Point(156, 21)
        ...
        Me.PanelControl2.Location = New System.Drawing.Point(0, 378)
        ...
        Me.PanelControl3.Size = New System.Drawing.Size(824, 298)
        ...
        Me.GridControl1.Size = New System.Drawing.Size(820, 294)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1})
        '
        'ContextMenu1
        '
        Me.ContextMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem13, Me.MenuItem14, Me.MenuItem15, Me.MenuItem16, Me.MenuItem17, Me.MenuItem18, Me.MenuItem19, Me.MenuItem23, Me.MenuItem32, Me.MenuItem22, Me.MenuItem21, Me.MenuItem31, Me.MenuItem20, Me.MenuItem24, Me.MenuItem2, Me.MenuItem1, Me.MenuItem3, Me.MenuItem4, Me.MenuItem10, Me.MenuItem5, Me.MenuItem6, Me.MenuItem11, Me.MenuItem7, Me.MenuItem8, Me.MenuItem12, Me.MenuItem9})
        '
        'MenuItem13
        '
        ...
        Me.MenuItem32.Shortcut = System.Windows.Forms.Shortcut.CtrlZ
        Me.MenuItem32.Text = "Karlýlýk Akýþ Tablosu"
        '
        'MenuItem22
        '
        ...
        Me.MenuItem24.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem27, Me.MenuItem28, Me.MenuItem29, Me.MenuItem30, Me.MenuItem25, Me.MenuItem26})
        Me.MenuItem24.Text = "Raporla"
        '
        'MenuItem27
        '
        Me.MenuItem27.Index = 0
        Me.MenuItem27.Text = "Önizle"
        '
        'MenuItem28
        '
        Me.MenuItem28.Index = 1
        Me.MenuItem28.Text = "Dizayn"
        '
        'MenuItem29
        '
        Me.MenuItem29.Index = 2
        Me.MenuItem29.Shortcut = System.Windows.Forms.Shortcut.F2
        Me.MenuItem29.Text = "Yazdýr"
        '
        'MenuItem30
        '
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colnMusteriID, Me.colsMagaza, Me.collKodu, Me.colsAdi, Me.colsSoyadi, Me.colMusteri, Me.colnCinsiyet, Me.colsEmail, Me.colsIsYeriAdi, Me.colsIsAdresi, Me.colsIsTelefonu, Me.colsEvAdresi, Me.colsEvTelefonu, Me.colsSigortaNo, Me.colbEvlimi, Me.coldteEvlilikTarihi, Me.coldteDogumTarihi, Me.colsDogumYeri, Me.colsEhliyetNo, Me.colsKanGrubu, Me.colISTIHBARAT, Me.colsGSM, Me.colsFax, Me.collTutari, Me.collTahsilat, Me.collKalan, Me.collBakiye, Me.coldteTarihi, Me.colnGecikme})
        ...
        Me.GridView1.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Musteri", Nothing, "{0} Kayýt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Musteri", Me.colMusteri, "{0} Kayýt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lTutari", Nothing, "Tutar: {0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lTutari", Me.collTutari, "{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lTahsilat", Nothing, "Tahsilat: {0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lTahsilat", Me.collTahsilat, "{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lKalan", Nothing, "Kalan: {0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lKalan", Me.collKalan, "{0:#,0.00}")})
        ...
        Me.collTahsilat.VisibleIndex = 7
        '
        'collKalan
        '
        ...
        Me.coldteTarihi.VisibleIndex = 5
        '
        'colnGecikme
        '
        ...
        Me.Name = "frm_Musteri_Taksitleri"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Müþteri Taksitleri"
...
#End Region
    ...
    Private Sub gorunum_yazdir()
        ...
        kriter += " Müþteri Taksitleri " & vbCrLf
        kriter += "Vade = " & DateEdit1.EditValue & "-" & DateEdit2.EditValue
    ...
    Public Function stok(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String, ByVal kefil_kriter As String) As DataSet
        Dim kriter
        kriter = "WHERE tbTaksit.dteTarihi between '" & Microsoft.VisualBasic.Left(tarih1.ToString, 10) + " 00:00:00" & "' and '" & Microsoft.VisualBasic.Left(tarih2.ToString, 10) + " 23:59:59" & "' "
        If ara.ToString <> "" Then
            ...
            ElseIf sec_konum.Text = "Sýnýf1" Then
                kriter += " AND tbMusteri.nMusteriID IN (SELECT     tbMusteriSinifi.nMusteriID FROM         tbMSinif1 INNER JOIN                       tbMusteriSinifi ON tbMSinif1.sSinifKodu = tbMusteriSinifi.sSinifKodu1 WHERE tbMSinif1.sAciklama " & sorgu_kriter_string(ara, ara_kriter) & " )"
            ElseIf sec_konum.Text = "Sýnýf2" Then
                kriter += " AND tbMusteri.nMusteriID IN (SELECT     tbMusteriSinifi.nMusteriID FROM         tbMSinif2 INNER JOIN                       tbMusteriSinifi ON tbMSinif2.sSinifKodu = tbMusteriSinifi.sSinifKodu2 WHERE tbMSinif2.sAciklama " & sorgu_kriter_string(ara, ara_kriter) & " )"
            ElseIf sec_konum.Text = "Sýnýf3" Then
                kriter += " AND tbMusteri.nMusteriID IN (SELECT     tbMusteriSinifi.nMusteriID FROM         tbMSinif3 INNER JOIN                       tbMusteriSinifi ON tbMSinif3.sSinifKodu = tbMusteriSinifi.sSinifKodu3 WHERE tbMSinif3.sAciklama " & sorgu_kriter_string(ara, ara_kriter) & " )"
            ElseIf sec_konum.Text = "Sýnýf4" Then
                kriter += " AND tbMusteri.nMusteriID IN (SELECT     tbMusteriSinifi.nMusteriID FROM         tbMSinif4 INNER JOIN                       tbMusteriSinifi ON tbMSinif4.sSinifKodu = tbMusteriSinifi.sSinifKodu4 WHERE tbMSinif4.sAciklama " & sorgu_kriter_string(ara, ara_kriter) & " )"
            ElseIf sec_konum.Text = "Sýnýf5" Then
                kriter += " AND tbMusteri.nMusteriID IN (SELECT     tbMusteriSinifi.nMusteriID FROM         tbMSinif5 INNER JOIN                       tbMusteriSinifi ON tbMSinif5.sSinifKodu = tbMusteriSinifi.sSinifKodu5 WHERE tbMSinif5.sAciklama " & sorgu_kriter_string(ara, ara_kriter) & " )"
    ...
    Private Sub raporla(ByVal nIslem As Integer)
        ...
        OpenFileDialog1.Filter = "Rapor Dosyalarý (MusteriTaksitleri*.frx) |MusteriTaksitleri*.frx"
        OpenFileDialog1.FileName = "c:\Formlar\Raporlar\MusteriRaporlarý\MusteriTaksitleri.frx"
        OpenFileDialog1.InitialDirectory = "c:\Formlar\Raporlar\MusteriRaporlarý\"
        If OpenFileDialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            report.SetParameterValue("tarih1", DateEdit1.EditValue)
            report.SetParameterValue("tarih2", DateEdit2.EditValue)
    ...
    Private Sub takibe_al()
        ...
        frm.kasiyer = kasiyer
        frm.txt_takip_aciklama.Text = "Yeni Müþteri Kayýtlarý..."
        frm.status = True
