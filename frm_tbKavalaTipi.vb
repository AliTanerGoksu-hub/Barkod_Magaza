...
Public Class frm_tbKavalaTipi
    ...
    Public Sub Dataload_tbRenk()
        ...
        adapter.SelectCommand = cmd
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT sKavala1 AS sKavala FROM tbKavala UNION SELECT sKavala2 AS sKavala FROM tbKavala UNION SELECT sKavala3 AS sKavala FROM tbKavala UNION SELECT sKavala4 AS sKavala FROM tbKavala UNION SELECT sKavala5 AS sKavala FROM tbKavala UNION SELECT sKavala6 AS sKavala FROM tbKavala UNION SELECT sKavala7 AS sKavala FROM tbKavala UNION SELECT sKavala8 AS sKavala FROM tbKavala UNION SELECT sKavala9 AS sKavala FROM tbKavala UNION SELECT sKavala10 AS sKavala FROM tbKavala UNION SELECT sKavala11 AS sKavala FROM tbKavala UNION SELECT sKavala12 AS sKavala FROM tbKavala UNION SELECT sKavala13 AS sKavala FROM tbKavala UNION SELECT sKavala14 AS sKavala FROM tbKavala UNION SELECT sKavala15 AS sKavala FROM tbKavala) tbKavala  " & kriter_beden & " " & kriter & " ")
        cmd.Connection = conn
    ...
    Private Sub txt_sRenk_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txt_sRenk.Validating
        If islem = "Ekle" Then
            If sorgu_sRenk_kontrol(Trim(txt_sRenk.EditValue)) = False Then
                txt_sRenk.ErrorText = txt_sRenk.Text & vbTab & "Renk Kaydı Daha Önce Kullanılmış"
                e.Cancel = True
                txt_sRenk.Focus()
                txt_sRenk.SelectAll()
            End If
