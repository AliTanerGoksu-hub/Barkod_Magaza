...
Public Class frm_stok_envanter_dagilim
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents colsGenelMevcut As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colsGenelBekleyen As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents MenuItem16 As System.Windows.Forms.MenuItem
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_envanter_dagilim))
        ...
        Me.colsGenelMevcut = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colsGenelBekleyen = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.LabelControl5.Location = New System.Drawing.Point(17, 58)
        ...
        Me.sec_depo.TabIndex = 46
        '
        'sec_grup
        '
        Me.sec_grup.EditValue = "R/B/K"
        Me.sec_grup.EnterMoveNextControl = True
        Me.sec_grup.Location = New System.Drawing.Point(259, 58)
        ...
        Me.sec_grup.Properties.Items.AddRange(New Object() {"R/B/K", "Model"})
        ...
        Me.Label8.Text = "Eþittir"
        '
        'DateEdit1
        '
        Me.DateEdit1.EditValue = Nothing
        Me.DateEdit1.EnterMoveNextControl = True
        Me.DateEdit1.Location = New System.Drawing.Point(64, 14)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(323, 58)
        ...
        Me.sec_grid.Location = New System.Drawing.Point(159, 48)
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colnStokID, Me.colsKodu, Me.colsStokAciklama, Me.colMiktar, Me.colsRenk, Me.colsBeden, Me.colsBirimCinsi1, Me.colnBirimCarpan, Me.colsGenelMevcut, Me.colsGenelBekleyen})
        ...
        'colsGenelMevcut
        '
        Me.colsGenelMevcut.Caption = "Genel Mevcut"
        Me.colsGenelMevcut.FieldName = "GenelMevcut"
        Me.colsGenelMevcut.Name = "colsGenelMevcut"
        Me.colsGenelMevcut.Visible = True
        Me.colsGenelMevcut.VisibleIndex = 3
        '
        'colsGenelBekleyen
        '
        Me.colsGenelBekleyen.Caption = "Genel Bekleyen"
        Me.colsGenelBekleyen.FieldName = "GenelBekleyen"
        Me.colsGenelBekleyen.Name = "colsGenelBekleyen"
        Me.colsGenelBekleyen.Visible = True
        Me.colsGenelBekleyen.VisibleIndex = 4
        '
        'ps
        '
        ...
        Me.Name = "frm_stok_envanter_dagilim"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Envanter Depo Daðýlýmý"
...
#End Region
    ...
    Private Function sorgu_kriter_string(ByVal deger As String, ByVal kriter As String) As String
        ...
        Return sorgu_kriter
    End Function
    Public Function stok(ByVal tarih1 As DateTime, ByVal ara_stok As String, ByVal konum_stok As String, ByVal ara_kriter_stok As String, ByVal sGrup As String, ByVal sDepo As String) As DataSet
        Dim kriter As String = ""
        Dim kriter2 = ""
        Dim kriter3 = ""
        Dim kriter_depo = ""
        ...
        End If
        If sDepo <> "[Tümü]" Then
            kriter_depo += " AND tbStokFisiDetayi.sDepo IN ( " & sDepo & " )"
        End If
        kriter3 = sorgu_depo_kontrol(sGrup)
        Dim conn As New OleDb.OleDbConnection
        Dim cmd As New OleDb.OleDbCommand
        Dim adapter As New OleDb.OleDbDataAdapter
        conn.ConnectionString = connection
        ...
        adapter.SelectCommand = cmd
        If sGrup = "R/B/K" Then
            'cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.sModel, barkod.sBarkod,stok.sBirimCinsi1,ISNULL((SELECT ISNULL(lOran, 0) FROM tbStokBirimCevrimi WHERE nStokID = Stok.nStokID AND sBirimCinsi = Stok.sBirimCinsi2), 1) AS nBirimCarpan, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID AND  tbStokFisiDetayi.dteIslemTarihi < = '" & tarih1 & "' " & kriter_depo & ") AS Mevcut " & kriter3 & " ,  tbRenk.sRenkAdi, stok.sRenk FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID and barkod.nKisim = 0 INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") AS T " & kriter2 & " ORDER BY sKodu")
            cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.sModel, barkod.sBarkod,stok.sBirimCinsi1,ISNULL((SELECT ISNULL(lOran, 0) FROM tbStokBirimCevrimi WHERE nStokID = Stok.nStokID AND sBirimCinsi = Stok.sBirimCinsi2), 1) AS nBirimCarpan, (SELECT SUM(BEKLEYEN) AS BEKLEYEN FROM (SELECT SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) AS BEKLEYEN FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok1 ON tbAlisverisSiparis.nStokID = stok1.nStokID INNER JOIN tbDepo depo ON tbAlisverisSiparis.sMagazaKodu = depo.sDepo AND depo.bEnvanterGosterme = 0 WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (stok1.sKodu = Stok.sKodu) AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') UNION SELECT 0 AS BEKLEYEN FROM tbStok stok1 INNER JOIN tbStokFisiDetayi hareket1 ON stok1.nStokID = hareket1.nStokID INNER JOIN tbDepo depo ON hareket1.sDepo = depo.sDepo AND depo.bEnvanterGosterme = 0 WHERE (stok1.sKodu = Stok.sKodu) and (hareket1.dteFisTarihi <= '31/12/2078')) TT) as GenelBekleyen, (SELECT isnull(SUM(hareket.lGirisMiktar1 - hareket.lCikisMiktar1), 0) FROM tbStokFisiDetayi hareket INNER JOIN tbDepo depo ON hareket.sDepo = depo.sDepo AND depo.bEnvanterGosterme = 0 WHERE Stok.nStokID = hareket.nStokID AND hareket.dteIslemTarihi <= '31/12/2078') AS GenelMevcut, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID AND  tbStokFisiDetayi.dteIslemTarihi < = '" & tarih1 & "' " & kriter_depo & ") AS Mevcut " & kriter3 & " ,  tbRenk.sRenkAdi, stok.sRenk FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID and barkod.nKisim = 0 INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") AS T " & kriter2 & " ORDER BY sKodu")
        ElseIf sGrup = "Model" Then
            'cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT  sModel as sKodu,sAciklama,SUM(Mevcut) as Mevcut " & kriter4 & "  FROM (SELECT stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.sModel, barkod.sBarkod,stok.sBirimCinsi1,ISNULL((SELECT ISNULL(lOran, 0) FROM tbStokBirimCevrimi WHERE nStokID = Stok.nStokID AND sBirimCinsi = Stok.sBirimCinsi2), 1) AS nBirimCarpan, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID AND  tbStokFisiDetayi.dteIslemTarihi < = '" & tarih1 & "' " & kriter_depo & ") AS Mevcut " & kriter3 & " ,  tbRenk.sRenkAdi, stok.sRenk FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID and barkod.nKisim = 0 INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") AS T " & kriter2 & " Group by sModel,sAciklama ORDER BY sModel")
            cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT sModel as sKodu,sAciklama,SUM(Mevcut) as Mevcut " & kriter4 & "  FROM (SELECT stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.sModel, barkod.sBarkod,stok.sBirimCinsi1,ISNULL((SELECT ISNULL(lOran, 0) FROM tbStokBirimCevrimi WHERE nStokID = Stok.nStokID AND sBirimCinsi = Stok.sBirimCinsi2), 1) AS nBirimCarpan, (SELECT SUM(BEKLEYEN) AS BEKLEYEN FROM (SELECT SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) AS BEKLEYEN FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok1 ON tbAlisverisSiparis.nStokID = stok1.nStokID INNER JOIN tbDepo depo ON tbAlisverisSiparis.sMagazaKodu = depo.sDepo AND depo.bEnvanterGosterme = 0 WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (stok1.sKodu = Stok.sKodu) AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') UNION SELECT 0 AS BEKLEYEN FROM tbStok stok1 INNER JOIN tbStokFisiDetayi hareket1 ON stok1.nStokID = hareket1.nStokID INNER JOIN tbDepo depo ON hareket1.sDepo = depo.sDepo AND depo.bEnvanterGosterme = 0 WHERE (stok1.sKodu = Stok.sKodu) and (hareket1.dteFisTarihi <= '31/12/2078')) TT) as GenelBekleyen, (SELECT isnull(SUM(hareket.lGirisMiktar1 - hareket.lCikisMiktar1), 0) FROM tbStokFisiDetayi hareket INNER JOIN tbDepo depo ON hareket.sDepo = depo.sDepo AND depo.bEnvanterGosterme = 0 WHERE Stok.nStokID = hareket.nStokID AND hareket.dteIslemTarihi <= '31/12/2078') AS GenelMevcut, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID AND  tbStokFisiDetayi.dteIslemTarihi < = '" & tarih1 & "' " & kriter_depo & ") AS Mevcut " & kriter3 & " ,  tbRenk.sRenkAdi, stok.sRenk FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID and barkod.nKisim = 0 INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") AS T " & kriter2 & " Group by sModel,sAciklama ORDER BY sModel")
        End If
        cmd.Connection = conn
        conn.Open()
    ...
    Private Function sorgu_query(ByVal query As String) As String
        ...
        Return query
    End Function
    Private Sub dataload(ByVal tarih1 As DateTime, ByVal ara_stok As String, ByVal konum_stok As String, ByVal ara_kriter_stok As String, ByVal sGrup As String, ByVal sDepo As String)
        DataSet1 = stok(tarih1, ara_stok, konum_stok, ara_kriter_stok, sGrup, sDepo)
    ...
    Private Sub SimpleButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton3.Click
        ...
        dataload(DateEdit1.EditValue, txt_ara_stok.EditValue, sec_konum_stok.EditValue, sec_kriter_stok.EditValue, sec_grup.Text, sec_depo.Text)
        Label2.Text = Sorgu_sDil("Tamamlandý...", sDil)
    ...
    Private Sub GridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.DoubleClick
        ...
        End If
    End Sub
    Private Function sorgu_depo_kontrol(ByVal sGrup As String) As String
        Dim dr As DataRow
        ...
        For Each dr In ds_magaza.Tables(0).Rows
            If dr("SEC") = True Then
                depo_satir += ", CAST((SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID AND  tbStokFisiDetayi.dteIslemTarihi < = '" & DateEdit1.EditValue & "' AND (tbStokFisiDetayi.sDepo = '" & dr("KOD") & "')) AS MONEY) AS  [" & dr("KOD") & "]"
                If sGrup = "Model" Then
                    kriter4 += ", SUM([" & dr("KOD") & "]) AS  [" & dr("KOD") & "] "
                End If
                'MsgBox(GridView1.Columns.Contains(GridView1.Columns(dr("KOD"))))
                If GridView1.Columns.Contains(GridView1.Columns(dr("KOD"))) = False Then
                    GridView1.Columns.AddField(dr("KOD").ToString)
                End If
                GridView1.Columns(dr("KOD")).visible = True
                GridView1.Columns(dr("KOD")).FieldName = dr("KOD")
                GridView1.Columns(dr("KOD")).DisplayFormat.FormatString = "#,0.##"
                GridView1.Columns(dr("KOD")).DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
                GridView1.Columns(dr("KOD")).SummaryItem.DisplayFormat = "{0:#,0.##}"
                GridView1.Columns(dr("KOD")).SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum
            Else
                If GridView1.Columns.Contains(GridView1.Columns(dr("KOD"))) = True Then
                    GridView1.Columns.Remove(GridView1.Columns(dr("KOD")))
                End If
            End If
        Next
        dr = Nothing
