...
#End Region
    ...
    Private Sub frm_stok_pesin_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        If dr IsNot Nothing AndAlso dr.Table IsNot Nothing AndAlso dr.RowState <> DataRowState.Deleted AndAlso dr.RowState <> DataRowState.Detached AndAlso Not IsDBNull(dr("nAlisVerisID")) Then
            ...
            ' Gonderim - Iptal veya iade ise gonderme
            If PosEntegre AndAlso Not Muhasebe AndAlso belgeIptalOldu = False Then
                Dim lNet As Decimal = 0
                Try
                    lNet = CDec(dr_toplam("lNetTutar"))
                Catch
                End Try
                If lNet > 0 Then
