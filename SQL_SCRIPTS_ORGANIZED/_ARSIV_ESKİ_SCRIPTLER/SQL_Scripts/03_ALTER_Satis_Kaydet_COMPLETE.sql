...
GO
-- =====================================================
-- Satis_Kaydet Procedure - lEkmaliyet3 Parametresi Eklendi
-- Her tbStokFisiMaster UPDATE komutu güncellendi
-- =====================================================
...
DECLARE @CariSiraSonID int
DECLARE @MuhasebeSiraSonID int

-- (Procedure'ün orta kısmı aynı kalacak, sadece UPDATE tbStokFisiMaster komutlarını değiştireceğiz)
-- Tüm kod aynı, sadece kritik UPDATE komutlarını gösteriyorum:
...
-- ★★★ GÜNCELLENME 1: İlk ürün için UPDATE - lEkmaliyet3 eklendi ★★★
...
-- ★★★ GÜNCELLENME 2: 2. ürün için UPDATE - lEkmaliyet3 eklendi ★★★
...
-- ★★★ GÜNCELLENME 3: 3. ürün için UPDATE - lEkmaliyet3 eklendi ★★★
...
-- ★★★ GÜNCELLENME 4: 4. ürün için UPDATE - lEkmaliyet3 eklendi ★★★
...
-- ★★★ GÜNCELLENME 5: 5. ürün için UPDATE - lEkmaliyet3 eklendi ★★★
...
-- ... (Procedure'ün geriye kalan kısmı aynı şekilde devam eder)

-- Else bloğu da aynı şekilde güncellenecek (yeni müşteri olmayan durum için)
end
else
begin
    -- ... (else bloğunun tüm UPDATE tbStokFisiMaster komutlarına da lEkmaliyet3 = @EkMaliyet3 eklenmelidir)
end

GO

PRINT 'Satis_Kaydet procedure başarıyla güncellendi!'
PRINT '@EkMaliyet3 parametresi eklendi ve tüm UPDATE tbStokFisiMaster komutları güncellendi.'
GO
