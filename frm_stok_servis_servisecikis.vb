...
Imports System.IO
Public Class frm_stok_servis_servisecikis
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_servis_servisecikis))
        ...
        Me.colSERVISTIPI.VisibleIndex = 6
        '
        'colUCRET
        '
        ...
        Me.Name = "frm_stok_servis_servisecikis"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Servise Stok Gönderimi"
...
#End Region
        ...
        If frm.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
            ...
            Else
                ...
                For Each i In arr
                    ...
                    If firmatipi = True Then
                        hareketler_kaydet_yeni(dr_baslik("TARIH"), 1, dr_baslik("BELGETIPI"), dr_baslik("BELGENO"), dr_baslik("IND"), "", dr1("IND"), dr1("REFNO"), Now, 0, dr_baslik("FIRMANO"))
                    Else
                        hareketler_kaydet_yeni(dr_baslik("TARIH"), 4, dr_baslik("BELGETIPI"), dr_baslik("BELGENO"), dr_baslik("IND"), "", dr1("IND"), dr1("REFNO"), Now, 0, dr_baslik("FIRMANO"))
                    End If
                    'hareketler_kaydet_yeni(dr_baslik("TARIH"), 1, dr_baslik("BELGETIPI"), dr_baslik("BELGENO"), dr_baslik("IND"), "", dr1("IND"), dr1("REFNO"), Now, 0, dr_baslik("FIRMANO"))
                    dataload_harekets()
    ...
    Private Sub servis()
        ...
        If frm.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
            Dim dr1 As DataRow
            dr1 = frm.GridView1.GetDataRow(frm.GridView1.FocusedRowHandle)
            dr_baslik("FIRMANO") = Trim(dr1("IND"))
            dr_baslik("FIRMAKODU") = Trim(dr1("KODU"))
            dr_baslik("FIRMAADI") = Trim(dr1("ADI"))
            dr_baslik("YETKILI") = Trim(dr1("YETKILI"))
            dr_baslik("ADRES") = Trim(dr1("ADRES"))
            dr_baslik("TELEFON") = Trim(dr1("TELEFON1"))
            baslik_kaydet_degistir(dr_baslik("IND"), dr_baslik("TARIH"), dr_baslik("BELGENO"), dr_baslik("FIRMATIPI"), dr_baslik("FIRMANO"), dr_baslik("FIRMAKODU"), dr_baslik("FIRMAADI"), dr_baslik("BELGETIPI"), dr_baslik("ACIKLAMA"), dr_baslik("KOD1"), dr_baslik("KOD2"), dr_baslik("KOD3"), dr_baslik("KOD4"), dr_baslik("KOD5"), dr_baslik("GIRIS"), dr_baslik("IADE"), dr_baslik("IPTAL"), dr_baslik("KAYITTARIHI"), dr_baslik("SONUC"), dr_baslik("ADRES"), dr_baslik("TELEFON"), dr_baslik("YETKILI"), dr_baslik("ILETISIM"))
        End If
    End Sub
    Private Sub firma()
    ...
    Private Sub report_create_stok(ByVal dosya As String, ByVal kriter As String, ByVal status As Integer)
        ...
        If IntPtr.Size = 4 Then
            ...
            frx.SetVariable("BELGETIPI", "'Servise Ürün Çýkýþ Formu'")
        ...
        ElseIf IntPtr.Size = 8 Then
            ...
            args(14) = "BELGETIPI"
            args(15) = "'Servise Ürün Çýkýþ Formu'"
            processYol = args(0)
