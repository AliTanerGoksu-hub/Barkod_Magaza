...
Public Class frm_tbMuhasebe_GelirTablosu
    Public firmano
    Public donemno
    Public connection
    Public nFirmaID
    ...
    Private Sub gorunum_yazdir()
        If XtraTabControl1.SelectedTabPageIndex = 0 Then
            ...
            kriter += DateEdit1.EditValue & " ve " & DateEdit2.EditValue & Sorgu_sDil(" Tarihleri Arasındaki Gelir Tablosu", sDil) & vbCrLf
