...
Public Class HandledExceptionManager
    ...
    '--
    Public Overloads Shared Function ShowDialog(ByVal strWhatHappened As String, ByVal strHowUserAffected As String, _
        ByVal strWhatUserCanDo As String, ByVal objException As System.Exception, _
        ...
        Return ShowDialogInternal(strWhatHappened, strHowUserAffected, strWhatUserCanDo, ExceptionToMore(objException), _
    ...
    Private Shared Function ShowDialogInternal(ByVal strWhatHappened As String, _
        ...
        With objForm
            ...
            .lblError.Text = strWhatHappened
            .lblScope.Text = strHowUserAffected
            .lblAction.Text = strWhatUserCanDo
        ...
        Select Case Icon
            Case MessageBoxIcon.Error
                objForm.PictureBox1.Image = EmbeddedResource.GetImage("icon_stop.gif")
            Case MessageBoxIcon.Stop
                objForm.PictureBox1.Image = EmbeddedResource.GetImage("icon_stop.gif")
            Case MessageBoxIcon.Exclamation
                objForm.PictureBox1.Image = EmbeddedResource.GetImage("icon_exclamation.gif")
            Case MessageBoxIcon.Information
                objForm.PictureBox1.Image = EmbeddedResource.GetImage("icon_information.gif")
            Case MessageBoxIcon.Question
                objForm.PictureBox1.Image = EmbeddedResource.GetImage("icon_question.gif")
            Case Else
                objForm.PictureBox1.Image = EmbeddedResource.GetImage("icon_stop.gif")
        End Select
    ...
    Private Shared Sub ThreadHandler()
        Dim objSMTP As New SimpleMail.SMTPClient
        Dim objMail As New SimpleMail.SMTPMailMessage
        With objMail
            .To = AppSettings.GetString("UnhandledExceptionManager/EmailTo")
            If _blnHaveException Then
                .Subject = "Handled Exception notification"
            Else
