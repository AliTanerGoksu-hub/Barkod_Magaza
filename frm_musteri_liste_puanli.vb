...
Public Class frm_musteri_liste_puanli
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_musteri_liste_puanli))
        ...
        Me.GroupControl1.Size = New System.Drawing.Size(441, 84)
        ...
        Me.sec_konum.Location = New System.Drawing.Point(176, 46)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(323, 46)
        ...
        Me.sec_kriter.Location = New System.Drawing.Point(259, 46)
        ...
        Me.txt_ara.Location = New System.Drawing.Point(64, 46)
        ...
        Me.txt_ustlimit.Location = New System.Drawing.Point(176, 24)
        ...
        Me.txt_altlimit.Location = New System.Drawing.Point(64, 24)
        ...
        Me.PanelControl2.Location = New System.Drawing.Point(0, 398)
        ...
        Me.Panelstatus.Location = New System.Drawing.Point(176, 123)
        ...
        Me.GridControl1.Size = New System.Drawing.Size(820, 306)
        ...
        Me.Name = "frm_musteri_liste_puanli"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Müþteri Kayýtlarý Puanlý"
...
#End Region
    ...
    Public musterino
    Public kullanici
    Public bAlacakli As Boolean = False
    Public kasiyer
    Public kasiyerno
    Private Sub frm_cari_faturalar_acik_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txt_ara.EditValue = ""
        'dataload()
        If bAlacakli = True Then
            Label4.Text = "Bakiye:"
            coltutar.Caption = "Bakiye"
        ElseIf bAlacakli = False Then
            Label4.Text = "Puan:"
            coltutar.Caption = "Puan"
        End If
    End Sub
    ...
    Private Sub gorunum_yazdir()
        ...
        If bAlacakli = False Then
            kriter += " Müþteri Puanlarý " & vbCrLf
        ElseIf bAlacakli = True Then
            kriter += " Müþteri Alacaklarý " & vbCrLf
        End If
    ...
    Private Function sorgu_kriter_string(ByVal deger As String, ByVal kriter As String) As String
        ...
        Return sorgu_kriter
    End Function
    Public Function stok(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal limitalt As Decimal, ByVal limitust As Decimal, ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String) As DataSet
        Dim kriter As String = ""
        ...
        'cmd.CommandText = sorgu_query("set dateformat dmy SELECT * FROM vwMusteriBakiyesi Bakiye INNER JOIN (SELECT tbMusteri.nMusteriID , tbMusteri.sMagaza , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , tbMusteri.sAdi + ' ' + tbMusteri.sSoyadi AS Musteri , tbMusteri.nCinsiyet , tbMusteri.lAylikGelir , tbMusteri.dteKartAcilisTarihi , tbMusteri.nIskontoPesin , tbMusteri.nIskontoKredili , tbMusteri.sUnvan , tbMusteri.sVergiDairesi , tbMusteri.sVergiNo , tbMusteri.bYazismaEvAdresinemi , tbMusteri.sEmail , tbMusteri.sIsYeriAdi , tbMusteri.sIsAdresi1 + ' ' + tbMusteri.sIsAdresi2 + ' ' + tbMusteri.sIsSemt + ' ' + tbMusteri.sIsIl + ' ' + tbMusteri.sIsPostaKodu AS sIsAdresi , tbMusteri.sIsTelefonu , tbMusteri.sEvAdresi1 + ' ' + tbMusteri.sEvAdresi2 + ' ' + tbMusteri.sEvSemt + ' ' + tbMusteri.sEvPostaKodu + ' ' + tbMusteri.sEvIl AS sEvAdresi , tbMusteri.sEvTelefonu , tbMusteri.sSigortaNo , tbMusteri.bEvlimi , tbMusteri.dteEvlilikTarihi , tbMusteri.dteDogumTarihi , tbMusteri.sDogumYeri , tbMusteri.sEhliyetNo , tbMusteri.sKanGrubu , tbMusteri.dteKayitTarihi , tbMusteri.sAciklama1 + ' ' + tbMusteri.sAciklama2 + ' ' + tbMusteri.sAciklama3 + ' ' + tbMusteri.sAciklama4 + ' ' + tbMusteri.sAciklama5 AS ISTIHBARAT , tbMusteri.sGSM , tbMusteri.sFax , (SELECT TOP 1 nKartNo FROM tbMusteriKarti WHERE nMusteriID = tbMusteri.nMusteriID ORDER BY dteKayitTarihi DESC) AS SOZLESME , tbMSinif1.sAciklama AS Sýnýf1 , tbMSinif2.sAciklama AS Sýnýf2 , tbMSinif3.sAciklama AS Sýnýf3 , tbMSinif4.sAciklama AS Sýnýf4 , tbMSinif5.sAciklama AS Sýnýf5 FROM tbMusteri INNER JOIN tbMusteriSinifi ON tbMusteri.nMusteriID = tbMusteriSinifi.nMusteriID INNER JOIN tbMSinif1 ON tbMusteriSinifi.sSinifKodu1 = tbMSinif1.sSinifKodu INNER JOIN tbMSinif2 ON tbMusteriSinifi.sSinifKodu2 = tbMSinif2.sSinifKodu INNER JOIN tbMSinif3 ON tbMusteriSinifi.sSinifKodu3 = tbMSinif3.sSinifKodu INNER JOIN tbMSinif4 ON tbMusteriSinifi.sSinifKodu4 = tbMSinif4.sSinifKodu INNER JOIN tbMSinif5 ON tbMusteriSinifi.sSinifKodu5 = tbMSinif5.sSinifKodu " & kriter & ") Musteri ON Bakiye.nMusteriID = Musteri.nMusteriID WHERE     (Bakiye.bakiye BETWEEN " & limitalt & " AND " & limitust & ")")
        If bAlacakli = False Then
            cmd.CommandText = sorgu_query("SET DATEFORMAT DMY SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT Musteri.*, tbPuan.lKalanPuan AS bakiye FROM (SELECT tbMusteri.nMusteriID , tbMusteri.sMagaza , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , tbMusteri.sAdi + ' ' + tbMusteri.sSoyadi AS Musteri , tbMusteri.nCinsiyet , tbMusteri.lAylikGelir , tbMusteri.dteKartAcilisTarihi , tbMusteri.nIskontoPesin , tbMusteri.nIskontoKredili , tbMusteri.sUnvan , tbMusteri.sVergiDairesi , tbMusteri.sVergiNo , tbMusteri.bYazismaEvAdresinemi , tbMusteri.sEmail , tbMusteri.sIsYeriAdi , tbMusteri.sIsAdresi1 + ' ' + tbMusteri.sIsAdresi2 + ' ' + tbMusteri.sIsSemt + ' ' + tbMusteri.sIsIl + ' ' + tbMusteri.sIsPostaKodu AS sIsAdresi , tbMusteri.sIsTelefonu , tbMusteri.sEvAdresi1 + ' ' + tbMusteri.sEvAdresi2 + ' ' + tbMusteri.sEvSemt + ' ' + tbMusteri.sEvPostaKodu + ' ' + tbMusteri.sEvIl AS sEvAdresi , tbMusteri.sEvTelefonu , tbMusteri.sSigortaNo , tbMusteri.bEvlimi , tbMusteri.dteEvlilikTarihi , tbMusteri.dteDogumTarihi , tbMusteri.sDogumYeri , tbMusteri.sEhliyetNo , tbMusteri.sKanGrubu , tbMusteri.dteKayitTarihi , tbMusteri.sAciklama1 + ' ' + tbMusteri.sAciklama2 + ' ' + tbMusteri.sAciklama3 + ' ' + tbMusteri.sAciklama4 + ' ' + tbMusteri.sAciklama5 AS ISTIHBARAT , tbMusteri.sGSM , tbMusteri.sFax , (SELECT TOP 1 nKartNo FROM tbMusteriKarti WHERE nMusteriID = tbMusteri.nMusteriID ORDER BY dteKayitTarihi DESC) AS SOZLESME , tbMSinif1.sAciklama AS Sýnýf1 , tbMSinif2.sAciklama AS Sýnýf2 , tbMSinif3.sAciklama AS Sýnýf3 , tbMSinif4.sAciklama AS Sýnýf4 , tbMSinif5.sAciklama AS Sýnýf5 FROM tbMusteri INNER JOIN tbMusteriSinifi ON tbMusteri.nMusteriID = tbMusteriSinifi.nMusteriID INNER JOIN tbMSinif1 ON tbMusteriSinifi.sSinifKodu1 = tbMSinif1.sSinifKodu INNER JOIN tbMSinif2 ON tbMusteriSinifi.sSinifKodu2 = tbMSinif2.sSinifKodu INNER JOIN tbMSinif3 ON tbMusteriSinifi.sSinifKodu3 = tbMSinif3.sSinifKodu INNER JOIN tbMSinif4 ON tbMusteriSinifi.sSinifKodu4 = tbMSinif4.sSinifKodu INNER JOIN tbMSinif5 ON tbMusteriSinifi.sSinifKodu5 = tbMSinif5.sSinifKodu " & kriter & " ) Musteri INNER JOIN (SELECT nMusteriID , SUM(lKazanilanPuan - lHarcananPuan) AS lKalanPuan FROM (SELECT tbAlisVeris.nMusteriID , SUM(tbAVHediyeCeki.lTutar) AS lKazanilanPuan , 0 AS lHarcananPuan FROM tbAlisVeris INNER JOIN tbAVHediyeCeki ON tbAlisVeris.nAlisverisID = tbAVHediyeCeki.nAlisverisID WHERE (tbAVHediyeCeki.sHediyeCekiTipi = 'ParaPU_KAZ') GROUP BY tbAlisVeris.nMusteriID UNION ALL SELECT tbAlisVeris.nMusteriID , 0 AS lKazanilanPuan , SUM(tbAVHediyeCeki.lTutar) AS lHarcananPuan FROM tbAlisVeris INNER JOIN tbAVHediyeCeki ON tbAlisVeris.nAlisverisID = tbAVHediyeCeki.nAlisverisID WHERE (tbAVHediyeCeki.sHediyeCekiTipi IN ('ParaPU_HAR' , 'ParaPU_AL')) GROUP BY tbAlisVeris.nMusteriID) Puan GROUP BY nMusteriID) tbPuan ON Musteri.nMusteriID = tbPuan.nMusteriID WHERE     (tbPuan.lKalanPuan BETWEEN " & limitalt & " AND " & limitust & ")")
        ElseIf bAlacakli = True Then
            cmd.CommandText = sorgu_query("SET DATEFORMAT DMY SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT Musteri.*, ABS(HediyeCeki.lHediyeCeki) AS bakiye FROM (SELECT tbMusteri.nMusteriID , tbMusteri.sMagaza , tbMusteri.lKodu , tbMusteri.sAdi , tbMusteri.sSoyadi , tbMusteri.sAdi + ' ' + tbMusteri.sSoyadi AS Musteri , tbMusteri.nCinsiyet , tbMusteri.lAylikGelir , tbMusteri.dteKartAcilisTarihi , tbMusteri.nIskontoPesin , tbMusteri.nIskontoKredili , tbMusteri.sUnvan , tbMusteri.sVergiDairesi , tbMusteri.sVergiNo , tbMusteri.bYazismaEvAdresinemi , tbMusteri.sEmail , tbMusteri.sIsYeriAdi , tbMusteri.sIsAdresi1 + ' ' + tbMusteri.sIsAdresi2 + ' ' + tbMusteri.sIsSemt + ' ' + tbMusteri.sIsIl + ' ' + tbMusteri.sIsPostaKodu AS sIsAdresi , tbMusteri.sIsTelefonu , tbMusteri.sEvAdresi1 + ' ' + tbMusteri.sEvAdresi2 + ' ' + tbMusteri.sEvSemt + ' ' + tbMusteri.sEvPostaKodu + ' ' + tbMusteri.sEvIl AS sEvAdresi , tbMusteri.sEvTelefonu , tbMusteri.sSigortaNo , tbMusteri.bEvlimi , tbMusteri.dteEvlilikTarihi , tbMusteri.dteDogumTarihi , tbMusteri.sDogumYeri , tbMusteri.sEhliyetNo , tbMusteri.sKanGrubu , tbMusteri.dteKayitTarihi , tbMusteri.sAciklama1 + ' ' + tbMusteri.sAciklama2 + ' ' + tbMusteri.sAciklama3 + ' ' + tbMusteri.sAciklama4 + ' ' + tbMusteri.sAciklama5 AS ISTIHBARAT , tbMusteri.sGSM , tbMusteri.sFax , (SELECT TOP 1 nKartNo FROM tbMusteriKarti WHERE nMusteriID = tbMusteri.nMusteriID ORDER BY dteKayitTarihi DESC) AS SOZLESME , tbMSinif1.sAciklama AS Sýnýf1 , tbMSinif2.sAciklama AS Sýnýf2 , tbMSinif3.sAciklama AS Sýnýf3 , tbMSinif4.sAciklama AS Sýnýf4 , tbMSinif5.sAciklama AS Sýnýf5 FROM tbMusteri INNER JOIN tbMusteriSinifi ON tbMusteri.nMusteriID = tbMusteriSinifi.nMusteriID INNER JOIN tbMSinif1 ON tbMusteriSinifi.sSinifKodu1 = tbMSinif1.sSinifKodu INNER JOIN tbMSinif2 ON tbMusteriSinifi.sSinifKodu2 = tbMSinif2.sSinifKodu INNER JOIN tbMSinif3 ON tbMusteriSinifi.sSinifKodu3 = tbMSinif3.sSinifKodu INNER JOIN tbMSinif4 ON tbMusteriSinifi.sSinifKodu4 = tbMSinif4.sSinifKodu INNER JOIN tbMSinif5 ON tbMusteriSinifi.sSinifKodu5 = tbMSinif5.sSinifKodu) Musteri INNER JOIN (SELECT tbAlisVeris.nMusteriID , ISNULL(SUM(tbOdeme.lOdemeTutar) , 0) AS lHediyeCeki FROM tbAlisVeris INNER JOIN tbOdeme ON tbAlisVeris.nAlisverisID = tbOdeme.nAlisverisID WHERE (tbOdeme.sOdemeSekli = 'HC') GROUP BY tbAlisVeris.nMusteriID) HediyeCeki ON Musteri.nMusteriID = HediyeCeki.nMusteriID WHERE     (ABS(HediyeCeki.lHediyeCeki) BETWEEN " & limitalt & " AND " & limitust & ")")
        End If
        cmd.Connection = conn
        conn.Open()
    ...
    Private Function sorgu_query(ByVal query As String) As String
        ...
        Return query
    End Function
    Private Sub dataload(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal limitalt As Decimal, ByVal limitust As Decimal, ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String)
        DataSet1 = stok(tarih1, tarih2, limitalt, limitust, ara, konum, ara_kriter)
    ...
    Private Sub SimpleButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton3.Click
        ...
        Cursor.Show()
        dataload(Today, Today, txt_altlimit.EditValue, txt_ustlimit.EditValue, txt_ara.EditValue, sec_konum.Text, sec_kriter.Text)
