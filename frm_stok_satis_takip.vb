...
Public Class frm_stok_satis_takip
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_satis_takip))
        ...
        Me.collKota = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.collKotaKalan = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.collKotaYuzde = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colsAciklama = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.collKotaHedefYuzde = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.txt_sFiyatTipi.Location = New System.Drawing.Point(176, 49)
        ...
        'Label3
        '
        Me.Label3.Location = New System.Drawing.Point(21, 29)
        ...
        Me.sec_konum_stok.Location = New System.Drawing.Point(176, 29)
        ...
        Me.sec_kriter_stok.Location = New System.Drawing.Point(259, 29)
        ...
        Me.txt_ara_stok.Location = New System.Drawing.Point(64, 29)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(64, 69)
        Me.SimpleButton3.Name = "SimpleButton3"
        Me.SimpleButton3.Size = New System.Drawing.Size(195, 20)
        ...
        Me.sec_kriter.Location = New System.Drawing.Point(64, 49)
        ...
        Me.collGirisTutar.VisibleIndex = 3
        '
        'collCikisTutar
        '
        ...
        Me.collCikisTutar.VisibleIndex = 5
        '
        'collKalanTutar
        '
        ...
        'collKota
        '
        Me.collKota.Caption = "Kota"
        Me.collKota.DisplayFormat.FormatString = "#,0.00"
        Me.collKota.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.collKota.FieldName = "lKota"
        Me.collKota.Name = "collKota"
        Me.collKota.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lKota", "{0:#,0.00}")})
        Me.collKota.Visible = True
        Me.collKota.VisibleIndex = 6
        '
        'collKotaKalan
        '
        Me.collKotaKalan.Caption = "KotaKalan"
        Me.collKotaKalan.DisplayFormat.FormatString = "#,0.00"
        Me.collKotaKalan.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.collKotaKalan.FieldName = "lKotaKalan"
        Me.collKotaKalan.Name = "collKotaKalan"
        Me.collKotaKalan.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lKotaKalan", "{0:#,0.00}")})
        Me.collKotaKalan.Visible = True
        Me.collKotaKalan.VisibleIndex = 7
        '
        'collKotaYuzde
        '
        Me.collKotaYuzde.Caption = "Kalan"
        Me.collKotaYuzde.DisplayFormat.FormatString = "P"
        Me.collKotaYuzde.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.collKotaYuzde.FieldName = "lKotaYuzde"
        Me.collKotaYuzde.Name = "collKotaYuzde"
        Me.collKotaYuzde.Visible = True
        Me.collKotaYuzde.VisibleIndex = 9
        '
        'colsAciklama
        '
        Me.colsAciklama.Caption = "Acýklama"
        Me.colsAciklama.FieldName = "sAciklama"
        Me.colsAciklama.Name = "colsAciklama"
        '
        'collKotaHedefYuzde
        '
        Me.collKotaHedefYuzde.Caption = "Gerceklesen"
        Me.collKotaHedefYuzde.DisplayFormat.FormatString = "P"
        Me.collKotaHedefYuzde.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.collKotaHedefYuzde.FieldName = "lKotaHedefYuzde"
        Me.collKotaHedefYuzde.Name = "collKotaHedefYuzde"
        Me.collKotaHedefYuzde.Visible = True
        Me.collKotaHedefYuzde.VisibleIndex = 8
        '
        'sec_renk
        '
        ...
        'BarButtonItem5
        '
        Me.BarButtonItem5.Caption = "Servis Detayý"
...
#End Region
    ...
    Public dteIslemTarihi1 As DateTime
    Public dteIslemTarihi2 As DateTime
    Public sEvrakno As String = ""
    ...
    Private Function sorgu_kriter_string(ByVal deger As String, ByVal kriter As String) As String
        ...
        Return sorgu_kriter
    End Function
    Public Function stok(ByVal ara_stok As String, ByVal konum_stok As String, ByVal ara_kriter_stok As String, ByVal sFiyatTipi As String, ByVal dteIslemTarihi1 As DateTime, ByVal dteIslemTarihi2 As DateTime, ByVal EVRAKNO As String) As DataSet
        Dim kriter As String = ""
        Dim kriter2 = ""
        Dim kriter3 = ""
        ...
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SET DATEFORMAT DMY SELECT Satis.*, Talep.MIKTAR-Satis.CIKAN as lKotaKalan, (Talep.MIKTAR - Satis.CIKAN) / Talep.MIKTAR AS lKotaYuzde,ISNULL(Satis.CIKAN,0.0001)/Talep.MIKTAR as lKotaHedefYuzde,Talep.MIKTAR AS lKota, Talep.ACIKLAMA AS sAciklama,Talep.STOKKODU AS STOKKODU, Talep.MALINCINSI AS STOKADI, Talep.BARCODE AS sBarkod, Talep.RENK AS sRenk, Talep.BEDEN AS sBeden, Talep.MODEL AS sModel FROM (SELECT TS.nStokID , TS.lAsgariMiktar , TS.lAzamiMiktar ,CAST(SUM(TS.GIREN) AS MONEY) AS GIREN , CAST(SUM(TS.CIKAN) AS MONEY) AS CIKAN , CAST(SUM(TS.KALAN) AS MONEY) AS KALAN , CAST(SUM(TS.BEKLEYEN) AS MONEY) AS BEKLEYEN , tbRenk.sRenkAdi , tbStokFiyati.lFiyat , CAST(SUM(TS.GIREN * ISNULL(tbStokFiyati.lFiyat , 0)) AS MONEY) AS lGirisTutar , CAST(SUM(TS.CIKAN * ISNULL(tbStokFiyati.lFiyat , 0)) AS MONEY) AS lCikisTutar , CAST(SUM(TS.KALAN * ISNULL(tbStokFiyati.lFiyat , 0)) AS MONEY) AS lKalanTutar , (SELECT ISNULL(CAST(SUM(GIREN) AS MONEY) , 0) AS MIKTAR FROM (SELECT HAREKET.* , (SELECT TOP 1 ISLEMTIPI FROM ASTOKSERVISHAREKETLERI WHERE REFNO = HAREKET.IND AND REFBASLIK = HAREKET.EVRAKNO ORDER BY ISLEMTIPI DESC) AS STOKISLEMTIPI FROM ASTOKSERVISDETAY HAREKET INNER JOIN ASTOKSERVISBASLIK BASLIK ON HAREKET.EVRAKNO = BASLIK.IND WHERE BASLIK.FIRMATIPI = 1) T WHERE (STOKISLEMTIPI IN (0 , 2 , 4)) AND STOKNO = TS.nStokID) AS Servis , (SELECT TOP 1 tbStokFisiDetayi.dteFisTarihi FROM tbStokFisiDetayi INNER JOIN tbFisTipi ON tbStokFisiDetayi.sFisTipi = tbFisTipi.sFisTipi WHERE (tbStokFisiDetayi.sFisTipi NOT IN ('T' , 'DC')) AND (tbFisTipi.bSatismi = 1) AND tbStokFisiDetayi.nGirisCikis = 3 AND tbStokFisiDetayi.nStokID = TS.nStokID ORDER BY tbStokFisiDetayi.dteFisTarihi DESC) AS SonSatisTarihi , (SELECT TOP 1 tbStokFisiDetayi.dteFisTarihi FROM tbStokFisiDetayi INNER JOIN tbFisTipi ON tbStokFisiDetayi.sFisTipi = tbFisTipi.sFisTipi WHERE (tbStokFisiDetayi.sFisTipi <> 'T') AND (tbStokFisiDetayi.sFisTipi = 'FA') AND (tbFisTipi.bSatismi = 0) AND tbStokFisiDetayi.nGirisCikis = 1 AND tbStokFisiDetayi.nStokID = TS.nStokID ORDER BY tbStokFisiDetayi.dteFisTarihi DESC) AS SonAlisTarihi , (SELECT ISNULL(SUM(lKalanMiktar) , 0) AS siparis FROM (SELECT tbFirma.sKodu AS sFirmaKodu , tbFirma.sAciklama AS sFirmaAdi , tbstok.nstokID , tbStok.sKodu AS sModel , tbStok.sRenk AS sRenk , tbRenk.sRenkAdi AS sRenkAdi , tbStok.sBeden AS sBeden , tbStok.sAciklama , '' AS dteIlkSevkiyatTarihi , STR(tbSiparis.lSiparisNo) + ' - ' + LTRIM(STR(tbSiparis.nSiparisID)) AS sSipNo , tbSiparis.dteSiparisTarihi AS dteSiparisTarihi , tbSiparis.dteTeslimTarihi AS dteTeslimTarihi , tbSiparis.sSiparisIslem , tbSiparis.lMiktari AS SiparisMiktari , SUM(ISNULL(tbStokFisiDetayi.lSevkMiktari , 0)) AS lSevkMiktari , SUM(ISNULL(tbStokFisiDetayi.lSevkIadeMiktari , 0)) AS lSevkIadeMiktari , SUM(ISNULL(tbStokFisiDetayi.lSevkIadeTutari , 0)) AS lSevkIadeTutari , tbSiparis.lReserveMiktari , tbSiparis.lMiktari - SUM(ISNULL(tbStokFisiDetayi.lSevkMiktari , 0)) + SUM(ISNULL(tbStokFisiDetayi.lSevkIadeMiktari , 0)) AS lKalanMiktar FROM (SELECT nSiparisID , isnull(abs(SUM(lGirisMiktar1 * (nGirisCikis - 2))) , 0) lSevkMiktari , isnull(abs(SUM(lGirisTutar * (nGirisCikis - 2))) , 0) lSevkTutari , isnull(abs(SUM(lGirisMiktar1 * (nGirisCikis - 1))) , 0) lSevkIadeMiktari , isnull(abs(SUM(lGirisTutar * (nGirisCikis - 1))) , 0) lSevkIadeTutari FROM tbStokFisiDetayi , tbStok , tbFirma WHERE tbStok.nStokID = tbStokFisiDetayi.nStokID AND tbFirma.nFirmaID = tbStokFisiDetayi.nFirmaID AND dteIslemTarihi BETWEEN '01/01/1900' AND '31/12/2078' AND nSiparisID IS NOT NULL GROUP BY nSiparisID) tbStokFisiDetayi RIGHT OUTER JOIN tbStok INNER JOIN tbRenk ON tbStok.sRenk = tbRenk.sRenk AND tbStok.sRenk = tbRenk.sRenk INNER JOIN tbSiparis INNER JOIN tbParti ON tbSiparis.nPartiID = tbParti.nPartiID INNER JOIN tbFirma ON tbSiparis.nFirmaID = tbFirma.nFirmaID ON tbStok.nStokID = tbSiparis.nStokID ON tbStokFisiDetayi.nSiparisID = tbSiparis.nSiparisID WHERE (tbSiparis.bKapandimi = 0) AND (tbSiparis.nSiparisTipi = 2) GROUP BY tbStok.nStokID , tbStok.sKodu , tbStok.sBeden , tbStok.sAciklama , tbFirma.sKodu , tbFirma.sAciklama , tbSiparis.lSiparisNo , tbSiparis.nSiparisID , tbSiparis.dteSiparisTarihi , tbSiparis.dteTeslimTarihi , tbSiparis.sSiparisIslem , tbSiparis.lMiktari , tbSiparis.lReserveMiktari , tbStok.sRenk , tbRenk.sRenkAdi , tbSiparis.nValorGun , CAST(tbSiparis.bKapandimi AS int)) t WHERE (lKalanMiktar > 0) AND nStokID = ts.nStokID) AS Siparis FROM (SELECT nStokID , sAciklama , SUM(GIREN) AS GIREN , SUM(CIKAN) AS CIKAN , SUM(KALAN) AS KALAN , SUM(BEKLEYEN) AS BEKLEYEN , sBarkod , STOKKODU , STOKADI , sRenk , sBeden , lAsgariMiktar , lAzamiMiktar , sModel FROM (SELECT depo.sAciklama , 0 AS GIREN , 0 AS CIKAN , 0 AS KALAN , barkod.sBarkod , stok.nStokID , stok.sKodu AS STOKKODU , stok.sAciklama AS STOKADI , stok.sRenk , stok.sBeden , stok.lAsgariMiktar , stok.lAzamiMiktar , stok.sModel , SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) AS BEKLEYEN FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID INNER JOIN tbDepo depo ON tbAlisverisSiparis.sMagazaKodu = depo.sDepo INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') GROUP BY depo.sAciklama , barkod.sBarkod , stok.nStokID , stok.sKodu , stok.sAciklama , stok.sRenk , stok.sBeden , stok.lAsgariMiktar , stok.lAzamiMiktar , stok.sModel UNION SELECT depo.sAciklama , ISNULL(SUM(hareket.lGirisMiktar1) , 0) AS GIREN , ISNULL(SUM(hareket.lCikisMiktar1) , 0) AS CIKAN , ISNULL(SUM(hareket.lGirisMiktar1 - hareket.lCikisMiktar1) , 0) AS KALAN , barkod.sBarkod , stok.nStokID , stok.sKodu AS STOKKODU , stok.sAciklama AS STOKADI , stok.sRenk , stok.sBeden , stok.lAsgariMiktar , stok.lAzamiMiktar , stok.sModel , 0 AS BEKLEYEN FROM tbStokBarkodu barkod INNER JOIN tbStok stok INNER JOIN tbStokFisiDetayi hareket ON stok.nStokID = hareket.nStokID INNER JOIN tbDepo depo ON hareket.sDepo = depo.sDepo ON barkod.nStokID = stok.nStokID WHERE (hareket.sFistipi <> 'T') and hareket.dteFisTarihi between '" & dteIslemTarihi1 & "' and '" & dteIslemTarihi2 & "' GROUP BY depo.sAciklama , stok.nStokID , barkod.sBarkod , stok.sKodu , stok.sAciklama , stok.sRenk , stok.sBeden , stok.lAsgariMiktar , stok.lAzamiMiktar , stok.sModel , depo.sDepo) TT GROUP BY sAciklama , sBarkod , nStokID , STOKKODU , STOKADI , sRenk , sBeden , lAsgariMiktar , lAzamiMiktar , sModel) TS INNER JOIN tbRenk ON TS.sRenk COLLATE Turkish_CI_AS = tbRenk.sRenk LEFT OUTER JOIN tbStokFiyati ON TS.nStokID = tbStokFiyati.nStokID WHERE (tbStokFiyati.sFiyatTipi = '1   ') GROUP BY TS.nStokID , TS.sBarkod , TS.STOKKODU , TS.STOKADI , TS.sRenk , TS.sBeden , TS.lAsgariMiktar , TS.lAzamiMiktar , TS.sModel , tbRenk.sRenkAdi , tbStokFiyati.lFiyat) Satis RIGHT OUTER JOIN ASTOKETIKETTALEPDETAY Talep ON Satis.nStokID = Talep.STOKNO WHERE (Talep.EVRAKNO = " & EVRAKNO & ")")
        cmd.Connection = conn
        conn.Open()
    ...
    Private Sub dataload(ByVal ara_stok As String, ByVal konum_stok As String, ByVal ara_kriter_stok As String, ByVal sFiyatTipi As String)
        DataSet1 = stok(ara_stok, konum_stok, ara_kriter_stok, sFiyatTipi, dteIslemTarihi1, dteIslemTarihi2, sEvrakno)
    ...
    Private Sub MenuItem17_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem17.Click
        analiz_serviste()
    End Sub
    Friend WithEvents collKota As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents collKotaKalan As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents collKotaYuzde As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Private Sub BarButtonItem9_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem9.ItemClick
        raporla_pdf()
    End Sub
    Friend WithEvents collKotaHedefYuzde As DevExpress.XtraGrid.Columns.GridColumn
End Class
