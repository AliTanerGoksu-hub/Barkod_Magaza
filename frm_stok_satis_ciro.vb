...
Public Class frm_stok_satis_ciro
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents colToplamKdv As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colMiktar As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNetCiro As DevExpress.XtraGrid.Columns.GridColumn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_satis_ciro))
        ...
        Me.colToplamKdv = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colMiktar = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNetCiro = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.PanelControl1.Size = New System.Drawing.Size(824, 128)
        ...
        Me.GroupControl1.Size = New System.Drawing.Size(726, 124)
        ...
        Me.sec_alisveris.Location = New System.Drawing.Point(64, 69)
        ...
        Me.sec_periyod.Location = New System.Drawing.Point(64, 89)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(264, 89)
        ...
        Me.PictureBox1.Size = New System.Drawing.Size(94, 124)
        ...
        Me.XtraTabControl1.Size = New System.Drawing.Size(820, 227)
        ...
        Me.XtraTabPage1.Size = New System.Drawing.Size(818, 194)
        Me.XtraTabPage1.Text = "Ta&blo..."
        '
        'sec_grid
        '
        Me.sec_grid.Controls.Add(Me.GridControl2)
        Me.sec_grid.Location = New System.Drawing.Point(163, 27)
        ...
        Me.GridControl1.Size = New System.Drawing.Size(818, 194)
        ...
        'DataColumn2
        '
        Me.DataColumn2.ColumnName = "Tutar"
        Me.DataColumn2.DataType = GetType(Decimal)
        '
        'DataColumn3
        '
        Me.DataColumn3.ColumnName = "Iskonto"
        Me.DataColumn3.DataType = GetType(Decimal)
        '
        'DataColumn4
        '
        Me.DataColumn4.ColumnName = "ToplamKdv"
        Me.DataColumn4.DataType = GetType(Decimal)
        '
        'DataColumn5
        '
        Me.DataColumn5.ColumnName = "Miktar"
        Me.DataColumn5.DataType = GetType(Decimal)
        '
        'DataColumn6
        '
        Me.DataColumn6.ColumnName = "NetCiro"
        Me.DataColumn6.DataType = GetType(Decimal)
        '
        'DataColumn7
        '
        Me.DataColumn7.ColumnName = "AraToplam"
        Me.DataColumn7.DataType = GetType(Decimal)
        '
        'DataColumn8
        '
        Me.DataColumn8.ColumnName = "MUSTERISAYISI"
        '
        'GridView1
        '
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPERIYOD, Me.colTutar, Me.colIskonto, Me.colToplamKdv, Me.colMiktar, Me.colNetCiro, Me.colAraToplam, Me.colKOD, Me.colMUSTERISAYISI, Me.colKar, Me.colYuzde, Me.colFISSAYISI, Me.colFISORTALAMA})
        ...
        Me.colIskonto.VisibleIndex = 3
        Me.colIskonto.Width = 89
        '
        'colToplamKdv
        '
        Me.colToplamKdv.Caption = "Toplam Kdv"
        Me.colToplamKdv.DisplayFormat.FormatString = "#,0.00"
        Me.colToplamKdv.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colToplamKdv.FieldName = "ToplamKdv"
        Me.colToplamKdv.Name = "colToplamKdv"
        Me.colToplamKdv.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "ToplamKdv", "{0:#,0.00}")})
        Me.colToplamKdv.Visible = True
        Me.colToplamKdv.VisibleIndex = 4
        Me.colToplamKdv.Width = 89
        '
        'colMiktar
        '
        ...
        'colNetCiro
        '
        Me.colNetCiro.Caption = "Net Ciro"
        Me.colNetCiro.DisplayFormat.FormatString = "#,0.00"
        Me.colNetCiro.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colNetCiro.FieldName = "NetCiro"
        Me.colNetCiro.Name = "colNetCiro"
        Me.colNetCiro.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NetCiro", "{0:#,0.00}")})
        Me.colNetCiro.Visible = True
        Me.colNetCiro.VisibleIndex = 6
        Me.colNetCiro.Width = 89
        '
        'colAraToplam
        '
        Me.colAraToplam.Caption = "Ara Toplam"
        ...
        Me.colFISSAYISI.VisibleIndex = 9
        '
        'colFISORTALAMA
        '
        ...
        Me.colFISORTALAMA.VisibleIndex = 10
        '
        'XtraTabPage2
        '
        Me.XtraTabPage2.Controls.Add(Me.ChartControl1)
        Me.XtraTabPage2.Name = "XtraTabPage2"
        Me.XtraTabPage2.Size = New System.Drawing.Size(818, 194)
        ...
        Series1.ValueDataMembersSerializable = "NetCiro"
        ...
        Me.ChartControl1.Size = New System.Drawing.Size(818, 194)
        ...
        Me.Bar3.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem1, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem2, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem3, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem4, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem5, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem6, True)})
        ...
        'BarButtonItem1
        '
        Me.BarButtonItem1.Caption = "Giriþ Deðiþtir"
        ...
        'BarButtonItem2
        '
        Me.BarButtonItem2.Caption = "Grafik Yazdir"
        ...
        Me.Name = "frm_stok_satis_ciro"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Periyodik Satýþ Cirolarý"
...
#End Region
    ...
    Private Function sorgu_kriter_string(ByVal deger As String, ByVal kriter As String) As String
        ...
        Return sorgu_kriter
    End Function
    Public Function stok(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal depo As String, ByVal periyod As String, ByVal yenikayit As Boolean, ByVal alisveris As String) As DataSet
        Dim kriter As String = ""
        Dim kriter_fatura = ""
        kriter += " WHERE dteFaturaTarihi Between '" & tarih1 & "' and '" & tarih2 & "' "
        kriter_fatura += " WHERE dteFisTarihi Between '" & tarih1 & "' and '" & tarih2 & "'  and sFisTipi IN (" & kriter_fistipi & ") "
        If depo <> "[Tümü]" Then
        ...
        If yenikayit = True Then
            ...
            kriter_fatura += " AND nFirmaID IN (Select nFirmaID From tbFirma WHERE dteKayitTarihi between '" & Microsoft.VisualBasic.Left(tarih1.ToString, 10) + " 00:00:00" & "' and '" & Microsoft.VisualBasic.Left(tarih2.ToString, 10) + " 23:59:59" & "' )"
        End If
        If alisveris = "[Tümü]" Then
        ElseIf alisveris = "Kredili Satýþlar" Then
            kriter += " AND sFisTipi IN ('K','SK') "
            kriter_fatura += " AND sFisTipi IN ('K','SK') "
        ElseIf alisveris = "Kredili" Then
            kriter += " AND sFisTipi IN ('K') "
            kriter_fatura += " AND sFisTipi IN ('K') "
        ElseIf alisveris = "Sonradan Teslim Kredili" Then
            kriter += " AND sFisTipi IN ('SK') "
            kriter_fatura += " AND sFisTipi IN ('SK') "
        ElseIf alisveris = "Peþin Satýþlar" Then
            kriter += " AND sFisTipi IN ('P','SP') "
            kriter_fatura += " AND sFisTipi IN ('P','SP') "
        ElseIf alisveris = "Peþin" Then
            kriter += " AND sFisTipi IN ('P') "
            kriter_fatura += " AND sFisTipi IN ('P') "
        ElseIf alisveris = "Sonradan Teslim Peþin" Then
            kriter += " AND sFisTipi IN ('SP') "
            kriter_fatura += " AND sFisTipi IN ('SP') "
        End If
        Dim conn As New OleDb.OleDbConnection
        Dim cmd As New OleDb.OleDbCommand
        Dim adapter As New OleDb.OleDbDataAdapter
        ...
        If islem = 0 Then
            If periyod = "Günlük" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DAY(dteFaturaTarihi) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam,COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM tbAlisVeris " & kriter & "  GROUP BY DAY(dteFaturaTarihi) ORDER BY DAY(dteFaturaTarihi)")
            ElseIf periyod = "Aylýk" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DBO.AYTOSTR(MONTH(dteFaturaTarihi)) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam,COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM tbAlisVeris " & kriter & "  GROUP BY DBO.AYTOSTR(MONTH(dteFaturaTarihi)) ORDER BY DBO.AYTOSTR(MONTH(dteFaturaTarihi))")
            ElseIf periyod = "Haftalýk" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT { fn WEEK(dteFaturaTarihi) } AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam,COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM tbAlisVeris " & kriter & "  GROUP BY { fn WEEK(dteFaturaTarihi) } ORDER BY { fn WEEK(dteFaturaTarihi) }")
            ElseIf periyod = "Yýllýk" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT YEAR(dteFaturaTarihi) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam,COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM tbAlisVeris " & kriter & "  GROUP BY YEAR(dteFaturaTarihi) ORDER BY YEAR(dteFaturaTarihi)")
            ElseIf periyod = "Haftanýn Günü" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET DATEFIRST 1 SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DATENAME(DW, dteFaturaTarihi) AS PERIYOD,DATEPART(DW, dteFaturaTarihi), SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam,COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM tbAlisVeris " & kriter & "  GROUP BY DATENAME(DW, dteFaturaTarihi),DATEPART(DW, dteFaturaTarihi) ORDER BY DATEPART(DW, dteFaturaTarihi)")
            ElseIf periyod = "Quarter" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT { fn QUARTER(dteFaturaTarihi) } AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam,COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM tbAlisVeris " & kriter & "  GROUP BY { fn QUARTER(dteFaturaTarihi) } ORDER BY { fn QUARTER(dteFaturaTarihi) }")
            ElseIf periyod = "Saatlik" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DATEPART(HH,dteKayitTarihi)  AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam,COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM tbAlisVeris " & kriter & "  GROUP BY DATEPART(HH,dteKayitTarihi) ORDER BY DATEPART(HH,dteKayitTarihi)")
            End If
            'cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DAY(dteFaturaTarihi) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam FROM tbAlisVeris " & kriter & "  GROUP BY DAY(dteFaturaTarihi)")
        ElseIf islem = 1 Then
            If periyod = "Günlük" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DAY(dteFaturaTarihi) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM (SELECT nAlisVerisID,dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nMusteriID FROM tbAlisVeris " & kriter & "  UNION ALL SELECT CAST(nStokFisiID as CHAR(60)) as nAlisVerisID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY DAY(dteFaturaTarihi) ORDER BY DAY(dteFaturaTarihi)")
            ElseIf periyod = "Aylýk" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DBO.AYTOSTR(MONTH(dteFaturaTarihi)) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM (SELECT nAlisVerisID,dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nMusteriID FROM tbAlisVeris " & kriter & "  UNION ALL SELECT CAST(nStokFisiID as CHAR(60)) as nAlisVerisID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY DBO.AYTOSTR(MONTH(dteFaturaTarihi)) ORDER BY DBO.AYTOSTR(MONTH(dteFaturaTarihi))")
            ElseIf periyod = "Haftalýk" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT { fn WEEK(dteFaturaTarihi) } AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM (SELECT nAlisVerisID,dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nMusteriID FROM tbAlisVeris " & kriter & "  UNION ALL SELECT CAST(nStokFisiID as CHAR(60)) as nAlisVerisID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY { fn WEEK(dteFaturaTarihi) } ORDER BY { fn WEEK(dteFaturaTarihi) } ")
            ...
            ElseIf periyod = "Quarter" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT { fn QUARTER(dteFaturaTarihi) } AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM (SELECT nAlisVerisID,dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nMusteriID FROM tbAlisVeris " & kriter & "  UNION ALL SELECT CAST(nStokFisiID as CHAR(60)) as nAlisVerisID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY { fn QUARTER(dteFaturaTarihi) } ORDER BY { fn QUARTER(dteFaturaTarihi) }")
            ElseIf periyod = "Saatlik" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DATEPART(HH,dteKayitTarihi) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nAlisVerisID) AS MUSTERISAYISI,COUNT(DISTINCT nAlisVerisID) AS FISSAYISI,SUM(lNetTutar)/COUNT(DISTINCT nAlisVerisID) FISORTALAMA   FROM (SELECT nAlisVerisID,dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nMusteriID,dteKayitTarihi FROM tbAlisVeris " & kriter & "  UNION ALL SELECT CAST(nStokFisiID as CHAR(60)) as nAlisVerisID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID,dteKayitTarihi FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY DATEPART(HH,dteKayitTarihi) ORDER BY DATEPART(HH,dteKayitTarihi) ")
            End If
        ElseIf islem = 2 Then
            If periyod = "Günlük" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DAY(dteFaturaTarihi) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nStokFisiID) AS MUSTERISAYISI FROM (SELECT nStokFisiID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY DAY(dteFaturaTarihi) ORDER BY DAY(dteFaturaTarihi)")
            ElseIf periyod = "Aylýk" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DBO.AYTOSTR(MONTH(dteFaturaTarihi)) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nStokFisiID) AS MUSTERISAYISI FROM (SELECT nStokFisiID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY DBO.AYTOSTR(MONTH(dteFaturaTarihi)) ORDER BY DBO.AYTOSTR(MONTH(dteFaturaTarihi))")
            ElseIf periyod = "Haftalýk" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT { fn WEEK(dteFaturaTarihi) } AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nStokFisiID) AS MUSTERISAYISI FROM (SELECT nStokFisiID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY { fn WEEK(dteFaturaTarihi) } ORDER BY { fn WEEK(dteFaturaTarihi) } ")
            ...
            ElseIf periyod = "Quarter" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT { fn QUARTER(dteFaturaTarihi) } AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nStokFisiID) AS MUSTERISAYISI FROM (SELECT nStokFisiID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY { fn QUARTER(dteFaturaTarihi) } ORDER BY { fn QUARTER(dteFaturaTarihi) }")
            ElseIf periyod = "Saatlik" Then
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT DATEPART(HH,dteKayitTarihi) AS PERIYOD, SUM(lMalBedeli) AS Tutar, SUM(lMalIskontoTutari) AS Iskonto, SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5) AS ToplamKdv, SUM(lToplamMiktar) AS Miktar, SUM(lNetTutar) AS NetCiro, SUM(lMalBedeli) - (SUM(lKdv1) + SUM(lKdv2) + SUM(lKdv3) + SUM(lKdv4) + SUM(lKdv5)) AS AraToplam, COUNT(DISTINCT nStokFisiID) AS MUSTERISAYISI FROM (SELECT nStokFisiID,dteFisTarihi AS dteFaturaTarihi , lMalBedeli , lMalIskontoTutari , lKdv1 , lKdv2 , lKdv3 , lKdv4 , lKdv5 , lToplamMiktar , lNetTutar , nFirmaID AS nMusteriID,dteKayitTarihi FROM tbStokFisiMaster " & kriter_fatura & " ) t GROUP BY DATEPART(HH,dteKayitTarihi) ORDER BY DATEPART(HH,dteKayitTarihi) ")
            End If
        End If
        cmd.Connection = conn
        conn.Open()
    ...
    Private Function sorgu_query(ByVal query As String) As String
        ...
        Return query
    End Function
    Private Sub dataload(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal depo As String, ByVal periyod As String, ByVal yenikayit As Boolean, ByVal alisveris As String)
        DataSet1 = stok(tarih1, tarih2, depo, periyod, yenikayit, alisveris)
    ...
    Private Sub SimpleButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton3.Click
        ...
        dataload(DateEdit1.EditValue, DateEdit2.EditValue, Trim(sec_depo.Text), sec_periyod.Text, sec_yeni.Checked, sec_alisveris.Text)
        Label2.Text = Sorgu_sDil("Tamamlandý...", sDil)
