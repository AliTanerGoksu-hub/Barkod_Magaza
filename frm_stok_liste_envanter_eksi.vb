...
Public Class frm_stok_liste_envanter_eksi
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_liste_envanter_eksi))
        ...
        Me.LabelControl2.Location = New System.Drawing.Point(14, 63)
        ...
        Me.sec_depo.Location = New System.Drawing.Point(183, 60)
        ...
        Me.sec_depo.Size = New System.Drawing.Size(157, 20)
        Me.sec_depo.TabIndex = 5
        '
        'sec_grid
        '
        Me.sec_grid.Controls.Add(Me.GridControl2)
        Me.sec_grid.Location = New System.Drawing.Point(264, 51)
        ...
        Me.sec_konum.Location = New System.Drawing.Point(184, 38)
        ...
        Me.sec_kriter.Location = New System.Drawing.Point(276, 38)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(344, 17)
        Me.SimpleButton3.Name = "SimpleButton3"
        Me.SimpleButton3.Size = New System.Drawing.Size(64, 63)
        Me.SimpleButton3.TabIndex = 7
        Me.SimpleButton3.Text = "&Listele"
        '
        'sec_mevcut
        '
        Me.sec_mevcut.EditValue = "Eksiler"
        Me.sec_mevcut.Enabled = False
        ...
        'ContextMenu1
        '
        Me.ContextMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem13, Me.MenuItem14, Me.MenuItem15, Me.MenuItem21, Me.MenuItem16, Me.MenuItem17, Me.MenuItem18, Me.MenuItem19, Me.MenuItem20, Me.MenuItem1, Me.MenuItem2, Me.MenuItem3, Me.MenuItem4, Me.MenuItem10, Me.MenuItem22, Me.MenuItem5, Me.MenuItem6, Me.MenuItem11, Me.MenuItem7, Me.MenuItem8, Me.MenuItem12, Me.MenuItem9})
        '
        'MenuItem13
        '
        ...
        Me.MenuItem18.Text = "Transfer Hareketleri"
        '
        'MenuItem19
        '
        ...
        Me.Name = "frm_stok_liste_envanter_eksi"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Stok Envanteri Eksiye Düþenler"
...
#End Region
    ...
    Private Function sorgu_kriter_string(ByVal deger As String, ByVal kriter As String) As String
        ...
        Return sorgu_kriter
    End Function
    Public Function stok(ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String, ByVal tarih1 As DateTime, ByVal mevcut As String, ByVal depo As String) As DataSet
        ...
        adapter.SelectCommand = cmd
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) AS Mevcut, { fn UCASE(tbStokFisiDetayi.sDepo) } AS sDepo, tbStok.nStokID,tbStok.sKodu, tbStok.sAciklama,tbStok.sModel, tbRenk.sRenkAdi,'' as ISTIHBARAT FROM tbStokFisiDetayi INNER JOIN tbStok ON tbStokFisiDetayi.nStokID = tbStok.nStokID INNER JOIN tbRenk ON tbStok.sRenk = tbRenk.sRenk " & kriter & " GROUP BY { fn UCASE(tbStokFisiDetayi.sDepo) }, tbStok.nStokID,tbStok.sKodu, tbStok.sAciklama, tbStok.sModel,tbRenk.sRenkAdi HAVING (SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) < 0) ORDER BY { fn UCASE(tbStokFisiDetayi.sDepo) }  , tbStok.sKodu")
        cmd.Connection = conn
        conn.Open()
    ...
    Private Function sorgu_query(ByVal query As String) As String
        ...
        Return query
    End Function
    Private Sub dataload(ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String, ByVal tarih1 As DateTime, ByVal mevcut As String, ByVal depo As String)
        Me.Refresh()
        DataSet1 = stok(ara, konum, ara_kriter, tarih1, mevcut, depo)
    ...
    Private Sub SimpleButton6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        dataload(txt_ara.EditValue, sec_konum.Text, sec_kriter.Text, DateEdit1.EditValue, sec_mevcut.Text, sec_depo.Text)
    End Sub
