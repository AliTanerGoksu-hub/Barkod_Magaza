...
Public Class frm_firma_faaliyet
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_firma_faaliyet))
        ...
        Me.GroupControl1.Size = New System.Drawing.Size(681, 92)
        ...
        Me.sec_sdepo.Location = New System.Drawing.Point(193, 65)
        ...
        Me.sec_sdepo.Size = New System.Drawing.Size(99, 20)
        Me.sec_sdepo.TabIndex = 60
        '
        'sec_grid
        '
        Me.sec_grid.Controls.Add(Me.GridControl2)
        Me.sec_grid.Location = New System.Drawing.Point(140, 60)
        ...
        Me.LabelControl12.Location = New System.Drawing.Point(157, 65)
        ...
        Me.sec_sTarihTipi.MenuManager = Me.BarManager1
        ...
        Me.sec_sTarihTipi.Properties.Items.AddRange(New Object() {"Tarih", "Valor"})
        Me.sec_sTarihTipi.Size = New System.Drawing.Size(52, 20)
        Me.sec_sTarihTipi.TabIndex = 17
        '
        'BarManager1
        '
        ...
        'BarButtonItem9
        '
        Me.BarButtonItem9.Caption = "Toplamlar"
        ...
        Me.sec_sSatici.Location = New System.Drawing.Point(56, 65)
        ...
        Me.LabelControl4.Location = New System.Drawing.Point(6, 43)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(293, 65)
        Me.SimpleButton3.Name = "SimpleButton3"
        Me.SimpleButton3.Size = New System.Drawing.Size(73, 21)
        ...
        Me.PanelControl3.Size = New System.Drawing.Size(824, 263)
        ...
        Me.GridView1.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "sKodu", Me.colsKodu, "{0} Kayýt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lBorcTutar", Nothing, "Cikan:{0:#,0.00##}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "collAlacakTutar", Nothing, "Giren:{0:#,0.00##}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Max, "collBakiye", Nothing, "{0:#,0.00##}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "sKodu", Me.colsKodu, "{0} Kayýt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lBorcTutar", Me.collBorcTutar, "{0:#,0.00##}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lAlacakTutar", Me.collAlacakTutar, "{0:#,0.00##}")})
        ...
        Me.colsHangiUygulama.VisibleIndex = 0
        Me.colsHangiUygulama.Width = 90
        '
        'colsCariIslem
        '
        ...
        Me.colsCariIslem.VisibleIndex = 1
        Me.colsCariIslem.Width = 68
        '
        'colsDovizCinsi1
        '
        ...
        Me.colsDovizCinsi1.VisibleIndex = 6
        '
        'collDovizMiktari1
        '
        ...
        Me.collDovizMiktari1.VisibleIndex = 7
        '
        'collDovizKuru1
        '
        ...
        Me.Name = "frm_firma_faaliyet"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Hesap Faaliyetleri"
...
#End Region
    ...
    Private Sub gorunum_yazdir()
        ...
        kriter += Microsoft.VisualBasic.Left(DateEdit1.EditValue.ToString, 10) & " ve " & Microsoft.VisualBasic.Left(DateEdit2.EditValue.ToString, 10) & " Tarihleri Arasýndaki Firma Faaliyetleri " & vbCrLf
    ...
    Public Function stok(ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String, ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal sSaticiRumuzu As String, ByVal sDepo As String) As DataSet
        Dim kriter = " WHERE (tbFirmaHareketi.lBorcTutar - tbFirmaHareketi.lAlacakTutar <> 0) "
        ...
        ElseIf sModul = "Banka" Then
            ...
            End If
        End If
        If sec_sTarihTipi.Text = "Tarih" Then
            kriter += " AND tbFirmaHareketi.dteIslemTarihi between '" & Microsoft.VisualBasic.Left(tarih1.ToString, 10) & "' and '" & Microsoft.VisualBasic.Left(tarih2.ToString, 10) & "' "
        ElseIf sec_sTarihTipi.Text = "Valor" Then
            kriter += " AND tbFirmaHareketi.dteValorTarihi between '" & Microsoft.VisualBasic.Left(tarih1.ToString, 10) & "' and '" & Microsoft.VisualBasic.Left(tarih2.ToString, 10) & "' "
        End If
        sKriter = kriter
        ...
        adapter.SelectCommand = cmd
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(tbFirmaHareketi.lBorcTutar) AS lBorcTutar, SUM(tbFirmaHareketi.lAlacakTutar) AS lAlacakTutar, tbFirmaHareketi.sHangiUygulama, tbFirmaHareketi.sCariIslem, tbFirma.nFirmaID, tbFirma.sKodu, tbFirma.sAciklama, tbFirmaHareketi.sDovizCinsi1, tbFirmaHareketi.lDovizMiktari1, tbFirmaHareketi.lDovizKuru1, tbFirma.nOzelIskontosu, tbFirma.lKrediLimiti, tbFirma.sAdres1 + ' ' + tbFirma.sAdres2 + ' ' + tbFirma.sSemt + ' ' + tbFirma.sIl + ' ' + tbFirma.sUlke + ' ' + tbFirma.sPostaKodu AS Adres, tbFirma.sVergiDairesi, tbFirma.sVergiNo, tbFirma.sSemt, tbFirma.sIl, tbFSinif1.sAciklama AS FSINIF1, tbFSinif2.sAciklama AS FSINIF2, tbFSinif3.sAciklama AS FSINIF3, tbFSinif4.sAciklama AS FSINIF4, tbFSinif5.sAciklama AS FSINIF5, (SELECT ISNULL(SUM(lBorcTutar - lAlacakTutar) , 0) AS lBakiye FROM tbFirmaHareketi WHERE nFirmaID = tbFirma.nFirmaID) AS lBakiye, tbFirmaAciklamasi.sAciklama1 + ' ' + tbFirmaAciklamasi.sAciklama2 + ' ' + tbFirmaAciklamasi.sAciklama3 + ' ' + tbFirmaAciklamasi.sAciklama4 + ' ' + tbFirmaAciklamasi.sAciklama5 AS ISTIHBARAT FROM tbFirma INNER JOIN tbFirmaHareketi ON tbFirma.nFirmaID = tbFirmaHareketi.nFirmaID INNER JOIN tbFirmaSinifi ON tbFirma.nFirmaID = tbFirmaSinifi.nFirmaID INNER JOIN tbFSinif1 ON tbFirmaSinifi.sSinifKodu1 = tbFSinif1.sSinifKodu INNER JOIN tbFSinif2 ON tbFirmaSinifi.sSinifKodu2 = tbFSinif2.sSinifKodu INNER JOIN tbFSinif3 ON tbFirmaSinifi.sSinifKodu3 = tbFSinif3.sSinifKodu INNER JOIN tbFSinif4 ON tbFirmaSinifi.sSinifKodu4 = tbFSinif4.sSinifKodu INNER JOIN tbFSinif5 ON tbFirmaSinifi.sSinifKodu5 = tbFSinif5.sSinifKodu LEFT OUTER JOIN tbFirmaAciklamasi ON tbFirma.nFirmaID = tbFirmaAciklamasi.nFirmaID " & kriter & " GROUP BY tbFirmaHareketi.sHangiUygulama, tbFirmaHareketi.sCariIslem, tbFirmaHareketi.sDovizCinsi1, tbFirmaHareketi.lDovizMiktari1, tbFirmaHareketi.lDovizKuru1, tbFirma.nFirmaID, tbFirma.sKodu, tbFirma.sAciklama, tbFirma.nOzelIskontosu, tbFirma.lKrediLimiti, tbFirma.sAdres1, tbFirma.sAdres2, tbFirma.sVergiDairesi, tbFirma.sVergiNo, tbFirma.sSemt, tbFirma.sIl, tbFirma.sUlke, tbFirma.sPostaKodu, tbFSinif1.sAciklama, tbFSinif2.sAciklama, tbFSinif3.sAciklama, tbFSinif4.sAciklama, tbFSinif5.sAciklama, tbFirmaAciklamasi.sAciklama1, tbFirmaAciklamasi.sAciklama2, tbFirmaAciklamasi.sAciklama3, tbFirmaAciklamasi.sAciklama4, tbFirmaAciklamasi.sAciklama5  ORDER BY tbFirma.nFirmaID, tbFirmaHareketi.sHangiUygulama, tbFirmaHareketi.sCariIslem")
        cmd.Connection = conn
        conn.Open()
    ...
    Private Sub analiz_cari_genel()
        If GridView1.RowCount > 0 Then
            ...
            frm.connection = connection
            frm.sKodu = musterino
            frm.txt_musteriNo.EditValue = musterino
            frm.kullanici = kullanici
            frm.sKriter = sKriter
            If yetki_kontrol(kullanici, frm.Name) = True Then
                frm.ShowDialog()
