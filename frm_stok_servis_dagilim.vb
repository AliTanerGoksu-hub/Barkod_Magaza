...
Public Class frm_stok_servis_dagilim
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_servis_dagilim))
        ...
        Me.Label1.Text = "Servisteki Stoklarýn Daðýlýmý"
        '
        'PictureBox1
        '
        ...
        Me.sec_tamamlandi.Properties.Items.AddRange(New Object() {"[Tümü]", "Bekleyen", "TümBekleyen", "Serviste", "TeslimEdilen", "Onarýlan", "Ýptal", "FirmayaGönderilen", "FirmadanGelen"})
        Me.sec_tamamlandi.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor
        Me.sec_tamamlandi.Size = New System.Drawing.Size(100, 22)
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colFIRMATIPI, Me.colSayi, Me.colMiktar, Me.colKayit, Me.colTutar})
        ...
        'colFIRMATIPI
        '
        Me.colFIRMATIPI.Caption = "Firmada?"
        Me.colFIRMATIPI.FieldName = "FIRMATIPI"
        Me.colFIRMATIPI.Name = "colFIRMATIPI"
        Me.colFIRMATIPI.SummaryItem.DisplayFormat = "{0} Kayýt"
        Me.colFIRMATIPI.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Count
        Me.colFIRMATIPI.Visible = True
        Me.colFIRMATIPI.VisibleIndex = 0
        '
        'colSayi
        '
        Me.colSayi.Caption = "Hesap"
        ...
        Me.colSayi.SummaryItem.DisplayFormat = "{0:#,0}"
        Me.colSayi.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum
        Me.colSayi.Visible = True
        Me.colSayi.VisibleIndex = 1
        '
        'colMiktar
        '
        Me.colMiktar.Caption = "Parça"
        ...
        'colKayit
        '
        Me.colKayit.Caption = "Kayýt"
        Me.colKayit.DisplayFormat.FormatString = "#,0"
        Me.colKayit.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colKayit.FieldName = "Kayit"
        Me.colKayit.Name = "colKayit"
        Me.colKayit.SummaryItem.DisplayFormat = "{0:#,0}"
        Me.colKayit.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum
        Me.colKayit.Visible = True
        Me.colKayit.VisibleIndex = 4
        '
        'colTutar
        '
        ...
        Me.Name = "frm_stok_servis_dagilim"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Servis Ürün Daðýlýmý"
...
#End Region
    ...
    Private Sub gorunum_yazdir()
        ...
        kriter += Microsoft.VisualBasic.Left(tarih1.ToString, 10) & "  Tarihli Servis Ürün Daðýlýmý" & vbCrLf
        kriter += "Kriter: " & sec_tamamlandi.Text
        printlink1.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"[User Name]", kriter, "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"Powered by www.barkodyazilimevi.com", "Service Managment-Servis Yönetimi", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
    ...
    Public Function stok() As DataSet
        ...
        If takip = False Then
            cmd.CommandText = sorgu_query("SET dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT     FIRMATIPI, COUNT(DISTINCT FIRMAKODU) AS Sayi, SUM(GIREN) AS Miktar, SUM(TUTAR) AS Tutar,COUNT(*) AS Kayit FROM         (SELECT     BASLIK.FIRMATIPI, BASLIK.FIRMAKODU, HAREKET.GIREN,HAREKET.TUTAR, (SELECT     TOP 1 ISLEMTIPI  FROM          ASTOKSERVISHAREKETLERI WHERE      (REFNO = HAREKET.IND) AND (REFBASLIK = HAREKET.EVRAKNO)       ORDER BY ISLEMTIPI DESC) AS STOKISLEMTIPI FROM          ASTOKSERVISBASLIK AS BASLIK INNER JOIN ASTOKSERVISDETAY AS HAREKET ON BASLIK.IND = HAREKET.EVRAKNO) AS TT " & kriter & " GROUP BY FIRMATIPI ")
        ElseIf takip = True Then
            cmd.CommandText = sorgu_query("SET dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT APERSONEL.PERSONELADI AS PersonelAdý, COUNT(*) AS Devreden, 0 AS Bugun, COUNT(*) AS Toplam FROM         aEmirMusteriTakip INNER JOIN                       APERSONEL ON aEmirMusteriTakip.PersonelNo = APERSONEL.IND WHERE     (aEmirMusteriTakip.Status = 0) GROUP BY APERSONEL.PERSONELADI ")
        End If
        cmd.Connection = conn
        conn.Open()
