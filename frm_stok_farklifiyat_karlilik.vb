...
Imports System.IO
Public Class frm_stok_farklifiyat_karlilik
    ...
    Friend WithEvents colTLONBESAY As DevExpress.XtraGrid.Columns.GridColumn
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_farklifiyat_karlilik))
        ...
        Me.colTLONBESAY = New DevExpress.XtraGrid.Columns.GridColumn
        ...
        'colORAN1
        '
        Me.colORAN1.AppearanceCell.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(162, Byte))
        ...
        'colORAN2
        '
        Me.colORAN2.AppearanceCell.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(162, Byte))
        ...
        'colORAN3
        '
        Me.colORAN3.AppearanceCell.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(162, Byte))
        ...
        Me.colTLALTIAY.Visible = True
        Me.colTLALTIAY.VisibleIndex = 8
        ...
        Me.colTLPESIN.Visible = True
        Me.colTLPESIN.VisibleIndex = 5
        ...
        Me.colTLONAY.Visible = True
        Me.colTLONAY.VisibleIndex = 11
        ...
        Me.colONBESAY.VisibleIndex = 13
        '
        'colTLONBESAY
        '
        Me.colTLONBESAY.Caption = "Tl15Ay"
        Me.colTLONBESAY.DisplayFormat.FormatString = "#,0.00"
        Me.colTLONBESAY.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colTLONBESAY.FieldName = "TLONBESAY"
        Me.colTLONBESAY.Name = "colTLONBESAY"
        Me.colTLONBESAY.Visible = True
        Me.colTLONBESAY.VisibleIndex = 14
        '
        'frm_stok_farklifiyat_karlilik
        '
        ...
        Me.Name = "frm_stok_farklifiyat_karlilik"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Stok Fiyatlarý Karlýlýk Analizi"
            ...
            For Each dr1 In ds_stok.Tables(0).Rows
                ...
                If sorgu_sayi(dr("TLPESIN"), 0) > 0 Then
                    If sorgu_sayi(dr("TLPESIN"), 0) <> sorgu_sayi(dr("PESIN"), 0) Then
                        ...
                        End Try
                        If fiyat = 0 Then
                            ekle_fiyat(dr("nStokID"), sFiyat1, dr("TLPESIN"), kullaniciadi)
                        Else
                            If dr1("nStokTipi") = 1 And dr1("nFiyatlandirma") = 0 Then
                                duzelt_fiyat_renk(dr("nStokID"), sFiyat1, dr("TLPESIN"), dr1("sModel"))
                            ElseIf dr1("nStoktipi") = 1 And dr1("nFiyatlandirma") = 1 Then
                                duzelt_fiyat(dr("nStokID"), sFiyat1, dr("TLPESIN"))
                            ElseIf dr1("nStokTipi") = 0 Then
                                duzelt_fiyat(dr("nStokID"), sFiyat1, dr("TLPESIN"))
                            End If
                            'duzelt_fiyat(dr("STOKNO"), "PS", dr("TLPESIN"))
                ...
                If sorgu_sayi(dr("TLALTIAY"), 0) > 0 Then
                    If sorgu_sayi(dr("TLALTIAY"), 0) <> sorgu_sayi(dr("ALTIAY"), 0) Then
                        's += "Altý Aylýk Fiyatlar Farklý" & vbCrLf
                        Try
                            fiyat = sorgu_stok_fiyat(sFiyat2, dr("nStokID"))
                        Catch ex As Exception
                            fiyat = 0
                        End Try
                        If fiyat = 0 Then
                            ekle_fiyat(dr("nStokID"), sFiyat2, dr("TLALTIAY"), kullaniciadi)
                        Else
                            If dr1("nStokTipi") = 1 And dr1("nFiyatlandirma") = 0 Then
                                duzelt_fiyat_renk(dr("nStokID"), "6 AY", dr("TLALTIAY"), dr1("sModel"))
                            ElseIf dr1("nStoktipi") = 1 And dr1("nFiyatlandirma") = 1 Then
                                duzelt_fiyat(dr("nStokID"), sFiyat2, dr("TLALTIAY"))
                            ElseIf dr1("nStokTipi") = 0 Then
                                duzelt_fiyat(dr("nStokID"), sFiyat2, dr("TLALTIAY"))
                            End If
                            'duzelt_fiyat(dr("STOKNO"), "PS", dr("TLPESIN"))
                ...
                If sorgu_sayi(dr("TLONAY"), 0) > 0 Then
                    If sorgu_sayi(dr("TLONAY"), 0) <> sorgu_sayi(dr("ONAY"), 0) Then
                        's += "Peþin Fiyatlar Farklý" & vbCrLf
                        Try
                            fiyat = sorgu_stok_fiyat(sFiyat3, dr("nStokID"))
                        Catch ex As Exception
                            fiyat = 0
                        End Try
                        If fiyat = 0 Then
                            ekle_fiyat(dr("nStokID"), sFiyat3, dr("TLONAY"), kullaniciadi)
                        Else
                            If dr1("nStokTipi") = 1 And dr1("nFiyatlandirma") = 0 Then
                                duzelt_fiyat_renk(dr("nStokID"), sFiyat3, dr("TLONAY"), dr1("sModel"))
                            ElseIf dr1("nStoktipi") = 1 And dr1("nFiyatlandirma") = 1 Then
                                duzelt_fiyat(dr("nStokID"), sFiyat3, dr("TLONAY"))
                            ElseIf dr1("nStokTipi") = 0 Then
                                duzelt_fiyat(dr("nStokID"), sFiyat3, dr("TLONAY"))
                            End If
                            'duzelt_fiyat(dr("STOKNO"), "PS", dr("TLPESIN"))
