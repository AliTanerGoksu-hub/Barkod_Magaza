...
Imports System.IO
Public Class frm_stok_karlilik_analizli
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents colSONMIKTAR As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colONCEKIMIKTAR As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents MenuItem21 As System.Windows.Forms.MenuItem
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_karlilik_analizli))
        ...
        Me.colSONMIKTAR = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colONCEKIMIKTAR = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        'colORAN1
        '
        Me.colORAN1.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(224, Byte), Integer), CType(CType(192, Byte), Integer))
        ...
        Me.colORAN1.VisibleIndex = 4
        Me.colORAN1.Width = 52
        '
        'colORAN2
        '
        Me.colORAN2.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(224, Byte), Integer), CType(CType(192, Byte), Integer))
        ...
        Me.colORAN2.VisibleIndex = 6
        Me.colORAN2.Width = 52
        '
        'colORAN3
        '
        Me.colORAN3.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(224, Byte), Integer), CType(CType(192, Byte), Integer))
        ...
        Me.colORAN3.VisibleIndex = 8
        Me.colORAN3.Width = 55
        '
        'PanelControl1
        '
        ...
        Me.Label1.Size = New System.Drawing.Size(662, 13)
        Me.Label1.TabIndex = 1
        Me.Label1.Text = "Aþaðýda seçtiðiniz Stok Kartlarýnýn Tanýmlý Maliyet fiyatlarýný ve Son 2 Alýþlarý" & _
    "nýn Deðerlendirmesini vede Oransal Daðýlýmlarýný görmektesiniz..."
        '
        'PictureBox1
        '
        ...
        Me.SimpleButton2.Location = New System.Drawing.Point(744, 9)
        ...
        Me.Panelstatus.Location = New System.Drawing.Point(138, 84)
        ...
        Me.colPESIN.VisibleIndex = 3
        Me.colPESIN.Width = 67
        '
        'colALTIAY
        '
        ...
        'colSONALISMIKTARI
        '
        Me.colSONALISMIKTARI.Caption = "Son Alýþ Miktarý"
        ...
        'colSONALISFIYATI
        '
        Me.colSONALISFIYATI.Caption = "Son Alýþ Fiyatý"
        Me.colSONALISFIYATI.DisplayFormat.FormatString = "#,0.##"
        ...
        'colSONALISMALIYETI
        '
        Me.colSONALISMALIYETI.Caption = "Son Alýþ Maliyeti"
        Me.colSONALISMALIYETI.DisplayFormat.FormatString = "#,0.##"
        ...
        Me.colNETMALIYET.VisibleIndex = 12
        Me.colNETMALIYET.Width = 87
        '
        'colONCEKIMALIYET
        '
        Me.colONCEKIMALIYET.Caption = "Önceki Maliyet"
        Me.colONCEKIMALIYET.DisplayFormat.FormatString = "#,0.##"
        ...
        Me.colSONALISTARIHI.VisibleIndex = 13
        Me.colSONALISTARIHI.Width = 122
        '
        'colONCEKIALISTARIHI
        '
        ...
        Me.colMALIYET.VisibleIndex = 11
        Me.colMALIYET.Width = 91
        '
        'colSONMIKTAR
        '
        Me.colSONMIKTAR.Caption = "Son Alýþ Miktarý"
        Me.colSONMIKTAR.DisplayFormat.FormatString = "#,0.##"
        Me.colSONMIKTAR.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colSONMIKTAR.FieldName = "SONMIKTAR"
        Me.colSONMIKTAR.Name = "colSONMIKTAR"
        Me.colSONMIKTAR.Visible = True
        Me.colSONMIKTAR.VisibleIndex = 14
        Me.colSONMIKTAR.Width = 154
        '
        'colONCEKIMIKTAR
        '
        Me.colONCEKIMIKTAR.Caption = "Önceki Alýþ Miktarý"
        Me.colONCEKIMIKTAR.DisplayFormat.FormatString = "#,0.##"
        Me.colONCEKIMIKTAR.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colONCEKIMIKTAR.FieldName = "ONCEKIMIKTAR"
        Me.colONCEKIMIKTAR.Name = "colONCEKIMIKTAR"
        '
        'colORAN4
        '
        Me.colORAN4.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(224, Byte), Integer), CType(CType(192, Byte), Integer))
        Me.colORAN4.AppearanceCell.Options.UseBackColor = True
        Me.colORAN4.Caption = "Oran4"
        Me.colORAN4.DisplayFormat.FormatString = "P"
        ...
        Me.colORAN4.Visible = True
        Me.colORAN4.VisibleIndex = 10
        Me.colORAN4.Width = 52
        '
        'colONBESAY
        '
        ...
        Me.colONBESAY.VisibleIndex = 9
        Me.colONBESAY.Width = 56
        '
        'colFIYAT5
        '
        Me.colFIYAT5.Caption = "Fiyat 5"
        ...
        Me.colFIYAT5.VisibleIndex = 15
        '
        'colOran5
        '
        Me.colOran5.Caption = "Oran 5"
        Me.colOran5.DisplayFormat.FormatString = "P"
        ...
        Me.colOran5.Visible = True
        Me.colOran5.VisibleIndex = 16
        '
        'ContextMenu1
        '
        Me.ContextMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem15, Me.MenuItem16, Me.MenuItem1, Me.MenuItem2, Me.MenuItem3, Me.MenuItem19, Me.MenuItem21, Me.MenuItem12, Me.MenuItem4, Me.MenuItem5, Me.MenuItem6, Me.MenuItem20, Me.MenuItem13, Me.MenuItem7, Me.MenuItem8, Me.MenuItem9, Me.MenuItem14, Me.MenuItem25, Me.MenuItem10, Me.MenuItem11, Me.MenuItem18, Me.MenuItem17})
        '
        'MenuItem15
        '
        ...
        Me.MenuItem19.Text = "Maliyetleri Son Alýþa Göre Güncelle"
        '
        'MenuItem21
        '
        ...
        Me.printlink1.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"", "Stok Maliyet Analiz Karlýlýk Listesi", "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"[User Name]", "Stok Ýþlemleri", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
        ...
        'BarButtonItem3
        '
        Me.BarButtonItem3.Caption = "Fiyatlandýr,Ctrl+F"
        ...
        'BarButtonItem6
        '
        Me.BarButtonItem6.Caption = "Transferler,F8"
        ...
        'BarButtonItem11
        '
        Me.BarButtonItem11.Caption = "Güncelle"
        ...
        Me.Name = "frm_stok_karlilik_analizli"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Stok Maliyetlendirmeli Karlýlýk Listesi"
...
#End Region
    ...
    Public Function stok() As DataSet
        ...
        'kriter = "WHERE (stok.skodu is not null ) and stok.nStokTipi=1 "
        If stokkodu <> "" Then
        ...
        conn.ConnectionString = connection
        adapter.SelectCommand = cmd
        'cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.sModel, barkod.sBarkod, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID) AS Mevcut, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyat1 &"') AS PESIN, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyat3 &"') AS ONAY, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyat2 &"') AS ALTIAY,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyatM &"') AS MALIYET, tbRenk.sRenkAdi, stok.sRenk,CAST(0 AS MONEY) AS ORANEKMALIYET, CAST(0 AS MONEY) AS ORAN1, CAST(0 AS MONEY) AS ORAN2, CAST(0 AS MONEY) AS ORAN3, CAST(0 AS MONEY) AS SONALISMIKTARI, CAST(0 AS MONEY) AS SONALISFIYATI, CAST(0 AS MONEY) AS SONALISMALIYETI,CAST(0 AS MONEY) AS ONCEKIALISMALIYETI,CAST('01.01.1900' AS DATETIME) AS ONCEKIALISTARIHI,CAST('01.01.1900' AS DATETIME) AS SONALISTARIHI,CAST(0 AS MONEY) AS NETMALIYET,CAST(0 AS MONEY) AS EKMALIYET,CAST(0 AS MONEY) AS SONMIKTAR,CAST(0 AS MONEY) AS ONCEKIMIKTAR FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") AS T  " & kriter2 & "  ORDER BY sKodu")
        'cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.sModel, barkod.sBarkod, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID) AS Mevcut, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyat1 &"') AS PESIN, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyat3 &"') AS ONAY, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyat2 &"') AS ALTIAY,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '"& sFiyatM &"') AS MALIYET, tbRenk.sRenkAdi, stok.sRenk,CAST(0 AS MONEY) AS ORANEKMALIYET, CAST(0 AS MONEY) AS ORAN1, CAST(0 AS MONEY) AS ORAN2, CAST(0 AS MONEY) AS ORAN3, CAST(0 AS MONEY) AS SONALISMIKTARI, CAST(0 AS MONEY) AS SONALISFIYATI, CAST(0 AS MONEY) AS SONALISMALIYETI,CAST(0 AS MONEY) AS ONCEKIALISMALIYETI,CAST('01.01.1900' AS DATETIME) AS ONCEKIALISTARIHI,CAST('01.01.1900' AS DATETIME) AS SONALISTARIHI,CAST(0 AS MONEY) AS NETMALIYET,CAST(0 AS MONEY) AS EKMALIYET,CAST(0 AS MONEY) AS SONMIKTAR,CAST(0 AS MONEY) AS ONCEKIMIKTAR FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") AS T  " & kriter2 & "  ORDER BY sKodu")
        cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT stok.nStokID, stok.sKodu, stok.sAciklama, stok.sBeden, stok.sModel, barkod.sBarkod, (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1), 0) FROM tbStokFisiDetayi WHERE Stok.nStokID = tbStokFisiDetayi.nStokID) AS Mevcut, (SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat1 & "') AS PESIN , (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat3 & "') AS ONAY ,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat4 & "') AS ONBESAY, (SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat2 & "') AS ALTIAY, (SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyat5 & "') AS FIYAT5, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = stok.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS MALIYET , tbRenk.sRenkAdi , stok.sRenk , CAST(0 AS MONEY) AS ORANEKMALIYET , CAST(0 AS MONEY) AS ORAN1 , CAST(0 AS MONEY) AS ORAN2 , CAST(0 AS MONEY) AS ORAN3, CAST(0 AS MONEY) AS ORAN4, CAST(0 AS MONEY) AS ORAN5, CAST(0 AS MONEY) AS SONALISMIKTARI , CAST(0 AS MONEY) AS SONALISFIYATI , CAST(0 AS MONEY) AS SONALISMALIYETI , CAST(0 AS MONEY) AS ONCEKIALISMALIYETI , CAST('01.01.1900' AS DATETIME) AS ONCEKIALISTARIHI , CAST('01.01.1900' AS DATETIME) AS SONALISTARIHI , CAST(0 AS MONEY) AS NETMALIYET , CAST(0 AS MONEY) AS EKMALIYET , CAST(0 AS MONEY) AS SONMIKTAR , CAST(0 AS MONEY) AS ONCEKIMIKTAR , (SELECT TOP 1 ISNULL(tbStokFisiDetayi.dteFisTarihi , '01/01/1900') FROM tbStokFisiDetayi INNER JOIN tbStok ON tbStokFisiDetayi.nStokID = tbStok.nStokID INNER JOIN tbFisTipi ON tbStokFisiDetayi.sFisTipi = tbFisTipi.sFisTipi INNER JOIN tbFirma ON tbStokFisiDetayi.nFirmaID = tbFirma.nFirmaID LEFT OUTER JOIN tbStokFisiMaster baslik ON tbStokFisiDetayi.nStokFisiID = baslik.nStokFisiID WHERE (tbStokFisiDetayi.nGirisCikis = 1) AND (tbStokFisiDetayi.dteFisTarihi < GETDATE()) AND (tbFirma.sKodu LIKE '3%' AND tbStok.sKodu = stok.sKodu) ORDER BY tbStokFisiDetayi.dteFisTarihi DESC , tbStokFisiDetayi.lFisNo DESC) AS TARIH FROM tbStok stok INNER JOIN tbStokBarkodu barkod ON stok.nStokID = barkod.nStokID and barkod.nKisim = 0 INNER JOIN tbRenk ON stok.sRenk = tbRenk.sRenk " & kriter & ") T " & kriter2 & "ORDER BY TARIH,sKodu")
        cmd.Connection = conn
        conn.Open()
    ...
    Private Sub kontrol_oran()
        ...
        barlabel2.Text = "Alýþlar ve Maliyetleri Hesaplanýyor..."
        bar.Position = 0
        Dim dr As DataRow
        For Each dr In DataSet1.Tables(0).Rows
            ...
            For Each dr1 In ds_alislar.Tables(0).Rows
                ...
                If sayi = 1 Then
                    ...
                    dr("SONMIKTAR") = dr1("MIKTAR")
                ElseIf sayi = 2 Then
                    dr("ONCEKIALISMALIYETI") = dr1("NETMALIYET")
                    dr("ONCEKIALISTARIHI") = dr1("TARIH")
                    dr("ONCEKIMIKTAR") = dr1("MIKTAR")
                End If
                If dr("NETMALIYET") = 0.01 Then
                    If dr("SONALISTARIHI") = dr("ONCEKIALISTARIHI") Then
                        dr("NETMALIYET") = (dr("ONCEKIMIKTAR") * dr("ONCEKIALISMALIYETI")) / (dr("SONMIKTAR") + dr("ONCEKIMIKTAR"))
                    End If
                End If
            Next
            Try
            ...
            Try
                If dr("FIYAT5") <> 0 Then
                    dr("ORAN5") = ((dr("FIYAT5") - dr("NETMALIYET")) / dr("NETMALIYET"))
                End If
            Catch ex As Exception
            End Try
    ...
    End Sub
    Private Sub guncelle_maliyet_eski()
        Panelstatus.Visible = True
        bar.Properties.Maximum = GridView1.RowCount
        barlabel.Text = "Toplam Satýr Sayýsý : " & GridView1.RowCount
        bar.Position = 0
        Dim dr As DataRow
        For Each dr In DataSet1.Tables(0).Rows
            If dr("SONALISTARIHI") <> "01/01/1900" Then
                If dr("NETMALIYET") > 0.01 Then
                    ...
                    End Try
                    If fiyat = 0 Then
                        ekle_fiyat(dr("nStokID"), sFiyatM, FormatNumber(dr("NETMALIYET"), 2), kullaniciadi)
                    Else
                        duzelt_fiyat(dr("nStokID"), sFiyatM, FormatNumber(dr("NETMALIYET"), 2))
                    End If
                    fiyat = Nothing
                End If
            End If
            ...
            If dr("SONALISTARIHI") <> "01/01/1900" Then
                If dr("NETMALIYET") > 0.01 Then
                    ...
                    For Each dr1 In ds_stok.Tables(0).Rows
                        ...
                        End Try
                        If fiyat = 0 Then
                            ekle_fiyat(dr("nStokID"), sFiyatM, dr("NETMALIYET"), kullaniciadi)
                        Else
                            If dr1("nStokTipi") = 1 And dr1("nFiyatlandirma") = 0 Then
                                duzelt_fiyat_renk(dr("nStokID"), sFiyatM, dr("NETMALIYET"), dr1("sModel"))
                            ElseIf dr1("nStoktipi") = 1 And dr1("nFiyatlandirma") = 1 Then
                                duzelt_fiyat(dr("nStokID"), sFiyatM, dr("NETMALIYET"))
    ...
    Private Sub MenuItem19_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem19.Click
        If XtraMessageBox.Show(Sorgu_sDil("Maliyetleri Güncellemek Ýstediðinize Emin misiniz...?", sDil), Sorgu_sDil("Dikkat", sDil), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = MsgBoxResult.Yes Then
            guncelle_maliyet()
        End If
    End Sub
