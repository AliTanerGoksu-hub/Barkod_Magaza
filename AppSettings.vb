...
#End Region
    ...
    Public Shared Function GetBoolean(ByVal key As String) As Boolean
        Dim strTemp As String = AppSettings.GetBoolean(key) 'System.Configuration.ConfigurationSettings.AppSettings.Get(key)
    ...
    Public Shared Function GetString(ByVal key As String) As String
        ...
        'Try
        '    If key <> Nothing Then
        '        strTemp = CType(AppSettings.GetString(key), String)
        '    End If
        'Catch ex As Exception
        'End Try
        'If strTemp = Nothing Then
    ...
    Public Shared Function GetInteger(ByVal key As String) As Integer
        Dim intTemp As Integer = CType(AppSettings.GetInteger(key), Integer)
