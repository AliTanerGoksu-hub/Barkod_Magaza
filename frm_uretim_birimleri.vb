...
Public Class frm_uretim_birimleri
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_uretim_birimleri))
        ...
        Me.XtraTabPage1.Text = "Üretim Birimleri"
        '
        'GridControl1
        '
        ...
        'colKOD
        '
        Me.colKOD.Caption = "Birim"
        Me.colKOD.FieldName = "BIRIM"
        ...
        'colAD
        '
        Me.colAD.Caption = "BirimAdý"
        Me.colAD.FieldName = "BIRIMADI"
        Me.colAD.Name = "colAD"
...
#End Region
    ...
    Private Sub dataload_yerler()
        DataSet1 = sorgu(sorgu_query("SELECT     * FROM         TBLUREMALIYETBIRIMLERI"))
    ...
    Private Sub kayit_duzelt()
        If GridView1.RowCount > 0 Then
            ...
            kayitno = dr("IND")
            txt_kod.Text = dr("BIRIM").ToString
            txt_ad.Text = dr("BIRIMADI").ToString
