...
Imports System.IO
Public Class frm_stok_servis_servistengiris
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_servis_servistengiris))
        ...
        '
        'frm_stok_servis_servistengiris
        '
        ...
        Me.Name = "frm_stok_servis_servistengiris"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Servisten Ürün Giriþi"
...
#End Region
        ...
        If frm.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
            ...
            Else
                ...
                For Each i In arr
                    ...
                    If firmatipi = True Then
                        hareketler_kaydet_yeni(dr_baslik("TARIH"), 2, dr_baslik("BELGETIPI"), dr_baslik("BELGENO"), dr_baslik("IND"), "", dr1("IND"), dr1("REFNO"), Now, 0, dr_baslik("FIRMANO"))
                    ElseIf firmatipi = False Then
                        hareketler_kaydet_yeni(dr_baslik("TARIH"), 5, dr_baslik("BELGETIPI"), dr_baslik("BELGENO"), dr_baslik("IND"), "", dr1("IND"), dr1("REFNO"), Now, 0, dr_baslik("FIRMANO"))
                    End If
                    'hareketler_kaydet_yeni(dr_baslik("TARIH"), 2, dr_baslik("BELGETIPI"), dr_baslik("BELGENO"), dr_baslik("IND"), "", dr1("IND"), dr1("REFNO"), Now, 0, dr_baslik("FIRMANO"))
                    dataload_harekets()
    ...
    Private Sub report_create_stok(ByVal dosya As String, ByVal kriter As String, ByVal status As Integer)
        ...
        If IntPtr.Size = 4 Then
            ...
            frx.SetVariable("BELGETIPI", "'Servisten Ürün Kabul Formu'")
        ...
        ElseIf IntPtr.Size = 8 Then
            ...
            args(14) = "BELGETIPI"
            args(15) = "'Servisten Ürün Kabul Formu'"
            processYol = args(0)
