...
Imports System.IO
Public Class frm_stok_servis_teslimat
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_servis_teslimat))
        ...
        Me.Name = "frm_stok_servis_teslimat"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Servis Teslimat Ýþlemleri"
...
#End Region
        ...
        If frm.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
            ...
            Else
                ...
                For Each i In arr
                    ...
                    hareketler_kaydet_yeni(dr_baslik("TARIH"), 9, dr_baslik("BELGETIPI"), dr_baslik("BELGENO"), dr_baslik("IND"), "", dr1("IND"), dr1("REFNO"), Now, 0, dr_baslik("FIRMANO"))
                    dataload_harekets()
    ...
    Private Sub report_create_stok(ByVal dosya As String, ByVal kriter As String, ByVal status As Integer)
        ...
        If IntPtr.Size = 4 Then
            ...
            frx.SetVariable("BELGETIPI", "'Servis Teslim Formu'")
