...
Public Class frm_stok_satis_ciro_musteri
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_satis_ciro_musteri))
        ...
        Me.sec_bOzet = New DevExpress.XtraEditors.CheckEdit
        ...
        CType(Me.sec_bOzet.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GroupControl1
        '
        Me.GroupControl1.Controls.Add(Me.sec_bOzet)
        ...
        'sec_bOzet
        '
        Me.sec_bOzet.Location = New System.Drawing.Point(264, 89)
        Me.sec_bOzet.Name = "sec_bOzet"
        Me.sec_bOzet.Properties.Caption = "Özet"
        Me.sec_bOzet.Size = New System.Drawing.Size(88, 19)
        Me.sec_bOzet.TabIndex = 48
        '
        'sec_depo
        '
        ...
        Me.sec_sirala.Location = New System.Drawing.Point(264, 109)
        ...
        Me.sec_sirala.Properties.Items.AddRange(New Object() {"Miktar", "Iskonto", "Tutar", "Kar", "MüşteriSayısı"})
        ...
        Me.sec_kayitsayisi.Location = New System.Drawing.Point(184, 109)
        ...
        'Label10
        '
        Me.Label10.Location = New System.Drawing.Point(160, 109)
        ...
        Me.sec_sinifno.Location = New System.Drawing.Point(64, 69)
        ...
        Me.Label9.Text = "Musteri:"
        '
        'sec_satici
        '
        Me.sec_satici.EnterMoveNextControl = True
        Me.sec_satici.Location = New System.Drawing.Point(104, 69)
        ...
        Me.sec_satici.Properties.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo("IND", 10, "KayıtNo"), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("SATICI", 35, "Satıcı")})
        Me.sec_satici.Properties.DisplayMember = "SATICI"
        Me.sec_satici.Properties.NullText = "[Müşteriler]"
        ...
        Me.sec_alisveris.Properties.Items.AddRange(New Object() {"[Tümü]", "Satış Faturası", "Dahili Çıkış"})
        ...
        Me.sec_yeni.Properties.Caption = "Yeni Müşteri"
        ...
        Me.sec_periyod.Properties.Items.AddRange(New Object() {"Günlük", "Haftalık", "Haftanın Günü", "Aylık", "Quarter", "Yıllık"})
        ...
        Me.Label5.Text = "Mağaza :"
        '
        'Label6
        '
        Me.Label6.Location = New System.Drawing.Point(272, 29)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(344, 109)
        ...
        Me.sec_baslik.Properties.Caption = "Başlık Göster"
        ...
        Me.sec_grid.Location = New System.Drawing.Point(163, 22)
        ...
        'ContextMenu1
        '
        Me.ContextMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem14, Me.MenuItem13, Me.MenuItem20, Me.MenuItem1, Me.MenuItem2, Me.MenuItem3, Me.MenuItem4, Me.MenuItem10, Me.MenuItem15, Me.MenuItem5, Me.MenuItem6, Me.MenuItem11, Me.MenuItem7, Me.MenuItem8, Me.MenuItem12, Me.MenuItem9})
        '
        'MenuItem14
        '
        ...
        Me.MenuItem15.Text = "Hızlı Filtre"
        '
        'MenuItem5
        '
        ...
        'DataColumn5
        '
        Me.DataColumn5.ColumnName = "lIskontoTutari"
        Me.DataColumn5.DataType = GetType(Decimal)
        '
        'DataColumn6
        '
        Me.DataColumn6.ColumnName = "lNetTutar"
        ...
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPERIYOD, Me.colsSinifKodu, Me.colsAciklama, Me.colMiktar, Me.colIskonto, Me.colTutar, Me.colMUSTERISAYISI, Me.colMaliyet, Me.colKar, Me.colYuzde, Me.colsSaticiRumuzu, Me.colsSatici, Me.collFisNo, Me.colbPesinMi, Me.colnGirisCikis})
        ...
        Me.GridView1.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Musteri", Nothing, "{0} Kayıt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lToplamMiktar", Nothing, "{0:#,0.00} prç"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lIskontoTutari", Nothing, "Iskonto:{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lNetTutar", Nothing, "Tutar: {0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lKar", Nothing, "Kar:{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "sKodu", Me.colsSinifKodu, "{0} Kayıt"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lToplamMiktar", Me.colMiktar, "{0:#,0.####}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lIskontoTutari", Me.colIskonto, "{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lNetTutar", Me.colTutar, "{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lMaliyet", Me.colMaliyet, "{0:#,0.00}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lKar", Me.colKar, "{0:#,0.00}")})
        ...
        Me.colPERIYOD.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "PERIYOD", "{0} Kayıt")})
        ...
        Me.colsSinifKodu.FieldName = "sKodu"
        ...
        Me.colMiktar.FieldName = "lToplamMiktar"
        Me.colMiktar.Name = "colMiktar"
        Me.colMiktar.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lToplamMiktar", "{0:#,0.00}")})
        ...
        Me.colIskonto.FieldName = "lIskontoTutari"
        Me.colIskonto.Name = "colIskonto"
        Me.colIskonto.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lIskontoTutari", "{0:#,0.00}")})
        ...
        Me.colTutar.FieldName = "lNetTutar"
        Me.colTutar.Name = "colTutar"
        Me.colTutar.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lNetTutar", "{0:#,0.00}")})
        Me.colTutar.Visible = True
        Me.colTutar.VisibleIndex = 7
        '
        'colMUSTERISAYISI
        '
        Me.colMUSTERISAYISI.Caption = "Müşteri Sayısı"
        ...
        Me.colMaliyet.FieldName = "lMaliyet"
        Me.colMaliyet.Name = "colMaliyet"
        Me.colMaliyet.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lMaliyet", "{0:#,0.00}")})
        Me.colMaliyet.Visible = True
        Me.colMaliyet.VisibleIndex = 8
        '
        'colKar
        '
        ...
        Me.colKar.FieldName = "lKar"
        Me.colKar.Name = "colKar"
        Me.colKar.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "lKar", "{0:#,0.00}")})
        Me.colKar.Visible = True
        Me.colKar.VisibleIndex = 9
        '
        'colYuzde
        '
        Me.colYuzde.Caption = "Oran"
        Me.colYuzde.DisplayFormat.FormatString = "%#,0.00"
        Me.colYuzde.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.colYuzde.FieldName = "nOran"
        ...
        Me.colYuzde.VisibleIndex = 10
        '
        'colsSaticiRumuzu
        '
        Me.colsSaticiRumuzu.Caption = "Satıcı Rumuzu"
        ...
        Series1.ArgumentDataMember = "sKodu"
        ...
        Series1.ValueDataMembersSerializable = "lNetTutar"
        ...
        Me.printlink2.PageHeaderFooter = New DevExpress.XtraPrinting.PageHeaderFooter(New DevExpress.XtraPrinting.PageHeaderArea(New String() {"[User Name]", "Satış Ciro Grafiği", "[Date Printed][Time Printed]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Far), New DevExpress.XtraPrinting.PageFooterArea(New String() {"Powered by www.barkodyazilimevi.com", "Retail Managment-Satış Yönetimi", "[Page # of Pages #]"}, New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(162, Byte)), DevExpress.XtraPrinting.BrickAlignment.Near))
        ...
        Me.BarManager1.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.BarButtonItem1, Me.BarButtonItem2, Me.BarButtonItem3, Me.BarButtonItem4, Me.BarButtonItem5, Me.BarButtonItem6, Me.BarButtonItem7, Me.BarSubItem1, Me.BarButtonItem8, Me.BarButtonItem9, Me.BarButtonItem10})
        ...
        Me.Bar3.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem1), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem2, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem3, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem4, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem5, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem6, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarSubItem1, True)})
        ...
        'BarButtonItem1
        '
        Me.BarButtonItem1.Caption = "Grafik Değiştir"
        ...
        'BarButtonItem2
        '
        Me.BarButtonItem2.Caption = "Grafik Yazdır"
        ...
        'BarButtonItem3
        '
        Me.BarButtonItem3.Caption = "Yazdır,Ctrl+P"
        ...
        Me.BarSubItem1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem8), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem9), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem10)})
        Me.BarSubItem1.Name = "BarSubItem1"
        '
        'BarButtonItem8
        '
        Me.BarButtonItem8.Caption = "Önizle"
        Me.BarButtonItem8.Id = 8
        Me.BarButtonItem8.Name = "BarButtonItem8"
        '
        'BarButtonItem9
        '
        Me.BarButtonItem9.Caption = "Dizayn"
        Me.BarButtonItem9.Id = 9
        Me.BarButtonItem9.Name = "BarButtonItem9"
        '
        'BarButtonItem10
        '
        Me.BarButtonItem10.Caption = "Yazdır"
        ...
        'BarButtonItem7
        '
        Me.BarButtonItem7.Caption = "Raporla,F2"
        Me.BarButtonItem7.Id = 6
        Me.BarButtonItem7.ItemAppearance.Normal.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(162, Byte))
        Me.BarButtonItem7.ItemAppearance.Normal.Options.UseFont = True
        Me.BarButtonItem7.Name = "BarButtonItem7"
        '
        'frm_stok_satis_ciro_musteri
        '
        ...
        Me.Name = "frm_stok_satis_ciro_musteri"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Musteriler Periyodik Satış Ciroları"
        ...
        CType(Me.sec_bOzet.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub dataload_satici(Optional ByVal sinifno As Integer = 1)
        sec_satici.Properties.DataSource = sorgu(sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT     sKodu AS IND, sAciklama AS SATICI FROM         tbFirma")).Tables(0)
    ...
    Private Sub raporla(ByVal rapor As Integer, ByVal nislem As Integer, Optional ByVal bTumu As Boolean = False)
        ...
        OpenFileDialog1.Filter = "Rapor Dosyaları (FormSatis*.fr*) |FormSatis*.fr*"
        OpenFileDialog1.FileName = "c:\Formlar\Raporlar\NakitKasa\FormSatis" & sRaporUzanti & ""
        ...
        If OpenFileDialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            If Microsoft.VisualBasic.Right(sFile, 3) = "frx" Then
                ...
                report.SetParameterValue("sDepo", sec_depo.EditValue)
                report.SetParameterValue("sAlisVeris", sec_alisveris.EditValue)
    ...
    Private Sub gorunum_yazdir(Optional ByVal bGrafik As Boolean = False)
        ...
        kriter += Microsoft.VisualBasic.Left(DateEdit1.EditValue.ToString, 10) & " ve " & Microsoft.VisualBasic.Left(DateEdit2.EditValue.ToString, 10) & " Tarihleri Arasındaki Satışlar Ciro Analizi" & vbCrLf
        kriter += "Musteri = " & sec_depo.Text & vbTab & "Periyod = " & sec_periyod.Text
        If sec_yeni.Checked = True Then
            kriter += " YeniMüşteriler = Evet"
        End If
        'kriter += " Sınıflandırma = " & sec_sinifno.Text
        kriter += " Mağaza = " & sec_satici.Text
        If sec_kayitsayisi.EditValue > 0 Then
            kriter += " İlk = " & sec_kayitsayisi.EditValue
            kriter += " Sıralama = " & sec_sirala.Text
        End If
    ...
    Public Function stok(ByVal tarih1 As DateTime, ByVal tarih2 As DateTime, ByVal depo As String, ByVal periyod As String, ByVal yenikayit As Boolean, ByVal alisveris As String, ByVal sinifno As Integer, ByVal satici As String, ByVal kayitsayisi As Decimal, ByVal siralama As String) As DataSet
        ...
        Dim count = ""
        Dim count_sirala = ""
        kriter = " WHERE tbStokFisiMaster.dteFisTarihi Between '" & tarih1 & "' and '" & tarih2 & "' and tbStokFisiMaster.nGirisCikis IN(3,4)"
        If depo <> "[Tümü]" Then
        ...
        If alisveris = "[Tümü]" Then
            kriter += " AND tbStokFisiDetayi.sFisTipi IN ('FS','DC') "
            'kriter += " AND tbStokFisiDetayi.sFisTipi IN ('FS','DC') "
        ElseIf alisveris = "Satış Faturası" Then
            kriter += " AND tbStokFisiDetayi.sFisTipi IN ('FS') "
        ElseIf alisveris = "Dahili Çıkış" Then
            kriter += " AND tbStokFisiDetayi.sFisTipi IN ('DC') "
        End If
        ...
        If kayitsayisi > 0 Then
            ...
            ElseIf siralama = "MüşteriSayısı" Then
        ...
        If islem = 2 Then
            If periyod = "Günlük" Then
                If Trim(satici.ToString) <> "" Then
                    If sec_bOzet.Checked = False Then
                        cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " day(dteFisTarihi) as PERIYOD, bPesinmi, sKodu, sAciklama, sSaticiRumuzu, sSatici, lMalBedeli, 0 lToplamMiktar,lFisNo,lNetTutar, lMalIskontoTutari, nIskonto = CASE WHEN lIskontoTutari <> 0 THEN lIskontoTutari / lMalBedeli   ELSE 0 END, lIskontoTutari, lDipIskontoTutari, SUM(lMaliyetTutar) AS lMaliyet, SUM(lKar) AS lKar, nOran = CASE WHEN SUM(lMaliyetTutar) <> 0 AND SUM(lKar) <> 0 THEN (SUM(lKar) / SUM(lMaliyetTutar))   ELSE 100 END FROM (SELECT tbStokFisiMaster.nStokFisiID, tbStokFisiMaster.dteFisTarihi, tbStokFisiMaster.bPesinmi, tbStokFisiMaster.lFisNo, tbStokFisiMaster.nGirisCikis, tbFirma.sKodu, tbFirma.sAciklama, tbStokFisiDetayi.sSaticiRumuzu, (SELECT sAdi + ' ' + sSoyadi FROM tbSatici WHERE sSaticiRumuzu = tbStokFisiDetayi.sSaticiRumuzu) AS sSatici, tbStokFisiMaster.lMalBedeli, tbStokFisiMaster.lNetTutar, tbStokFisiMaster.lMalIskontoTutari, tbStokFisiMaster.lMalIskontoTutari + tbStokFisiMaster.lDipIskontoTutari1 + tbStokFisiMaster.lDipIskontoTutari2 + tbStokFisiMaster.lDipIskontoTutari3 AS lIskontoTutari, tbStokFisiMaster.lDipIskontoTutari1 + tbStokFisiMaster.lDipIskontoTutari2 + tbStokFisiMaster.lDipIskontoTutari3 AS lDipIskontoTutari, tbStokFisiDetayi.lCikisMiktar1 * ISNULL ((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "'), 0) AS lMaliyetTutar, tbStokFisiDetayi.lCikisTutar - ABS(tbStokFisiDetayi.lCikisMiktar1 * ISNULL ((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "'), 0)) AS lKar FROM tbStokFisiMaster INNER JOIN tbStokFisiDetayi ON tbStokFisiMaster.nStokFisiID = tbStokFisiDetayi.nStokFisiID INNER JOIN tbFirma ON tbStokFisiMaster.nFirmaID = tbFirma.nFirmaID " & kriter & ") DERIVEDTBL GROUP BY  DAY(dteFisTarihi), sKodu, sAciklama, sSaticiRumuzu, sSatici,bPesinmi,nGirisCikis, lMalBedeli, lFisNo,lNetTutar, lMalIskontoTutari, lIskontoTutari, lDipIskontoTutari ORDER BY sSaticiRumuzu, bPesinmi, nGirisCikis")
                    Else
                        cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " day(dteFisTarihi) as PERIYOD, bPesinmi, sKodu, sAciklama, sSaticiRumuzu, sSatici, lMalBedeli, 0 lToplamMiktar,lFisNo,lNetTutar, lMalIskontoTutari, nIskonto = CASE WHEN lIskontoTutari <> 0 THEN lIskontoTutari / lMalBedeli   ELSE 0 END, lIskontoTutari, lDipIskontoTutari, SUM(lMaliyetTutar) AS lMaliyet, SUM(lKar) AS lKar, nOran = CASE WHEN SUM(lMaliyetTutar) <> 0 AND SUM(lKar) <> 0 THEN (SUM(lKar) / SUM(lMaliyetTutar))   ELSE 100 END FROM (SELECT tbStokFisiMaster.dteFisTarihi, tbStokFisiMaster.bPesinmi, 0 lFisNo, 3 nGirisCikis, tbFirma.sKodu, tbFirma.sAciklama, tbStokFisiDetayi.sSaticiRumuzu, (SELECT sAdi + ' ' + sSoyadi FROM tbSatici WHERE sSaticiRumuzu = tbStokFisiDetayi.sSaticiRumuzu) AS sSatici, tbStokFisiMaster.lMalBedeli, tbStokFisiMaster.lNetTutar, tbStokFisiMaster.lMalIskontoTutari, tbStokFisiMaster.lMalIskontoTutari + tbStokFisiMaster.lDipIskontoTutari1 + tbStokFisiMaster.lDipIskontoTutari2 + tbStokFisiMaster.lDipIskontoTutari3 AS lIskontoTutari, tbStokFisiMaster.lDipIskontoTutari1 + tbStokFisiMaster.lDipIskontoTutari2 + tbStokFisiMaster.lDipIskontoTutari3 AS lDipIskontoTutari, tbStokFisiDetayi.lCikisMiktar1 * ISNULL ((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "'), 0) AS lMaliyetTutar, tbStokFisiDetayi.lCikisTutar - ABS(tbStokFisiDetayi.lCikisMiktar1 * ISNULL ((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "'), 0)) AS lKar FROM tbStokFisiMaster INNER JOIN tbStokFisiDetayi ON tbStokFisiMaster.nStokFisiID = tbStokFisiDetayi.nStokFisiID INNER JOIN tbFirma ON tbStokFisiMaster.nFirmaID = tbFirma.nFirmaID " & kriter & ") DERIVEDTBL GROUP BY  DAY(dteFisTarihi), sKodu, sAciklama, sSaticiRumuzu, sSatici,bPesinmi,nGirisCikis, lMalBedeli, lFisNo,lNetTutar, lMalIskontoTutari, lIskontoTutari, lDipIskontoTutari ORDER BY sSaticiRumuzu, bPesinmi, nGirisCikis")
                    End If
                ...
                Else
                    ...
                    cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " day(dteFisTarihi) as PERIYOD, bPesinmi, sKodu, sAciklama, sSaticiRumuzu, sSatici, lFisNo,lToplamMiktar,lMalBedeli, lNetTutar, lMalIskontoTutari, nIskonto = CASE WHEN lIskontoTutari <> 0 THEN lIskontoTutari / lMalBedeli   ELSE 0 END, lIskontoTutari, lDipIskontoTutari, SUM(lMaliyetTutar) AS lMaliyet, SUM(lKar) AS lKar, nOran = CASE WHEN SUM(lMaliyetTutar) <> 0 AND SUM(lKar) <> 0 THEN (SUM(lKar) / SUM(lMaliyetTutar))   ELSE 100 END FROM (SELECT tbStokFisiMaster.nStokFisiID, tbStokFisiMaster.dteFisTarihi, tbStokFisiMaster.bPesinmi, tbStokFisiMaster.lFisNo, tbStokFisiMaster.nGirisCikis, tbFirma.sKodu, tbFirma.sAciklama, tbStokFisiDetayi.sSaticiRumuzu, (SELECT sAdi + ' ' + sSoyadi FROM tbSatici WHERE sSaticiRumuzu = tbStokFisiDetayi.sSaticiRumuzu) AS sSatici, tbStokFisiMaster.lToplamMiktar,tbStokFisiMaster.lMalBedeli, tbStokFisiMaster.lNetTutar, tbStokFisiMaster.lMalIskontoTutari, tbStokFisiMaster.lMalIskontoTutari + tbStokFisiMaster.lDipIskontoTutari1 + tbStokFisiMaster.lDipIskontoTutari2 + tbStokFisiMaster.lDipIskontoTutari3 AS lIskontoTutari, tbStokFisiMaster.lDipIskontoTutari1 + tbStokFisiMaster.lDipIskontoTutari2 + tbStokFisiMaster.lDipIskontoTutari3 AS lDipIskontoTutari, tbStokFisiDetayi.lCikisMiktar1 * ISNULL ((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "'), 0) AS lMaliyetTutar, tbStokFisiDetayi.lCikisTutar - (tbStokFisiDetayi.lCikisMiktar1 * ISNULL ((SELECT isnull(lfiyat, 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "'), 0)) AS lKar FROM tbStokFisiMaster INNER JOIN tbStokFisiDetayi ON tbStokFisiMaster.nStokFisiID = tbStokFisiDetayi.nStokFisiID INNER JOIN tbFirma ON tbStokFisiMaster.nFirmaID = tbFirma.nFirmaID " & kriter & ") DERIVEDTBL GROUP BY  DAY(dteFisTarihi), sKodu, sAciklama,bPesinMi,nGirisCikis, sSaticiRumuzu, sSatici, lFisNo,lToplamMiktar,lMalBedeli, lNetTutar, lMalIskontoTutari, lIskontoTutari, lDipIskontoTutari ORDER BY sSaticiRumuzu, bPesinmi, nGirisCikis")
                End If
            ElseIf periyod = "Aylık" Then
                Me.ChartControl1.Series(0).ArgumentDataMember = "PERIYOD"
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT  " & count & " DBO.AYTOSTR(MONTH(dteFaturaTarihi)) AS PERIYOD,sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar,SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar, (SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , ISNULL(tbStokFisiDetayi.lCikisMiktar1 , 0) AS Miktar , ISNULL(tbStokFisiDetayi.lIskontoTutari , 0) AS Iskonto , tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisVeris LEFT OUTER JOIN tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') AND (tbAlisVeris.sFisTipi = 'P' OR tbAlisVeris.sFisTipi = 'K' OR tbAlisVeris.sFisTipi = 'Ks' OR tbAlisVeris.sFisTipi = 'PD' OR tbAlisVeris.sFisTipi = 'PTX') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') UNION ALL SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , tbAlisverisSiparis.lGCMiktar AS Miktar , tbAlisverisSiparis.lIskontoTutari AS Iskonto , tbAlisverisSiparis.lBrutTutar - tbAlisverisSiparis.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbAlisVerisSiparis.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStokSinifi ON tbAlisverisSiparis.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif" & sinifno & " ON tbStokSinifi.sSinifKodu" & sinifno & " = tbSSinif" & sinifno & ".sSinifKodu WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "')) Satislar " & kriter & " GROUP BY MONTH(dteFaturaTarihi),sMagaza ORDER BY " & count_sirala & " MONTH(dteFaturaTarihi),sMagaza")
            ElseIf periyod = "Haftalık" Then
                Me.ChartControl1.Series(0).ArgumentDataMember = "PERIYOD"
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " { fn WEEK(dteFaturaTarihi) } AS PERIYOD, sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar, SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar,(SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , ISNULL(tbStokFisiDetayi.lCikisMiktar1 , 0) AS Miktar , ISNULL(tbStokFisiDetayi.lIskontoTutari , 0) AS Iskonto , tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisVeris LEFT OUTER JOIN tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') AND (tbAlisVeris.sFisTipi = 'P' OR tbAlisVeris.sFisTipi = 'K' OR tbAlisVeris.sFisTipi = 'Ks' OR tbAlisVeris.sFisTipi = 'PD' OR tbAlisVeris.sFisTipi = 'PTX') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') UNION ALL SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , tbAlisverisSiparis.lGCMiktar AS Miktar , tbAlisverisSiparis.lIskontoTutari AS Iskonto , tbAlisverisSiparis.lBrutTutar - tbAlisverisSiparis.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbAlisVerisSiparis.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStokSinifi ON tbAlisverisSiparis.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif" & sinifno & " ON tbStokSinifi.sSinifKodu" & sinifno & " = tbSSinif" & sinifno & ".sSinifKodu WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "')) Satislar " & kriter & " GROUP BY { fn WEEK(dteFaturaTarihi) },sMagaza ORDER BY " & count_sirala & " { fn WEEK(dteFaturaTarihi) },sMagaza")
            ElseIf periyod = "Yıllık" Then
                Me.ChartControl1.Series(0).ArgumentDataMember = "PERIYOD"
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " YEAR(dteFaturaTarihi) AS PERIYOD, sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar, SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar,(SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , ISNULL(tbStokFisiDetayi.lCikisMiktar1 , 0) AS Miktar , ISNULL(tbStokFisiDetayi.lIskontoTutari , 0) AS Iskonto , tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisVeris LEFT OUTER JOIN tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') AND (tbAlisVeris.sFisTipi = 'P' OR tbAlisVeris.sFisTipi = 'K' OR tbAlisVeris.sFisTipi = 'Ks' OR tbAlisVeris.sFisTipi = 'PD' OR tbAlisVeris.sFisTipi = 'PTX') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') UNION ALL SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , tbAlisverisSiparis.lGCMiktar AS Miktar , tbAlisverisSiparis.lIskontoTutari AS Iskonto , tbAlisverisSiparis.lBrutTutar - tbAlisverisSiparis.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbAlisVerisSiparis.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStokSinifi ON tbAlisverisSiparis.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif" & sinifno & " ON tbStokSinifi.sSinifKodu" & sinifno & " = tbSSinif" & sinifno & ".sSinifKodu WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "')) Satislar " & kriter & " GROUP BY YEAR(dteFaturaTarihi),sMagaza ORDER BY " & count_sirala & " YEAR(dteFaturaTarihi),sMagaza")
            ElseIf periyod = "Haftanın Günü" Then
                Me.ChartControl1.Series(0).ArgumentDataMember = "PERIYOD"
                cmd.CommandText = sorgu_query("set dateformat dmy SET DATEFIRST 1 SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " DATENAME(DW, dteFaturaTarihi) AS PERIYOD,DATEPART(DW, dteFaturaTarihi), sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar, SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar,(SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , ISNULL(tbStokFisiDetayi.lCikisMiktar1 , 0) AS Miktar , ISNULL(tbStokFisiDetayi.lIskontoTutari , 0) AS Iskonto , tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisVeris LEFT OUTER JOIN tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') AND (tbAlisVeris.sFisTipi = 'P' OR tbAlisVeris.sFisTipi = 'K' OR tbAlisVeris.sFisTipi = 'Ks' OR tbAlisVeris.sFisTipi = 'PD' OR tbAlisVeris.sFisTipi = 'PTX') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') UNION ALL SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , tbAlisverisSiparis.lGCMiktar AS Miktar , tbAlisverisSiparis.lIskontoTutari AS Iskonto , tbAlisverisSiparis.lBrutTutar - tbAlisverisSiparis.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbAlisVerisSiparis.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStokSinifi ON tbAlisverisSiparis.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif" & sinifno & " ON tbStokSinifi.sSinifKodu" & sinifno & " = tbSSinif" & sinifno & ".sSinifKodu WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "')) Satislar " & kriter & " GROUP BY DATEPART(DW, dteFaturaTarihi),sMagaza ORDER BY " & count_sirala & " DATEPART(DW, dteFaturaTarihi),sMagaza")
            ElseIf periyod = "Quarter" Then
                Me.ChartControl1.Series(0).ArgumentDataMember = "PERIYOD"
                cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " { fn QUARTER(dteFaturaTarihi) } AS PERIYOD, sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar, SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar,(SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , ISNULL(tbStokFisiDetayi.lCikisMiktar1 , 0) AS Miktar , ISNULL(tbStokFisiDetayi.lIskontoTutari , 0) AS Iskonto , tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisVeris LEFT OUTER JOIN tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') AND (tbAlisVeris.sFisTipi = 'P' OR tbAlisVeris.sFisTipi = 'K' OR tbAlisVeris.sFisTipi = 'Ks' OR tbAlisVeris.sFisTipi = 'PD' OR tbAlisVeris.sFisTipi = 'PTX') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') UNION ALL SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , tbAlisverisSiparis.lGCMiktar AS Miktar , tbAlisverisSiparis.lIskontoTutari AS Iskonto , tbAlisverisSiparis.lBrutTutar - tbAlisverisSiparis.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbAlisVerisSiparis.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStokSinifi ON tbAlisverisSiparis.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif" & sinifno & " ON tbStokSinifi.sSinifKodu" & sinifno & " = tbSSinif" & sinifno & ".sSinifKodu WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "')) Satislar " & kriter & " GROUP BY { fn QUARTER(dteFaturaTarihi) },sMagaza ORDER BY " & count_sirala & " { fn QUARTER(dteFaturaTarihi) },sMagaza")
            End If
        ElseIf islem = 1 Then
            If periyod = "Günlük" Then
                If Trim(satici.ToString) <> "" Then
                    cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " DAY(dteFaturaTarihi) AS PERIYOD, sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar,SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar, (SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , ISNULL(tbStokFisiDetayi.lCikisMiktar1 , 0) AS Miktar , ISNULL(tbStokFisiDetayi.lIskontoTutari , 0) AS Iskonto , tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisVeris LEFT OUTER JOIN tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID ON tbAlisVeris.nAlisverisID = tbStokFisiDetayi.nAlisverisID WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2078') AND (tbAlisVeris.sFisTipi = 'P' OR tbAlisVeris.sFisTipi = 'K' OR tbAlisVeris.sFisTipi = 'Ks' OR tbAlisVeris.sFisTipi = 'PD' OR tbAlisVeris.sFisTipi = 'PTX') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') UNION ALL SELECT tbAlisVeris.dteFaturaTarihi , tbAlisVeris.sFisTipi , tbAlisVeris.sMagaza , tbAlisVeris.nMusteriID , tbAlisverisSiparis.lGCMiktar AS Miktar , tbAlisverisSiparis.lIskontoTutari AS Iskonto , tbAlisverisSiparis.lBrutTutar - tbAlisverisSiparis.lIskontoTutari AS lNetTutar , tbSSinif" & sinifno & ".sSinifKodu , tbSSinif" & sinifno & ".sAciklama,(SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbAlisVerisSiparis.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStokSinifi ON tbAlisverisSiparis.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif" & sinifno & " ON tbStokSinifi.sSinifKodu" & sinifno & " = tbSSinif" & sinifno & ".sSinifKodu WHERE (tbAlisVeris.dteFaturaTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "')UNION ALL SELECT tbStokFisiDetayi.dteFisTarihi AS dteFaturaTarihi, tbStokFisiDetayi.sFisTipi, tbStokFisiDetayi.sDepo AS sMagaza, tbStokFisiDetayi.nFirmaID AS nMusteriID, ISNULL(tbStokFisiDetayi.lCikisMiktar1, 0) AS Miktar, ISNULL(tbStokFisiDetayi.lIskontoTutari * (100 + tbStokFisiDetayi.nKdvOrani) / 100, 0) AS Iskonto, (tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari) * (100 + tbStokFisiDetayi.nKdvOrani) / 100 AS lNetTutar, tbSSinif" & sinifno & ".sSinifKodu, tbSSinif" & sinifno & ".sAciklama, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID WHERE (tbStokFisiDetayi.dteFisTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.sFisTipi = 'FS')) Satislar " & kriter & " GROUP BY DAY(dteFaturaTarihi),sMagaza ORDER BY " & count_sirala & " DAY(dteFaturaTarihi),sMagaza")
                    Me.ChartControl1.Series(0).ArgumentDataMember = "PERIYOD"
                Else
        ...
        ElseIf islem = 0 Then
            If periyod = "Günlük" Then
                If Trim(satici.ToString) <> "" Then
                    cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " DAY(dteFaturaTarihi) AS PERIYOD, sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar,SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar, (SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbStokFisiDetayi.dteFisTarihi AS dteFaturaTarihi, tbStokFisiDetayi.sFisTipi, tbStokFisiDetayi.sDepo AS sMagaza, tbStokFisiDetayi.nFirmaID AS nMusteriID, ISNULL(tbStokFisiDetayi.lCikisMiktar1, 0) AS Miktar, ISNULL(tbStokFisiDetayi.lIskontoTutari * (100 + tbStokFisiDetayi.nKdvOrani) / 100, 0) AS Iskonto, (tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari) * (100 + tbStokFisiDetayi.nKdvOrani) / 100 AS lNetTutar, tbSSinif" & sinifno & ".sSinifKodu, tbSSinif" & sinifno & ".sAciklama, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID WHERE (tbStokFisiDetayi.dteFisTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.sFisTipi = " & kriter_fistipi & ")) Satislar " & kriter & " GROUP BY DAY(dteFaturaTarihi),sMagaza ORDER BY " & count_sirala & " DAY(dteFaturaTarihi),sMagaza")
                    Me.ChartControl1.Series(0).ArgumentDataMember = "PERIYOD"
                Else
                    Me.ChartControl1.Series(0).ArgumentDataMember = "sMagaza"
                    cmd.CommandText = sorgu_query("set dateformat dmy SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT " & count & " '' AS PERIYOD, sMagaza, SUM(Miktar) AS Miktar, SUM(Iskonto) AS Iskonto, SUM(lNetTutar) AS Tutar, SUM(Miktar * ISNULL(Maliyet, 0)) AS Maliyet, SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0)) AS Kar,(SUM(lNetTutar) - SUM(Miktar * ISNULL(Maliyet, 0))) / SUM(Miktar*ISNULL(Maliyet, 0.01)) AS Yuzde,COUNT(DISTINCT nMusteriID) AS MUSTERISAYISI FROM (SELECT tbStokFisiDetayi.dteFisTarihi AS dteFaturaTarihi, tbStokFisiDetayi.sFisTipi, tbStokFisiDetayi.sDepo AS sMagaza, tbStokFisiDetayi.nFirmaID AS nMusteriID, ISNULL(tbStokFisiDetayi.lCikisMiktar1, 0) AS Miktar, ISNULL(tbStokFisiDetayi.lIskontoTutari * (100 + tbStokFisiDetayi.nKdvOrani) / 100, 0) AS Iskonto, (tbStokFisiDetayi.lBrutTutar - tbStokFisiDetayi.lIskontoTutari) * (100 + tbStokFisiDetayi.nKdvOrani) / 100 AS lNetTutar, tbSSinif" & sinifno & ".sSinifKodu, tbSSinif" & sinifno & ".sAciklama, (SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStokFisiDetayi.NstokId AND sFiyatTipi = '" & sFiyatM & "') AS Maliyet FROM tbSSinif" & sinifno & " INNER JOIN tbStokSinifi ON tbSSinif" & sinifno & ".sSinifKodu = tbStokSinifi.sSinifKodu" & sinifno & " INNER JOIN tbStokFisiDetayi ON tbStokSinifi.nStokID = tbStokFisiDetayi.nStokID WHERE (tbStokFisiDetayi.dteFisTarihi BETWEEN '" & tarih1 & "' AND '" & tarih2 & "') AND (tbStokFisiDetayi.sFisTipi = " & kriter_fistipi & ")) Satislar " & kriter & " GROUP BY sMagaza ORDER BY " & count_sirala & " sMagaza")
    ...
    Private Function deger(ByVal ds As DataSet) As String
        ...
        Return s.ToString
    End Function
    Friend WithEvents sec_bOzet As DevExpress.XtraEditors.CheckEdit
