...
Public Class frm_stok_liste_envanter
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents check_hepsi As System.Windows.Forms.CheckBox
    Friend WithEvents DateEdit1 As DevExpress.XtraEditors.DateEdit
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_stok_liste_envanter))
        Me.PanelControl1 = New DevExpress.XtraEditors.PanelControl()
        Me.GroupControl1 = New DevExpress.XtraEditors.GroupControl()
        Me.check_hepsi = New System.Windows.Forms.CheckBox()
        ...
        'GroupControl1
        '
        Me.GroupControl1.Controls.Add(Me.check_hepsi)
        ...
        'check_hepsi
        '
        Me.check_hepsi.AutoSize = True
        Me.check_hepsi.Location = New System.Drawing.Point(346, 83)
        Me.check_hepsi.Name = "check_hepsi"
        Me.check_hepsi.Size = New System.Drawing.Size(85, 17)
        Me.check_hepsi.TabIndex = 48
        Me.check_hepsi.Text = "Tüm Kayýtlar"
        Me.check_hepsi.UseVisualStyleBackColor = True
        '
        'sec_grup
        '
        Me.sec_grup.EditValue = "R/B/K"
        Me.sec_grup.EnterMoveNextControl = True
        Me.sec_grup.Location = New System.Drawing.Point(276, 59)
        ...
        Me.DateEdit1.Location = New System.Drawing.Point(64, 15)
        ...
        Me.DateEdit1.Size = New System.Drawing.Size(276, 20)
        Me.DateEdit1.TabIndex = 0
        '
        'LabelControl3
        '
        Me.LabelControl3.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.LabelControl3.Location = New System.Drawing.Point(16, 19)
        ...
        Me.LabelControl1.Location = New System.Drawing.Point(7, 41)
        ...
        Me.LabelControl5.Location = New System.Drawing.Point(133, 62)
        ...
        Me.sec_depo.Location = New System.Drawing.Point(185, 59)
        ...
        Me.sec_konum.Location = New System.Drawing.Point(184, 37)
        ...
        Me.sec_kriter.Location = New System.Drawing.Point(276, 37)
        ...
        Me.txt_ara.Location = New System.Drawing.Point(64, 37)
        ...
        'sec_bGenelBekleyen
        '
        Me.sec_bGenelBekleyen.Location = New System.Drawing.Point(62, 81)
        ...
        Me.SimpleButton3.Location = New System.Drawing.Point(185, 81)
        Me.SimpleButton3.Name = "SimpleButton3"
        Me.SimpleButton3.Size = New System.Drawing.Size(154, 20)
        ...
        Me.colSinif1.VisibleIndex = 5
        Me.colSinif1.Width = 202
        '
        'colSinif2
        '
        ...
        Me.Bar3.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem1), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem8, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem7, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem6, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem2, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem3, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem4, True), New DevExpress.XtraBars.LinkPersistInfo(Me.BarButtonItem5, True)})
        ...
        Me.Name = "frm_stok_liste_envanter"
...
#End Region
    ...
    Public musterino
    Public kullanici
    Public bSiparisGerektiren As Boolean = False
    Public bSeviyeUstundekiler As Boolean = False
    Public bSeviyeAltindakiler As Boolean = False
    Public nSeviye As String = ""
    ...
    Private Sub frm_cari_faturalar_acik_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DateEdit1.Select()
        If nSeviye = "1" Then
            bSiparisGerektiren = True
        ElseIf nSeviye = "2" Then
            bSeviyeUstundekiler = True
        ElseIf nSeviye = "3" Then
            bSeviyeAltindakiler = True
        End If
    End Sub
    ...
    Public Function stok(ByVal ara As String, ByVal konum As String, ByVal ara_kriter As String, ByVal tarih1 As DateTime, ByVal mevcut As String, ByVal depo As String, ByVal sGrup As String, ByVal bGenelBekleyen As Boolean, Optional ByVal sFiyatTipi As String = "M") As DataSet
        ...
        If mevcut <> "" Then
            ...
            End If
        End If
        If bSiparisGerektiren = True Then
            kriter2 = " AND (TempMevcut.lMevcut < tbStok.lAsgariMiktar) "
        End If
        If bSeviyeAltindakiler = True Then
            kriter2 = " AND (TempMevcut.lMevcut < tbStok.lAsgariMiktar) "
        End If
        If bSeviyeUstundekiler = True Then
            kriter2 = " AND (TempMevcut.lMevcut > tbStok.lAzamiMiktar) "
        End If
        Dim conn As New OleDb.OleDbConnection
        Dim cmd As New OleDb.OleDbCommand
        Dim adapter As New OleDb.OleDbDataAdapter
        ...
        ElseIf sGrup = "Sýnýf1" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif1 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif1")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif1 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif1")
            End If
        ElseIf sGrup = "Sýnýf2" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif2 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif2")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif2 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif2")
            End If
        ElseIf sGrup = "Sýnýf3" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif3 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif3")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif3 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif3")
            End If
        ElseIf sGrup = "Sýnýf4" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif4 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif4")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif4 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif4")
            End If
        ElseIf sGrup = "Sýnýf5" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif5 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif5")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif5 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif5")
            End If
        ElseIf sGrup = "Sýnýf6" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif6 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif6")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif6 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif6")
            End If
        ElseIf sGrup = "Sýnýf7" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif7 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif7")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif7 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif7")
            End If
        ElseIf sGrup = "Sýnýf8" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif8 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif8")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif8 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif8")
            End If
        ElseIf sGrup = "Sýnýf9" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif9 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif9")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif9 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif9")
            End If
        ElseIf sGrup = "Sýnýf10" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif10 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif10")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif10 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif10")
            End If
        ElseIf sGrup = "Sýnýf11" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif11 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif11")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif11 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif11")
            End If
        ElseIf sGrup = "Sýnýf12" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif12 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif12")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif12 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif12")
            End If
        ElseIf sGrup = "Sýnýf13" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif13 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif13")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif13 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif13")
            End If
        ElseIf sGrup = "Sýnýf14" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif14 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif14")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif14 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif14")
            End If
        ElseIf sGrup = "Sýnýf15" Then
            If check_hepsi.Checked = True Then
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif15 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID LEFT JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu LEFT JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu LEFT JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu LEFT JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu LEFT JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu LEFT JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu LEFT JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu LEFT JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu LEFT JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu LEFT JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu LEFT JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu LEFT JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu LEFT JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu LEFT JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu LEFT JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif15")
            Else
                cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT SUM(lMevcut) as lMevcut,Sum(lBekleyen) as lBekleyen,SUM(lMevcut * Maliyet) AS mDeger, SUM(lBekleyen * Maliyet) AS bDeger, Sinif15 FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod AS sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , ((SELECT isnull(lfiyat , 0) FROM tbstokfiyati WHERE nStokId = tbStok.NstokId AND sFiyatTipi = '" & sFiyatTipi & "')) AS Maliyet , TempBekleyen.lBekleyen AS lBekleyen , TempMevcut.lMevcut AS lMevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID and tbStokBarkodu.nKisim = 0 INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN (SELECT nStokID , isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) AS lMevcut FROM tbStokFisiDetayi " & kriter_depo & " GROUP BY nStokID) TempMevcut ON tbStok.nStokID = TempMevcut.nStokID LEFT OUTER JOIN (SELECT stok.nStokID , ISNULL(SUM(tbAlisverisSiparis.lGCMiktar - tbAlisverisSiparis.bEkAlan1) , 0) AS lBekleyen FROM tbAlisverisSiparis INNER JOIN tbAlisVeris ON tbAlisverisSiparis.nAlisverisID = tbAlisVeris.nAlisverisID INNER JOIN tbStok stok ON tbAlisverisSiparis.nStokID = stok.nStokID WHERE (tbAlisverisSiparis.nGirisCikis = 3) AND (tbAlisverisSiparis.lGCMiktar <> tbAlisverisSiparis.bEkAlan1) AND (tbAlisVeris.sFisTipi = 'SP' OR tbAlisVeris.sFisTipi = 'SK') AND (tbAlisverisSiparis.dteOnayTarihi = '01/01/1900') AND (tbAlisverisSiparis.dteTeslimEdilecek BETWEEN '01/01/1900' AND '31/12/2048') AND (tbAlisVeris.dteFaturaTarihi BETWEEN '01/01/1900' AND '31/12/2048') " & kriter_bDepo & " GROUP BY stok.nStokID) TempBekleyen ON tbStok.nStokID = TempBekleyen.nStokID LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & " " & kriter2 & ") tbStoklar GROUP BY Sinif15")
            End If
        End If
        'cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT * FROM (SELECT tbStok.*, tbStokBarkodu.sBarkod, tbSSinif1.sAciklama AS Sinif1, tbSSinif2.sAciklama AS Sinif2, tbSSinif3.sAciklama AS Sinif3, tbSSinif4.sAciklama AS Sinif4, tbSSinif5.sAciklama AS Sinif5, tbSSinif6.sAciklama AS Sinif6, tbSSinif7.sAciklama AS Sinif7, tbSSinif8.sAciklama AS Sinif8, tbSSinif9.sAciklama AS Sinif9, tbSSinif10.sAciklama AS Sinif10, tbSSinif11.sAciklama AS Sinif11, tbSSinif12.sAciklama AS Sinif12, tbSSinif13.sAciklama AS Sinif13, tbSSinif14.sAciklama AS Sinif14, tbSSinif15.sAciklama AS Sinif15, ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10, '') AS ISTIHBARAT,(SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE tbStok.nStokID = tbStokFisiDetayi.nStokID and tbStokFisiDetayi.dteFisTarihi < = '" & tarih1 & "'  " & kriter_depo & " ) AS Mevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & ") AS T  " & kriter2 & "  ORDER BY sKodu")
        'cmd.CommandText = sorgu_query("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED SELECT sModel AS sKodu, sAciklama, sKisaAdi, nStokTipi, sBedenTipi, sKavalaTipi, sBirimCinsi1, sBirimCinsi2, nIskontoYuzdesi, sKdvTipi, nTeminSuresi, lAsgariMiktar, lAzamiMiktar, sOzelNot, nFiyatlandirma, bEksiyeDusulebilirmi, sDefaultAsortiTipi, bEksideUyarsinmi, bOTVVar, sOTVTipi, nIskontoYuzdesiAV, bEk1, nEk2, Sinif1, Sinif2, Sinif3, Sinif4, Sinif5, Sinif6, Sinif7, Sinif8, Sinif9, Sinif10, Sinif11, Sinif12, Sinif13, Sinif14, Sinif15, SUM(Mevcut) AS Mevcut FROM (SELECT tbStok.* , tbStokBarkodu.sBarkod , tbSSinif1.sAciklama AS Sinif1 , tbSSinif2.sAciklama AS Sinif2 , tbSSinif3.sAciklama AS Sinif3 , tbSSinif4.sAciklama AS Sinif4 , tbSSinif5.sAciklama AS Sinif5 , tbSSinif6.sAciklama AS Sinif6 , tbSSinif7.sAciklama AS Sinif7 , tbSSinif8.sAciklama AS Sinif8 , tbSSinif9.sAciklama AS Sinif9 , tbSSinif10.sAciklama AS Sinif10 , tbSSinif11.sAciklama AS Sinif11 , tbSSinif12.sAciklama AS Sinif12 , tbSSinif13.sAciklama AS Sinif13 , tbSSinif14.sAciklama AS Sinif14 , tbSSinif15.sAciklama AS Sinif15 , ISNULL(tbStokAciklama.sAciklama1 + ' ' + tbStokAciklama.sAciklama2 + ' ' + tbStokAciklama.sAciklama3 + ' ' + tbStokAciklama.sAciklama4 + ' ' + tbStokAciklama.sAciklama5 + ' ' + tbStokAciklama.sAciklama6 + ' ' + tbStokAciklama.sAciklama7 + ' ' + tbStokAciklama.sAciklama8 + ' ' + tbStokAciklama.sAciklama9 + ' ' + tbStokAciklama.sAciklama10 , '') AS ISTIHBARAT , (SELECT isnull(SUM(tbStokFisiDetayi.lGirisMiktar1 - tbStokFisiDetayi.lCikisMiktar1) , 0) FROM tbStokFisiDetayi WHERE tbStok.nStokID = tbStokFisiDetayi.nStokID AND tbStokFisiDetayi.dteFisTarihi <= '30/01/2008') AS Mevcut FROM tbStok INNER JOIN tbStokBarkodu ON tbStok.nStokID = tbStokBarkodu.nStokID INNER JOIN tbStokSinifi ON tbStok.nStokID = tbStokSinifi.nStokID INNER JOIN tbSSinif1 ON tbStokSinifi.sSinifKodu1 = tbSSinif1.sSinifKodu INNER JOIN tbSSinif2 ON tbStokSinifi.sSinifKodu2 = tbSSinif2.sSinifKodu INNER JOIN tbSSinif3 ON tbStokSinifi.sSinifKodu3 = tbSSinif3.sSinifKodu INNER JOIN tbSSinif4 ON tbStokSinifi.sSinifKodu4 = tbSSinif4.sSinifKodu INNER JOIN tbSSinif5 ON tbStokSinifi.sSinifKodu5 = tbSSinif5.sSinifKodu INNER JOIN tbSSinif6 ON tbStokSinifi.sSinifKodu6 = tbSSinif6.sSinifKodu INNER JOIN tbSSinif7 ON tbStokSinifi.sSinifKodu7 = tbSSinif7.sSinifKodu INNER JOIN tbSSinif8 ON tbStokSinifi.sSinifKodu8 = tbSSinif8.sSinifKodu INNER JOIN tbSSinif9 ON tbStokSinifi.sSinifKodu9 = tbSSinif9.sSinifKodu INNER JOIN tbSSinif10 ON tbStokSinifi.sSinifKodu10 = tbSSinif10.sSinifKodu INNER JOIN tbSSinif11 ON tbStokSinifi.sSinifKodu11 = tbSSinif11.sSinifKodu INNER JOIN tbSSinif12 ON tbStokSinifi.sSinifKodu12 = tbSSinif12.sSinifKodu INNER JOIN tbSSinif13 ON tbStokSinifi.sSinifKodu13 = tbSSinif13.sSinifKodu INNER JOIN tbSSinif14 ON tbStokSinifi.sSinifKodu14 = tbSSinif14.sSinifKodu INNER JOIN tbSSinif15 ON tbStokSinifi.sSinifKodu15 = tbSSinif15.sSinifKodu LEFT OUTER JOIN tbStokAciklama ON tbStok.nStokID = tbStokAciklama.nStokID " & kriter & ")) T " & kriter2 & " GROUP BY sModel, sAciklama, sKisaAdi, nStokTipi, sBedenTipi, sKavalaTipi, sBirimCinsi1, sBirimCinsi2, nIskontoYuzdesi, sKdvTipi, nTeminSuresi, lAsgariMiktar, lAzamiMiktar, sOzelNot, nFiyatlandirma, bEksiyeDusulebilirmi, sDefaultAsortiTipi, bEksideUyarsinmi, bOTVVar, sOTVTipi, nIskontoYuzdesiAV, bEk1, nEk2, Sinif1, Sinif2, Sinif3, Sinif4, Sinif5, Sinif6, Sinif7, Sinif8, Sinif9, Sinif10, Sinif11, Sinif12, Sinif13, Sinif14, Sinif15 ORDER BY sModel")
        cmd.Connection = conn
        conn.Open()
